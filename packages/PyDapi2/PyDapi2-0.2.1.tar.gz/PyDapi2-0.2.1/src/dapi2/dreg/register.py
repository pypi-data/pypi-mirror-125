...
class Register(BaseRegElement):
    ...
    def __init__(self, name, parent=None, addr=None, size=1, descriptions=None, shortname=None, min=0, max=REG_MAX_VALUE, readonly=True): #@ReservedAssignment
...
class BitFieldRegister(Register):
    ...
    def __init__(self, name, parent=None, addr=None, size=1, descriptions=None, shortname=None, readonly=True):
        super().__init__(name, parent, addr, size, descriptions, shortname, readonly)
        self._bits = []
        self._index = {}
