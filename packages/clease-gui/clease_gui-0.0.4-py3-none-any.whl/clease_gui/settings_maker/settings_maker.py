...
from . import ConcentrationDashboard, SettingsDashboard, ClusterDashboard
...
class SettingsMakerDashboard(BaseDashboard):
    ...
    def initialize(self):
        ...
        self.out_clusters = widgets.Output()  # Clusters table dashboard
        ...
        with self.out_clusters:
            clear_output()
            self._cluster_dashboard.display()
