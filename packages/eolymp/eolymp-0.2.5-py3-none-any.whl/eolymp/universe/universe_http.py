...
class UniverseClient:
    ...
    def AddMember(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.universe.Universe/AddMember",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.universe.AddMemberOutput"),
            **kwargs,
        )

    def UpdateMember(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.universe.Universe/UpdateMember",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.universe.UpdateMemberOutput"),
            **kwargs,
        )

    def RemoveMember(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.universe.Universe/RemoveMember",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.universe.RemoveMemberOutput"),
            **kwargs,
        )

    def DescribeMember(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.universe.Universe/DescribeMember",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.universe.DescribeMemberOutput"),
            **kwargs,
        )

    def IntrospectMember(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.universe.Universe/IntrospectMember",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.universe.IntrospectMemberOutput"),
            **kwargs,
        )

    def ListMembers(self, request, **kwargs):
        return self.transport.request(
            url="eolymp.universe.Universe/ListMembers",
            request=request,
            response_obj=_sym_db.GetSymbol("eolymp.universe.ListMembersOutput"),
            **kwargs,
        )
