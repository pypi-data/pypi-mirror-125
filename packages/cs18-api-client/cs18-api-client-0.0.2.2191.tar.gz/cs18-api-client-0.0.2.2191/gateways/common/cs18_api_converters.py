...
from gateways.common.cs18_api_responses import (GetSpacesResponse, CreateAccountFinalizeResponse, ParameterStoreItem,
                                                ...
                                                SpaceCloudAccount, SpaceAdmin, ServiceTfProgressResponse)
...
class Converters:
    ...
    def _create_service_response(service: dict) -> ServiceResponse:
        progress_dict = service["progress"]
        if progress_dict:
            progress = ServiceTfProgressResponse(progress_dict["terraform_apply"],
                                                 progress_dict["terraform_destroy"],
                                                 progress_dict["terraform_plan"])
        else:
            progress = None
