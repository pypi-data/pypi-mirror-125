...
import sys
from agent_interface.runtimes.python.protect_once_py_interface import ProtectOnceInterface
import json

po_interface = ProtectOnceInterface(
    './agent_interface/out/libprotectonce.so')
po_interface.init_core('./core/index.js')
