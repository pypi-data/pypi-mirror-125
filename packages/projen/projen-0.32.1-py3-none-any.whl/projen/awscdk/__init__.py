...
class AutoDiscover(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param project: -
        :param libdir: (experimental) Output directory (where .js files go).
        ...
        options = AutoDiscoverOptions(
            libdir=libdir, srcdir=srcdir, lambda_options=lambda_options
        )
...
class AutoDiscoverOptions:
    ...
    def libdir(self) -> builtins.str:
        '''(experimental) Output directory (where .js files go).

        :stability: experimental
        '''
        result = self._values.get("libdir")
        assert result is not None, "Required property 'libdir' is missing"
...
class LambdaFunction(
    ...
    def __init__(
        ...
        *,
        ...
        :param entrypoint: (experimental) A path from the project root directory to a TypeScript file which contains the AWS Lambda handler entrypoint (exports a ``handler`` function).
        :param libdir: (experimental) JavaScript output directory (where .js files go).
        :param srcdir: (experimental) Project source directory tree (where .ts files live).
        :param construct_file: (experimental) The name of the generated TypeScript source file. Default: - The name of the entrypoint file, with the ``-function.ts`` suffix instead of ``.lambda.ts``.
        ...
        :param externals: (experimental) Names of modules which should not be included in the bundle. Default: - by default, the "aws-sdk" module will be excluded from the bundle. Note that if you use this option you will need to add "aws-sdk" explicitly.
    ...
    def bundle_task(self) -> _Task_fb843092:
        '''(experimental) The bundle task for this function.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"externals": "externals", "runtime": "runtime"},
)
class LambdaFunctionCommonOptions:
    ...
    def externals(self) -> typing.Optional[typing.List[builtins.str]]:
        '''(experimental) Names of modules which should not be included in the bundle.

        :default:

        - by default, the "aws-sdk" module will be excluded from the
...
class LambdaFunctionOptions(LambdaFunctionCommonOptions):
    ...
    @builtins.property
    def libdir(self) -> builtins.str:
        '''(experimental) JavaScript output directory (where .js files go).
    ...
    @builtins.property
    def srcdir(self) -> builtins.str:
        '''(experimental) Project source directory tree (where .ts files live).
