...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"changelog": "changelog", "changelog_path": "changelogPath"},
)
...
class Publisher(
    ...
    def publish_to_git(
        ...
        *,
        ...
        return typing.cast(_Task_fb843092, jsii.invoke(self, "publishToGit", [options]))
...
class Release(
    ...
    def __init__(
        self,
        project: _GitHubProject_8c232467,
        *,
        branch: builtins.str,
        task: _Task_fb843092,
        version_file: builtins.str,
    ...
    def manual(
        ...
        *,
        ...
        options = ManualReleaseOptions(
            changelog=changelog, changelog_path=changelog_path
        )
