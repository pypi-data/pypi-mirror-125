...
@jsii.data_type(
    jsii_type="projen.javascript.BundleOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class BundleOptions:
    def __init__(
        ...
        *,
        ...
        :param entrypoint: (experimental) The entrypoint of the code you wish to bundle.
        :param outfile: (experimental) This option sets the output file name for the build operation.
        ...
        :param sourcemap: (experimental) Include a source map in the bundle. Default: true
    ...
    def entrypoint(self) -> builtins.str:
        '''(experimental) The entrypoint of the code you wish to bundle.
    ...
    def outfile(self) -> builtins.str:
        '''(experimental) This option sets the output file name for the build operation.
...
class Bundler(
    ...
    def __init__(
        ...
        *,
        parent_task: _Task_fb843092,
        esbuild_version: typing.Optional[builtins.str] = None,
    ) -> None:
        '''(experimental) Creates a ``Bundler``.

        :param project: -
        :param parent_task: (experimental) A parent task that will spawn the "bundle" task (usually "compile").
        ...
        options = BundlerOptions(
            parent_task=parent_task, esbuild_version=esbuild_version
        )
    ...
    def add_bundle(
        ...
        *,
        ...
        :param name: The name of the artifact (the task will be named ``bundle:$name``).
        :param entrypoint: (experimental) The entrypoint of the code you wish to bundle.
        :param outfile: (experimental) This option sets the output file name for the build operation.
        :param platform: (experimental) esbuild platform.
        :param target: (experimental) esbuild target.
        ...
        return typing.cast(_Task_fb843092, jsii.invoke(self, "addBundle", [name, options]))
...
@jsii.data_type(
    jsii_type="projen.javascript.BundlerCommonOptions",
    jsii_struct_bases=[],
    name_mapping={"esbuild_version": "esbuildVersion"},
)
class BundlerCommonOptions:
    def __init__(
        self,
        *,
        esbuild_version: typing.Optional[builtins.str] = None,
    ) -> None:
        '''(experimental) Common options for ``Bundler``.
    ...
    def __repr__(self) -> str:
        return "BundlerCommonOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[BundlerCommonOptions],
    name_mapping={"esbuild_version": "esbuildVersion", "parent_task": "parentTask"},
)
class BundlerOptions(BundlerCommonOptions):
    def __init__(
        self,
        *,
        esbuild_version: typing.Optional[builtins.str] = None,
    ...
    @builtins.property
    def parent_task(self) -> _Task_fb843092:
        '''(experimental) A parent task that will spawn the "bundle" task (usually "compile").

        :stability: experimental
        '''
        result = self._values.get("parent_task")
        assert result is not None, "Required property 'parent_task' is missing"
