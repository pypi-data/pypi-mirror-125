...
class JavaProject(
    ...
    def build_task(self) -> _Task_fb843092:
        '''(experimental) The primary build task.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_GitHubProjectOptions_29a16188, PomOptions],
    name_mapping={
        "name": "name",
        "logging": "logging",
        "outdir": "outdir",
...
class JavaProjectCommonOptions(_GitHubProjectOptions_29a16188, PomOptions):
    def __init__(
        self,
        *,
        name: builtins.str,
