...
def u_Justi(T, AFAK=1.e8, Tref=273.15) -> float:
    ...
    return ICELib.u_Justi(T,AFAK,Tref)
...
def cv_Justi(T, AFAK=1.e8, Tref=273.15):
    ...
    :return: 定压比热容(J/(kg*K))
    """
    return ICELib.cv_Justi(T,AFAK,Tref)
    h = 1.e-3
...
def h_Justi(T, AFAK=1.e8, Tref=273.15):
    ...
    :return:比焓(J/kg)
    """
    return ICELib.h_Justi(T,AFAK,Tref)
...
def cp_Justi(T, AFAK=1.e8, Tref=273.15):
    ...
    :return:定压比热容((J/(kg*K)))
    """
    return ICELib.cp_Justi(T,AFAK,Tref)
