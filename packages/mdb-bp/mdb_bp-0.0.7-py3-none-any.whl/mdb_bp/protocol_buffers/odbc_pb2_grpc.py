...
import mdb_bp.protocol_buffers.odbc_pb2 as odbc__pb2
...
class MDBServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Load = channel.stream_unary(
            '/odbc.v1.MDBService/Load',
            request_serializer=odbc__pb2.LoadRequest.SerializeToString,
            response_deserializer=odbc__pb2.LoadResponse.FromString,
        )
...
def add_MDBServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'Load': grpc.stream_unary_rpc_method_handler(
            servicer.Load,
            request_deserializer=odbc__pb2.LoadRequest.FromString,
            response_serializer=odbc__pb2.LoadResponse.SerializeToString,
        ),
    }
...
class MDBService(object):
    ...
    def Load(request_iterator,
             ...
             timeout=None,
             metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/odbc.v1.MDBService/Load',
                                              odbc__pb2.LoadRequest.SerializeToString,
                                              odbc__pb2.LoadResponse.FromString,
                                              options, channel_credentials,
                                              insecure, call_credentials, compression, wait_for_ready, timeout,
                                              metadata)
