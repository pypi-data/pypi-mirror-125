...
class LearnRegressionError:
    ...
    def er_fit_and_predict(self):
        ...
        for key, model in models_list.items():
            ...
            if (model_predictions_validation < 0).any() or (self.validation['Current Model Error'] < 0).any():
                pass
            else:
            ...
            if (model_predictions_validation < 0).any() or (self.test['Current Model Error'] < 0).any():
                pass
            else:
            ...
            if (final_output_validation < 0).any() or (self.validation[self.output_label] < 0).any():
                pass
            else:
            ...
            if (final_output_test < 0).any() or (self.test[self.output_label] < 0).any():
                pass
            else:
