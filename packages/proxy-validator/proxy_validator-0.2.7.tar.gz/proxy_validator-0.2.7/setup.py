...
setup(
  ...
  url = 'https://bitbucket.fixmost.com/projects/PAYS/repos/proxy-checker/browse',   # Provide either the link to your github or to your website
  download_url = 'https://bitbucket.fixmost.com/projects/PAYS/repos/proxy-checker/browse',    # I explain this later on
