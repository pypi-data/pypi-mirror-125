...
class Client():
  ...
  def create_dataset_label(self, dataset_id, version_id, label):
    self.requires_login()
  ...
  def get_dataset_labels(self, dataset_id, version_id):
    self.requires_login()
  ...
  def get_dataset_label(self, dataset_id, version_id, label_id):
    self.requires_login()
  ...
  def update_dataset_label(self,  dataset_id, version_id, label):
    self.requires_login()
  ...
  def delete_dataset_label(self, dataset_id, version_id, label):
    self.requires_login()
  ...
  def create_dataset_split(self, dataset_id, version_id, split):
    self.requires_login()
  ...
  def get_dataset_splits(self, dataset_id, version_id):
    self.requires_login()
  ...
  def get_dataset_split(self, dataset_id, version_id, split_id):
    self.requires_login()
  ...
  def update_dataset_split(self,  dataset_id, version_id, split):
    self.requires_login()
  ...
  def delete_dataset_split(self, dataset_id, version_id, split):
    self.requires_login()
  ...
  def get_dataset_items(self, dataset_id, version_id, params=None):
    self.requires_login()
  ...
  def create_dataset_item(self, dataset_id, version_id, item):
    self.requires_login()
  ...
  def get_dataset_item(self, dataset_id, version_id, item_id):
    self.requires_login()
  ...
  def update_dataset_item(self,  dataset_id, version_id, item):
    self.requires_login()
  ...
  def delete_dataset_item(self, dataset_id, version_id, split_id, item):
    self.requires_login()
  ...
  def upload_dataset_item_image(self, dataset_id, version_id, item_id, folder, filename):
    self.requires_login()
  ...
  def download_dataset_item_image(self, dataset_id, version_id, item_id, download_location, thumbnail=False):
    self.requires_login()
