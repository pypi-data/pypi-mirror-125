...
class Client():
  ...
  def download_active_model(self, model, asset_type="pkl"):
    """
      asset_type: mlmodel, tflite, onnx, pkl, labels, names
    """

    if asset_type not in ["pkl", "mlmodel", "tflite", "onnx", "names", "labels"]:
      raise NotImplementedError
  ...
  def download_version(self, version, asset_type):
    ...
    if asset_type not in ["pkl", "mlmodel", "tflite", "onnx", "names", "labels", "txt"]:
      raise NotImplementedError()
  ...
  def inference(self, model_id:str, item, input_type="image_classification"):
    ...
    if input_type=="image_classification" or input_type=="object_detection":
  ...
  def create_dataset_label(self, dataset_id, dataset_version_id, label):
    ...
    labels_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/labels"
  ...
  def get_dataset_label(self, dataset_id, dataset_version_id, label_id):
    ...
    labels_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/labels/{label_id}"
  ...
  def update_dataset_label(self, dataset_id, dataset_version_id, label):
    ...
    labels_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/labels/{label['id']}"
  ...
  def create_dataset_split(self, dataset_id, dataset_version_id, split):
    ...
    splits_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/splits"
  ...
  def get_dataset_split(self, dataset_id, dataset_version_id, split_id):
    ...
    splits_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/splits/{split_id}"
  ...
  def update_dataset_split(self, dataset_id, dataset_version_id, split):
    ...
    splits_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/splits/{split['id']}"
  ...
  def get_dataset_items(self, dataset_id, dataset_version_id, params=None):
    ...
    items_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/items"
  ...
  def get_dataset_item(self, dataset_id, dataset_version_id, item_id):
    ...
    items_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/items/{item_id}"
  ...
  def update_dataset_item(self,  dataset_id, dataset_version_id, item):
    ...
    items_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/items/{item['id']}"
  ...
  def delete_dataset_item(self, dataset_id, dataset_version_id, split_id, item):
    ...
    items_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/splits/{split_id}/items/{item['id']}"
  ...
  def upload_dataset_item_image(self, dataset_id, dataset_version_id, item_id, folder, filename):
    ...
    items_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/items/{item_id}/upload"
  ...
  def download_dataset_item_image(self, dataset_id, dataset_version_id, item_id, download_location, thumbnail=False):
    ...
    items_api = f"{self.endpoints[DATASETS_ENDPOINT]}/{dataset_id}/{VERSIONS_ENDPOINT}/{dataset_version_id}/items/{item_id}/download"
  ...
  def download_dataset(self, dataset_id, dataset_version_id, split_id="", extract_to_dir="data", download_file="dataset.zip", remove_download_file=True):
    self.requires_login()
  ...
  def upload_dataset_version(self, dataset_id, dataset_version_id, folder="data", filename="dataset.zip"):
    self.requires_login()
  ...
  def import_yolo_dataset(self, dataset_name="yolo import", split_names=["train", "test"], folder="data", names_filename="yolo.names", config_filename="config.json"):
    ...
    with open(f"{folder}/{names_filename}") as names_file:
      ...
      for label_name in names:
        ...
        label = self.create_dataset_label(d_id, v_id, label)
    ...
    for split_filename in split_names:
      ...
      split = self.create_dataset_split(d_id, v_id, split)
      ...
      with open(f"{folder}/{split_filename}.txt") as split_file:
        ...
        for item_filename in split_items:
          ...
          with open(f"{folder}/{item_name}.txt") as annotation_file:
            ...
            item = self.create_dataset_item(d_id, v_id, local_item)

            self.upload_dataset_item_image(d_id, v_id, item["id"], folder, item_filename)
    return dataset
