...
from examples.danish.danish_deepoffense_config import LANGUAGE_FINETUNE, TEMP_DIRECTORY, SUBMISSION_FOLDER, \
...
data = pd.read_csv('examples/danish/data/offenseval-da-training-v1.tsv', sep="\t")
