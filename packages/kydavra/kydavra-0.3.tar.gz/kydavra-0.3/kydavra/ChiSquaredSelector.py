...
from .errors import MissingDataError, NoSuchColumnError, NonNumericDataError
...
class ChiSquaredSelector:
    ...
    def select(self, dataframe : 'pd.DataFrame', target : str) -> list:
        ...
        X_columns = [col for col in self.dataframe.columns if col != target]
        ...
        while True:
            ...
            chi2_vals, p_vals = chi2(self.X, self.y)
            index = 0
            for col in X_columns:
                if col in X_cols:
    ...
    def plot_chi2(self, title : str = "Chi2 Plot", save : bool = False, file_path : str = None) -> None:
        '''
            Plotting the process of selecting the important features using chi2.
        :param title
    ...
    def plot_p_value(self, title : str = "P-Value Plot", save : bool = False, file_path : str = None) -> None:
        '''
            Plotting the process of selecting the important features using p-values.
        :param save: boolean, default = False
            If the this parameter is set to False that the model will not save the model
            If it is set to True the plot will be saved using :param file_path
        :param file_path: string, default = None
