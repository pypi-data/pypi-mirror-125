...
class PhJupyterOperation(object):
    ...
    def create_jupyter(self):
        ...
        # 5.创建ec2实例
        create_jupyter_cmd1 = "curl https://ph-platform.s3.cn-northwest-1.amazonaws.com.cn/2020-11-11/emr/common/client/jupyterec2cfn.yaml -o ./powerbi.yaml"
        ...
        for user in users:
            ...
            create_jupyter_cmd2 = "aws cloudformation create-stack --stack-name " + user + "-jupyter " \
                                                                                           "--template-body file://powerbi.yaml " \
        ...
        create_jupyter_cmd3 = "rm -f powerbi.yaml"
