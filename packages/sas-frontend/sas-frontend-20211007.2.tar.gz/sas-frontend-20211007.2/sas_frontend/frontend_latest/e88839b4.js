/*! For license information please see e88839b4.js.LICENSE.txt */
"use strict";(self.webpackChunksas_frontend=self.webpackChunksas_frontend||[]).push([[73792,29485],{14166:(t,i,e)=>{e.d(i,{W:()=>n});var a=function(){return a=Object.assign||function(t){for(var i,e=1,a=arguments.length;e<a;e++)for(var n in i=arguments[e])Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n]);return t},a.apply(this,arguments)};function n(t,i,e){void 0===i&&(i=Date.now()),void 0===e&&(e={});var n=a(a({},o),e||{}),s=(+t-+i)/1e3;if(Math.abs(s)<n.second)return{value:Math.round(s),unit:"second"};var r=s/60;if(Math.abs(r)<n.minute)return{value:Math.round(r),unit:"minute"};var l=s/3600;if(Math.abs(l)<n.hour)return{value:Math.round(l),unit:"hour"};var p=s/86400;if(Math.abs(p)<n.day)return{value:Math.round(p),unit:"day"};var m=new Date(t),h=new Date(i),u=m.getFullYear()-h.getFullYear();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"year"};var d=12*u+m.getMonth()-h.getMonth();if(Math.round(Math.abs(d))>0)return{value:Math.round(d),unit:"month"};var c=s/604800;return{value:Math.round(c),unit:"week"}}var o={second:45,minute:45,hour:22,day:5}},54444:(t,i,e)=>{e(65233);var a=e(9672),n=e(87156),o=e(50856);(0,a.k)({_template:o.d`
    <style>
      :host {
        display: block;
        position: absolute;
...
//# sourceMappingURL=e88839b4.js.map