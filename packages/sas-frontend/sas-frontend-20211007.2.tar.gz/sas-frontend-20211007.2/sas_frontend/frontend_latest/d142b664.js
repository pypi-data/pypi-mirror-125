/*! For license information please see d142b664.js.LICENSE.txt */
"use strict";(self.webpackChunksas_frontend=self.webpackChunksas_frontend||[]).push([[83411],{54930:(r,e,i)=>{i.d(e,{D:()=>p});var t=i(87480),c=i(32207),s=i(38103),a=i(59685),o=i(88668),n=i(84298);class d extends c.oi{constructor(){super(...arguments),this.indeterminate=!1,this.progress=0,this.density=0,this.closed=!1}open(){this.closed=!1}close(){this.closed=!0}render(){const r={"mdc-circular-progress--closed":this.closed,"mdc-circular-progress--indeterminate":this.indeterminate},e=48+4*this.density,i={width:`${e}px`,height:`${e}px`};return c.dy`
      <div
...
//# sourceMappingURL=d142b664.js.map