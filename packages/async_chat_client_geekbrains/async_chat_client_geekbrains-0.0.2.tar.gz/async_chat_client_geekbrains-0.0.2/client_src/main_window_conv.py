...
# Form implementation generated from reading ui file 'client_src.ui'
#
...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.label_new_message.setGeometry(QtCore.QRect(300, 330, 431, 16))
        ...
        self.btn_send.setGeometry(QtCore.QRect(570, 450, 171, 31))
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(430, 450, 131, 31))
        self.btn_clear.setObjectName("btn_clear")
        self.theme_switch = QtWidgets.QCheckBox(self.centralwidget)
        self.theme_switch.setGeometry(QtCore.QRect(630, 0, 101, 22))
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        self.theme_switch.setText(_translate("MainClientWindow", "Тёмная тема"))
