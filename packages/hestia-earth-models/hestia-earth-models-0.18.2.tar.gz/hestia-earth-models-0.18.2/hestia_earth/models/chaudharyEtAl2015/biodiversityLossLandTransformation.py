...
def _run(impact_assessment: dict):
    ...
    landTransformation = list_sum([emission_value(impact_assessment, term_id) for term_id in TRANSFORMATION_TERM_IDS])
    ...
    value = landTransformation * factor + inputs_value
