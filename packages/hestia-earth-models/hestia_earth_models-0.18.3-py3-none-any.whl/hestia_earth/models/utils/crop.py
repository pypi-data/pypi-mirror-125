...
def get_crop_grouping_fao(term: dict): return get_lookup_value(term, 'cropGroupingFAO')


def get_crop_grouping_faostat(term: dict): return get_lookup_value(term, 'cropGroupingFAOSTAT')
