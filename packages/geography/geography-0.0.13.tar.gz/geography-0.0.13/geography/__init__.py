...
class UsaStates:
    ...
    @classmethod
    def getStatesInRegion(cls, region: str):
        if region.upper().replace(" ", "_") not in Data.usaStateRegionToAlpha.keys():
            return None
        else:
            return Data.usaStateRegionToAlpha[region.upper().replace(" ", '_')]
