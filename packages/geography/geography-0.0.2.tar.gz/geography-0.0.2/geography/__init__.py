...
class UsaStates:
    ...
    def doesStateExist(cls, usStateAlpha: str):
        if usStateAlpha.upper().replace(" ", "_") in JsonImports.usaStateAlphaToCapital:
            return True
        else:
            return False
    ...
    def getAreaKM(cls, usStateAlpha: str):
        if UsaStates.doesStateExist(usStateAlpha) is False:
            ...
            return JsonImports.usaStateAlphaToAreaKM[usStateAlpha.upper().replace(" ", "_")]
    ...
    def getAreaMiles(cls, usStateAlpha: str):
        if UsaStates.doesStateExist(usStateAlpha) is False:
            ...
            return math.ceil(int(JsonImports.alpha3ToAreaKMm[usStateAlpha.upper().replace(" ", "_")]) / 2.59)
    ...
    def getCapital(cls, usStateAlpha: str):
        if UsaStates.doesStateExist(usStateAlpha) is False:
            ...
            return JsonImports.usaStateAlphaToCapital[usStateAlpha.upper().replace(" ", "_")]
    ...
    def getLargestCity(cls, usStateAlpha: str):
        if UsaStates.doesStateExist(usStateAlpha) is False:
            ...
            return JsonImports.usaStateAlphaToLargestCity[usStateAlpha.upper().replace(" ", "_")]
    ...
    def getStateType(cls, usStateAlpha: str):
        if UsaStates.doesStateExist(usStateAlpha) is False:
            ...
            return JsonImports.usaStateType[usStateAlpha.upper().replace(" ", "_")]
