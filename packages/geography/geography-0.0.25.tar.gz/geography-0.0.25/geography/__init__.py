...
class Countries:
    ...
    def getGdpPerCapita(cls, alpha3: str):
        if Countries.doesCountryExist(alpha3) is False:
            ...
            try:
                return int(Data.alpha3ToGDP[Countries.getRedirectedNameToAlpha3(alpha3)] / Data.alpha3ToPopulation[Countries.getRedirectedNameToAlpha3(alpha3)])
            except TypeError:
                return None
...
class UsaStates:
    ...
    def getGdpPerCapita(cls, usStateAlpha: str):
        if UsaStates.doesStateExist(usStateAlpha) is False:
            ...
            return float(UsaStates.getGDP(UsaStates.getRedirectedNameToAlpha(usStateAlpha)) / UsaStates.getPopulation(UsaStates.getRedirectedNameToAlpha(usStateAlpha)))
