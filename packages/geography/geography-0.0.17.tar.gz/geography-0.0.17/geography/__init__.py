...
class Data:
    ...
    usaStateRegionToAlpha = {
        ...
        "SOUTH_EAST": ["US-AL", "US-AR", "US-FL", "US-GA", "US-LA", "US-MS", "US-NC", "US-SC", "US-TN", "US-VT"],
...
class Countries:
    ...
    def getContinent(cls, alpha3: str):
        if Countries.doesCountryExist(alpha3) is False:
            ...
            return Data.alpha3ToContinent[alpha3.upper()]
...
print(Continents.getAreaRanking("europe"))
