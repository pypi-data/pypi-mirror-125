...
**allen1989** could always use more documentation, whether as
part of the official **allen1989** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `allen1989` for local
development.

1. Fork the `allen1989` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/allen1989.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd allen1989
    (dvlpt) allen1989$ flake8
    (dvlpt) allen1989$ pytest
...
.. _issues: https://gitlab.com/b326/allen1989/issues
