...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '4.6.0-alpha.1635787274+43355506'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 4.6.0-alpha.1635787274+43355506`
                """)
            else:
                raise
