...
# test_requirements = [ ]
requirements = ['numpy>=1.18.0','missingno', 'pandas>=1.1.3', 'seaborn>=0.11.0', 'matplotlib>=3.2.2', 'scikit-learn>=0.23.1', 
'scipy','IPython','ipywidgets','tzlocal','pyperclip','plotly>=4.0.0',"statsmodels>=0.12",]#,'cufflinks>=0.17.0','numpy>=1.18','tensorflow>2.1.0','keras'] 
