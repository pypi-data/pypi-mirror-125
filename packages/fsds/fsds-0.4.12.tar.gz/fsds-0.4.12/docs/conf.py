#!/usr/bin/env python
#
# fsds documentation build configuration file, created by
...
version = fsds.__version__
# The full version, including alpha/beta/rc tags.
release = fsds.__version__
...
def run_apidoc(_):
	...
	module = os.path.join(cur_dir,"..","fsds")
