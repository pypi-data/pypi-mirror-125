...
class ManyModelsAutoMLTrainDriver(AutoMLPRSDriverBase):
    ...
    def run(self, input_data_file: str, output_data_file: str) -> Any:
        ...
        try:
            ...
            if self.args.retrain_failed_models:
                self.get_failed_models_logs(tags_dict, file_name, date1)
    ...
    def get_tag_dict(self, file_name_with_extension: str) -> Dict[str, str]:
        ...
        if not self.args.retrain_failed_models:
    ...
    def get_failed_models_logs(self, tags_dict: Dict[str, str], file_name: str, start_time: datetime) -> List[Any]:
        """
        ...
        try:
            ...
            if models:
                self._console_writer.println("model already exists for the dataset " + models[0].name)
        ...
        return self._compose_logs(file_name, start_time, None)
