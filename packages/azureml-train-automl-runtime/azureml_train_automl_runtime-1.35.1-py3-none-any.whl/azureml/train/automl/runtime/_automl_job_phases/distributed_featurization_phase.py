...
def _build_transformer_for_all_grains(
    ...
    for grain_key_values in all_grain_key_values:
        tr_identifier = distributed_timeseries_util.convert_grain_dict_to_str(grain_key_values)
        transformer = expr_store.transformers.get_by_grain(grain_key_values)  # type: TimeSeriesTransformer
