...
class ItemReserve(SalesInvBase):
    ...
    ext_fields = ['customer','location','inventory_location','inv_loc_override','finish_week', 'reserve_date','num_reserved','item','recipe_items','soft_delete','parent_path','path']
    ...
    def add(cls,argCustomer, argLocation, argWeek, argItem, argReserved=0, argDnl=None):
        ...
        return resp'''
        raise Exception("Item Reserve: add not implemented, Removed 10/26/2021")
