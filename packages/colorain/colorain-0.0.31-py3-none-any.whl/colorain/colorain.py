...
# Welcome message #
##################################################
print(StyledText(f"Welcome to <f=lr>c<f=o>o<f=y>l<f=g>o<f=b>r<f=gr>a<f=lr>i<f=c>n </> <B>{VERSION}</>!"))
print(StyledText("<B>For getting help on styling, run <f=r>styles_guide()</>. <f=y>Have fun!</>"))