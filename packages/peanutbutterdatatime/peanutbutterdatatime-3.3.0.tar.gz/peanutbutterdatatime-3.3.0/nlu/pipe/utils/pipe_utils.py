...
class PipeUtils():
    ...
    @staticmethod
    def set_column_values_on_components_from_pretrained_pipe(pipe, nlp_ref, lang):
        ...
        for c in pipe:
            c_metadata_path = f'{pipe_path}/stages/{digit_str}_{c.model}/metadata/part-00000'
    ...
    def enforce_AT_schema_on_NER_processors_and_add_missing_NER_converters(pipe):
        ...
        TODO this should include TOKEN-CLASSIFIER-TRANSFORMER models which usually output NER format
        """
