...
setuptools.setup(
    ...
    install_requires=[
        ...
        "aws-cdk.aws-autoscaling-hooktargets==1.126.0",
        ...
        "aws-cdk.cdk-assets-schema==1.126.0",
        ...
        "boto3==1.16.16",
        "cloudcomponents.cdk-cloudfront-authorization==1.37.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern==1.36.0"
    ],
    python_requires=">=3.6",
    classifiers=[
