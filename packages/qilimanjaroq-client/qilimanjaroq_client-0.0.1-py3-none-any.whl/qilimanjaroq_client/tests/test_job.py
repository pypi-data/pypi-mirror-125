...
from qilimanjaroq_client.algorithm import Algorithm, AlgorithmOptions
...
from qilimanjaroq_client.job_result import JobResult
from qilimanjaroq_client.job import Job
from qilimanjaroq_client.typings.algorithm import AlgorithmType, InitialValue
from qilimanjaroq_client.user import User
from qilimanjaroq_client.typings.job import JobRequest, JobResponse, JobStatus
from .data import simulator_device_inputs


def test_job_creation():
    algorithm = Algorithm(name="alg001",
