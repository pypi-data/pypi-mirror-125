...
from qilimanjaroq_client.util import base64url_encode, base64url_decode
import json


def test_base64url_encode():
    payload = {"name": "alg001", "type": "Gate-Based Circuit",
...
def test_base64url_decode_list():
    ...
    expected_decoded = [{"name": "alg001", "type": "Gate-Based Circuit",
                         "options": {"number_qubits": 2, "initial_value": "zero"}}]
    assert base64url_decode(data) == expected_decoded
