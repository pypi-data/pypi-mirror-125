...
from qilimanjaroq_client.typings.device import SimulatorDeviceCharacteristicsInput, DeviceType
...
class SimulatorDeviceCharacteristics(ABC):
    ...
    def __init__(self, characteristics_input: SimulatorDeviceCharacteristicsInput):
        if (characteristics_input['type'] is not DeviceType.SIMULATOR and
                characteristics_input['type'] != DeviceType.SIMULATOR.value):
