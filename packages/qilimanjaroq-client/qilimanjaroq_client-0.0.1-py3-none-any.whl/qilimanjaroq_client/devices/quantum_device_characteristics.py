...
from qilimanjaroq_client.typings.device import QuantumDeviceCharacteristicsInput, DeviceType
...
class QuantumDeviceCharacteristics(ABC):
    ...
    def __init__(self, characteristics_input: QuantumDeviceCharacteristicsInput):
        if (characteristics_input['type'] is not DeviceType.QUANTUM and
