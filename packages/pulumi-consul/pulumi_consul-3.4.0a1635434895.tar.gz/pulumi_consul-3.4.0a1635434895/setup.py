...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '3.4.0-alpha.1635434895+15a58c05'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 3.4.0-alpha.1635434895+15a58c05`
                """)
            else:
                raise
