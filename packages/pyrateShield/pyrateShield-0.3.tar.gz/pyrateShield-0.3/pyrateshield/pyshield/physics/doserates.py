...
if __name__ == "__main__":
    ...
    import yaml
    isotopes = yaml.safe_load(open('isotopes.yml'))
    dose_rates = {}
    for isotope in isotopes.keys():
        try:
          dose_rates[isotope] = H10(isotopes[isotope][ps.constants.ENERGY_keV],
                    isotopes[isotope][ps.constants.ABUNDANCE])

          print(str(dose_rates[isotope]/isotopes[isotope][ps.constants.H10] * 100) + \
