...
from matplotlib.ticker import FormatStrFormatter, StrMethodFormatter, NullFormatter
import numpy as np
import math
from ads.common import utils, logger, model
import itertools
...
class EvaluationPlot:
    ...
    def get_legend_labels(cls, legend_labels):
        ...
        Args:
            legend_labels (dict): key/value dictionary containing legend label data
        ...
        def render_legend_labels(label_dict):
            ...
            display(
                HTML(
                    ...
                    .set_table_styles([dict(props=[("text-align", "center")])])
    ...
    def plot(
        ...
        Args:
            evaluation (DataFrame): DataFrame with models as columns and metrics as rows.
            plots (str): The plot type based on class attribute `prob_type`.
            num_classes (int):
            ...
            legend_labels (dict, optional):
                Legend labels dictionary. Default value is `None`.
