...
class OCILanguage(object):  # pragma: no cover
    ...
    def text_classification(self):
        detect_language_text_clf_details = (
            oci.ai_language.models.DetectLanguageTextClassificationDetails(text=self.string)
        )
        output = self.ai_client.detect_language_text_classification(detect_language_text_clf_details)
