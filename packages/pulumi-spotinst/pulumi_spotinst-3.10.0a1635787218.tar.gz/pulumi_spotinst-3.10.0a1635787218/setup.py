...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.10.0-alpha.1635787218+5a9976c7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.10.0-alpha.1635787218+5a9976c7`
                """)
            else:
                raise
