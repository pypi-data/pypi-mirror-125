...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.10.0-alpha.1635517860+c0e592ef'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.10.0-alpha.1635517860+c0e592ef`
                """)
            else:
                raise
