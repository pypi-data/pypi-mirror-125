...
from feyn.tools._data import _select_top_inputs
...
class TestPriors(unittest.TestCase):
    ...
    def test_select_top_inputs(self):
        selected_features = _select_top_inputs(self.data, self.output_name, n=2)
        self.assertEqual(len(selected_features), 3)
        self.assertEqual("extra", selected_features[0])
