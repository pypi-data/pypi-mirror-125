...
required_packages["zope.interface"]="==5.4.0"
required_packages['zipp']="==0.6.0"
required_packages['pillow']="==8.4.0"
required_packages['setuptools']="==42.0.2"
...
required_packages['pycryptodome']="==3.11.0"
required_packages['pygments']="==2.4.0"
required_packages['pymysql']="==0.9.3"
required_packages['pynacl']="==1.4.0"
