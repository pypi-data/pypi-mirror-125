...
def peakbagging (a2z_file, freq, psd, back=None, wdw=None, dnu=None,
                 spectro=True, nsteps_mcmc=1000, show_corner=False, store_chains=False,
                 ...
                 coeff_discard=50, use_sinc=False, asym_profile='nigam-kosovichev',
  ...
  '''
  Read an a2z input file with a prior guess of the modes to fit and return the
  result of the peakbagging protocol processed over those modes.  Fitting
  strategy is the following: pair 1-3 and 2-0 of same order are successively
  fitted from low frequencies to high frequencies following a pseudo-global
  strategy. This protocol is repeted n_process times. 
  ...
  :param strategy: strategy to use for the fit, ``order``, ``pair``,
  ...
  :param coeff_discard: coeff used to compute the number of values to discard
    at the beginning of each MCMC : total amount of sampled values will be divided
    by coeff_discard. Optional, default 50.
