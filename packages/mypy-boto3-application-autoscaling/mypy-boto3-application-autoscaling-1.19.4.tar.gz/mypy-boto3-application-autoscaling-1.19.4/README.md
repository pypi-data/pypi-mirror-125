...
[boto3.ApplicationAutoScaling 1.19.4](https://boto3.amazonaws.com/v1/documentation/api/1.19.4/reference/services/application-autoscaling.html#ApplicationAutoScaling)
