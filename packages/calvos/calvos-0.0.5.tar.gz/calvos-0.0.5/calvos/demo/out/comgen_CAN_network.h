...
typedef uint8_t t_BCM_5_MC;
typedef uint32_t t_BCM_5_CMAC;
typedef uint8_t t_BCM_2_MC;
typedef uint32_t t_BCM_2_CMAC;
typedef uint16_t t_VehSpeed;
typedef uint8_t t_BRAKE_2_MC;
typedef uint8_t t_BRAKE_2_CRC;
typedef uint8_t t_TRANSM_2_MC;
typedef uint8_t t_TRANSM_2_CRC;
typedef uint8_t t_TRANSM_4_MC;
typedef uint8_t t_TRANSM_4_CRC;
typedef uint8_t t_DCU_1_MC;
typedef uint8_t t_DCU_1_CRC;
typedef uint8_t t_DCU_2_MC;
typedef uint8_t t_DCU_2_CRC;
typedef uint8_t t_DCU_3_MC;
