...
#define CAN_DCM_PS_get_timeout_flag_BCM_5()			(can_DCM_PS_rxMsgDynamicData[kCAN_DCM_PS_rxMsgIdx_BCM_5].timedout)
...
/* Get message timeout flag */
#define CAN_DCM_PS_get_timeout_flag_BCM_2()			(can_DCM_PS_rxMsgDynamicData[kCAN_DCM_PS_rxMsgIdx_BCM_2].timedout)
...
/* Get message timeout flag */
#define CAN_DCM_PS_get_timeout_flag_BRAKE_2()			(can_DCM_PS_rxMsgDynamicData[kCAN_DCM_PS_rxMsgIdx_BRAKE_2].timedout)
...
/* Get message timeout flag */
#define CAN_DCM_PS_get_timeout_flag_TRANSM_2()			(can_DCM_PS_rxMsgDynamicData[kCAN_DCM_PS_rxMsgIdx_TRANSM_2].timedout)
...
/* Get message timeout flag */
#define CAN_DCM_PS_get_timeout_flag_TRANSM_4()			(can_DCM_PS_rxMsgDynamicData[kCAN_DCM_PS_rxMsgIdx_TRANSM_4].timedout)
...
/* Get message timeout flag */
#define CAN_DCM_PS_get_timeout_flag_DCU_1()			(can_DCM_PS_rxMsgDynamicData[kCAN_DCM_PS_rxMsgIdx_DCU_1].timedout)
