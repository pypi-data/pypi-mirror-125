...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        endpoint: typing.Optional[typing.Union["CfnCluster.EndpointProperty", _IResolvable_a771d0ef]] = None,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"data_type": "dataType", "name": "name"},
)
class Column:
    def __init__(self, *, data_type: builtins.str, name: builtins.str) -> None:
