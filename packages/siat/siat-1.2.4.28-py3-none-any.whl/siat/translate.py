...
def codetranslate(code):
    ...
    codedict=pd.DataFrame([
        ...
        ['XPEV','小鹏汽车'],['LI','理想汽车'],['0175.HK','吉利汽车'],
        ['2238.HK','广汽'],['000625.SZ','长安汽车'],['600104.SS','上汽'],['NIO','蔚来'],        
        ...
        ['0823.HK','领展房产REIT'], ['2778.HK','冠君产业REIT'], 
        ['87001.HK','汇贤产业REIT'], ['0808.HK','泓富产业REIT'], 
        ['1426.HK','春泉产业REIT'], ['0435.HK','阳光房地产REIT'], 
        ['0405.HK','越秀房产REIT'], ['0778.HK','置富产业REIT'], 
        ['1275.HK','开元产业REIT'], ['1881.HK','富豪产业REIT'], 
        ['1503.HK','招商局商房REIT'], 
