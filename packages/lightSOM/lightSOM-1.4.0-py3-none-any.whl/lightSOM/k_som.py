...
from lightSOM.normalizers import NormalizerFactory
...
#        return self.nodeList[bmu[0]*self.width+bmu[1]]
    ...
    def diff_graph(self, show=False, printout=True, returns=False, path='./'):
        ...
        #
        # diffs = []
        # for node, neighbours in zip(range(self.nodes.nnodes), neighbours):
        ...
        centers =  self.nodes.coordinates#[[node.lattice_pos[0], node.lattice_pos[1]] for node in self.nodeList]
