...
class BoltGeometry(_1579.NamedDatabaseItem):
    ...
    def standard_size(self) -> '_1266.StandardSizes':
        ...
        return constructor.new(_1266.StandardSizes)(value) if value is not None else None
    ...
    def bolt_shank_type(self) -> '_1255.BoltShankType':
        ...
        return constructor.new(_1255.BoltShankType)(value) if value is not None else None
    ...
    def type_of_head_cap(self) -> '_1261.HeadCapTypes':
        ...
        return constructor.new(_1261.HeadCapTypes)(value) if value is not None else None
    ...
    def type_of_thread(self) -> '_1268.ThreadTypes':
        ...
        return constructor.new(_1268.ThreadTypes)(value) if value is not None else None
    ...
    def type_of_bolted_joint(self) -> '_1256.BoltTypes':
        ...
        return constructor.new(_1256.BoltTypes)(value) if value is not None else None
