...
class OilPumpDetail(_1366.IndependentReportablePropertiesBase['OilPumpDetail']):
    ...
    def oil_flow_rate_vs_speed(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.OilFlowRateVsSpeed) if self.wrapped.OilFlowRateVsSpeed is not None else None
    ...
    def operating_oil_pressure_vs_speed(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.OperatingOilPressureVsSpeed) if self.wrapped.OperatingOilPressureVsSpeed is not None else None
    ...
    def electric_power_consumed_vs_speed(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.ElectricPowerConsumedVsSpeed) if self.wrapped.ElectricPowerConsumedVsSpeed is not None else None
