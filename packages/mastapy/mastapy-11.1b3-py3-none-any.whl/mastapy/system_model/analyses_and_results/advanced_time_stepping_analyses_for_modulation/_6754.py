...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(_6759.GearAdvancedTimeSteppingAnalysisForModulation):
    ...
    def system_deflection_results(self) -> '_2464.FaceGearSystemDeflection':
        ...
        return constructor.new(_2464.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
