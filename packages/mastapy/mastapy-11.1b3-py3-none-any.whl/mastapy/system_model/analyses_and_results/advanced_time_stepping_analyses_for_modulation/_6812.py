...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6719.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    ...
    def system_deflection_results(self) -> '_2525.StraightBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2525.StraightBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
