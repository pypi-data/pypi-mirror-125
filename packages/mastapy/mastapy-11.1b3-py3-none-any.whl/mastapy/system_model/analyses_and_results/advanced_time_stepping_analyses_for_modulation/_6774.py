...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(_6768.KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation):
    ...
    def system_deflection_results(self) -> '_2484.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2484.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
