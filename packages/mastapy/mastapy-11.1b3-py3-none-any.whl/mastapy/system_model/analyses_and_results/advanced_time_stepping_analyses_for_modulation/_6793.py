...
class RollingRingAdvancedTimeSteppingAnalysisForModulation(_6740.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    ...
    def component_load_case(self) -> '_6638.RollingRingLoadCase':
        ...
        return constructor.new(_6638.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None
    ...
    def system_deflection_results(self) -> '_2507.RollingRingSystemDeflection':
        ...
        return constructor.new(_2507.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
