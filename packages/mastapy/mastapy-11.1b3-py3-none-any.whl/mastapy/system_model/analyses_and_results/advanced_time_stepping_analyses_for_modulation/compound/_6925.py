...
class RootAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_6838.AssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''RootAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6796.RootAssemblyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6796.RootAssemblyAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6796.RootAssemblyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6796.RootAssemblyAdvancedTimeSteppingAnalysisForModulation))
        return value
