...
class PartParametricStudyTool(_7235.PartAnalysisCase):
    ...
    def parametric_study_tool(self) -> '_4092.ParametricStudyTool':
        ...
        return constructor.new(_4092.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool is not None else None
    ...
    def data_logger(self) -> '_1598.DataLoggerWithCharts':
        ...
        return constructor.new(_1598.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger is not None else None
