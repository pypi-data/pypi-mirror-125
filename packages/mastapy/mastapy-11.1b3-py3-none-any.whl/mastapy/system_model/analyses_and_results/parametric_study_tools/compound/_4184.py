...
class CouplingCompoundParametricStudyTool(_4245.SpecialisedAssemblyCompoundParametricStudyTool):
    '''CouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4039.CouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4039.CouplingParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4039.CouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4039.CouplingParametricStudyTool))
        return value
