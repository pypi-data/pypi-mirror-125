...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3708
...
class StraightBevelPlanetGearCompoundStabilityAnalysis(_3708.StraightBevelDiffGearCompoundStabilityAnalysis):
    '''StraightBevelPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3585.StraightBevelPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3585.StraightBevelPlanetGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3585.StraightBevelPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3585.StraightBevelPlanetGearStabilityAnalysis))
        return value
