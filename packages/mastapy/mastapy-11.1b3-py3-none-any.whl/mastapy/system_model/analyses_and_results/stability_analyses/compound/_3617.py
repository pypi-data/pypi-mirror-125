...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3614
...
class BevelDifferentialPlanetGearCompoundStabilityAnalysis(_3614.BevelDifferentialGearCompoundStabilityAnalysis):
    '''BevelDifferentialPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3485.BevelDifferentialPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3485.BevelDifferentialPlanetGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3485.BevelDifferentialPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3485.BevelDifferentialPlanetGearStabilityAnalysis))
        return value
