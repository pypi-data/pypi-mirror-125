...
class AbstractShaftOrHousingCompoundStabilityAnalysis(_3628.ComponentCompoundStabilityAnalysis):
    '''AbstractShaftOrHousingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3472.AbstractShaftOrHousingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3472.AbstractShaftOrHousingStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3472.AbstractShaftOrHousingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3472.AbstractShaftOrHousingStabilityAnalysis))
        return value
