...
class ConceptGearSystemDeflection(_2469.GearSystemDeflection):
    ...
    def power_flow_results(self) -> '_3768.ConceptGearPowerFlow':
        ...
        return constructor.new(_3768.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def component_detailed_analysis(self) -> '_505.ConceptGearRating':
        ...
        return constructor.new(_505.ConceptGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
