...
class StraightBevelGearMeshSystemDeflection(_2414.BevelGearMeshSystemDeflection):
    ...
    def power_flow_results(self) -> '_3849.StraightBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3849.StraightBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_364.StraightBevelGearMeshRating':
        ...
        return constructor.new(_364.StraightBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
    ...
    def component_detailed_analysis(self) -> '_364.StraightBevelGearMeshRating':
        ...
        return constructor.new(_364.StraightBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
