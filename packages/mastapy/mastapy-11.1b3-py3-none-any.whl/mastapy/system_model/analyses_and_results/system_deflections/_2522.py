...
class StraightBevelDiffGearSetSystemDeflection(_2415.BevelGearSetSystemDeflection):
    ...
    def power_flow_results(self) -> '_3848.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3848.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_362.StraightBevelDiffGearSetRating':
        ...
        return constructor.new(_362.StraightBevelDiffGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
    ...
    def component_detailed_analysis(self) -> '_362.StraightBevelDiffGearSetRating':
        ...
        return constructor.new(_362.StraightBevelDiffGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
