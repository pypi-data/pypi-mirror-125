...
class ConicalGearSystemDeflection(_2469.GearSystemDeflection):
    ...
    def conical_gear_ltca_results(self) -> '_810.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_810.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults is not None else None
