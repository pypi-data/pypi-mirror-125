...
class KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection(_2477.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    ...
    def power_flow_results(self) -> '_3813.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow':
        ...
        return constructor.new(_3813.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
