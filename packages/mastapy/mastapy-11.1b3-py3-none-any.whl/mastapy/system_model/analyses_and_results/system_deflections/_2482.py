...
class KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection(_2476.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    ...
    def connection_load_case(self) -> '_6609.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_6609.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None
    ...
    def power_flow_results(self) -> '_3811.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3811.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_370.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
        ...
        return constructor.new(_370.KlingelnbergCycloPalloidSpiralBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
    ...
    def component_detailed_analysis(self) -> '_370.KlingelnbergCycloPalloidSpiralBevelGearMeshRating':
        ...
        return constructor.new(_370.KlingelnbergCycloPalloidSpiralBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
