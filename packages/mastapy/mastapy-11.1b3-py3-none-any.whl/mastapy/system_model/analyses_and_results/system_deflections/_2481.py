...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2478.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    ...
    def power_flow_results(self) -> '_3809.KlingelnbergCycloPalloidHypoidGearPowerFlow':
        ...
        return constructor.new(_3809.KlingelnbergCycloPalloidHypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def component_detailed_analysis(self) -> '_374.KlingelnbergCycloPalloidHypoidGearRating':
        ...
        return constructor.new(_374.KlingelnbergCycloPalloidHypoidGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
