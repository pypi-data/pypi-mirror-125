...
class StraightBevelPlanetGearCompoundSystemDeflection(_2666.StraightBevelDiffGearCompoundSystemDeflection):
    '''StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2527.StraightBevelPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2527.StraightBevelPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2527.StraightBevelPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2527.StraightBevelPlanetGearSystemDeflection))
        return value
