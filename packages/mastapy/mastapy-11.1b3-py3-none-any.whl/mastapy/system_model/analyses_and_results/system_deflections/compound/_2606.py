...
class CylindricalGearCompoundSystemDeflection(_2618.GearCompoundSystemDeflection):
    ...
    def duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating is not None else None
    ...
    def cylindrical_duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalDutyCycleRating) if self.wrapped.CylindricalDutyCycleRating is not None else None
