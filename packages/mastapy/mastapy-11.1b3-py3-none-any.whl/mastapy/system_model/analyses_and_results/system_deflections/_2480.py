...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(_2477.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    ...
    def power_flow_results(self) -> '_3810.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
        ...
        return constructor.new(_3810.KlingelnbergCycloPalloidHypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
