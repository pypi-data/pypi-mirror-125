...
class HypoidGearSystemDeflection(_2404.AGMAGleasonConicalGearSystemDeflection):
    ...
    def power_flow_results(self) -> '_3802.HypoidGearPowerFlow':
        ...
        return constructor.new(_3802.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def component_detailed_analysis(self) -> '_404.HypoidGearRating':
        ...
        return constructor.new(_404.HypoidGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
