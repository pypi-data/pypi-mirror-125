...
class PartSystemDeflection(_7237.PartFEAnalysis):
    ...
    def mass_properties_from_node_model(self) -> '_1301.MassProperties':
        ...
        return constructor.new(_1301.MassProperties)(self.wrapped.MassPropertiesFromNodeModel) if self.wrapped.MassPropertiesFromNodeModel is not None else None
