...
class StraightBevelGearSystemDeflection(_2416.BevelGearSystemDeflection):
    ...
    def power_flow_results(self) -> '_3850.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3850.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def component_detailed_analysis(self) -> '_365.StraightBevelGearRating':
        ...
        return constructor.new(_365.StraightBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
