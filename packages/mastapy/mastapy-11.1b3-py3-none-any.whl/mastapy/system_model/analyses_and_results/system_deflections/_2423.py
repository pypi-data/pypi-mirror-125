...
class ComponentSystemDeflection(_2493.PartSystemDeflection):
    ...
    def rigidly_connected_components(self) -> '_2556.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2556.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents is not None else None
    ...
    def mass_properties_in_local_coordinate_system_from_node_model(self) -> '_1301.MassProperties':
        ...
        return constructor.new(_1301.MassProperties)(self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel) if self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel is not None else None
