...
class ConceptGearMeshSystemDeflection(_2467.GearMeshSystemDeflection):
    ...
    def power_flow_results(self) -> '_3767.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3767.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_504.ConceptGearMeshRating':
        ...
        return constructor.new(_504.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
