...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_3903.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3806.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3806.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3806.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3806.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value
