...
class PowerLoadModalAnalysis(_4922.VirtualComponentModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2500.PowerLoadSystemDeflection':
        ...
        return constructor.new(_2500.PowerLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
