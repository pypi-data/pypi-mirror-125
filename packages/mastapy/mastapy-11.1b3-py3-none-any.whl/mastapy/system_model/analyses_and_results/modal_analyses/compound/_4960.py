...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4957
...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4957.BevelDifferentialGearCompoundModalAnalysis):
    '''BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4807.BevelDifferentialPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4807.BevelDifferentialPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4807.BevelDifferentialPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4807.BevelDifferentialPlanetGearModalAnalysis))
        return value
