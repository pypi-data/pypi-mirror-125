...
class HypoidGearMeshModalAnalysis(_4797.AGMAGleasonConicalGearMeshModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2471.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2471.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
