...
class PointLoadModalAnalysis(_4922.VirtualComponentModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2499.PointLoadSystemDeflection':
        ...
        return constructor.new(_2499.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
