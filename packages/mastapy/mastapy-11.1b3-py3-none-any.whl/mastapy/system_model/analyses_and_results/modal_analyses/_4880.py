...
class PartToPartShearCouplingHalfModalAnalysis(_4832.CouplingHalfModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2495.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2495.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
