...
class ConnectionAdvancedSystemDeflection(_7231.ConnectionStaticLoadAnalysisCase):
    ...
    def advanced_system_deflection(self) -> '_6964.AdvancedSystemDeflection':
        ...
        return constructor.new(_6964.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None
