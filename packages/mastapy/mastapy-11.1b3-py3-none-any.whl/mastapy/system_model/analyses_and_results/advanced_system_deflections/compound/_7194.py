...
class SpecialisedAssemblyCompoundAdvancedSystemDeflection(_7096.AbstractAssemblyCompoundAdvancedSystemDeflection):
    '''SpecialisedAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7064.SpecialisedAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7064.SpecialisedAssemblyAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7064.SpecialisedAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7064.SpecialisedAssemblyAdvancedSystemDeflection))
        return value
