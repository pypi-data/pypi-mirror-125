...
class StraightBevelSunGearCompoundAdvancedSystemDeflection(_7201.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    '''StraightBevelSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7078.StraightBevelSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7078.StraightBevelSunGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7078.StraightBevelSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7078.StraightBevelSunGearAdvancedSystemDeflection))
        return value
