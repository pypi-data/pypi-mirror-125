...
class MassDiscHarmonicAnalysis(_5786.VirtualComponentHarmonicAnalysis):
    ...
    def component_load_case(self) -> '_6611.MassDiscLoadCase':
        ...
        return constructor.new(_6611.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None
    ...
    def system_deflection_results(self) -> '_2487.MassDiscSystemDeflection':
        ...
        return constructor.new(_2487.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
