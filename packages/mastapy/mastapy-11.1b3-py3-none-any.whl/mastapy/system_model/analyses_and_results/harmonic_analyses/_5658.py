...
class ClutchHalfHarmonicAnalysis(_5675.CouplingHalfHarmonicAnalysis):
    ...
    def component_load_case(self) -> '_6521.ClutchHalfLoadCase':
        ...
        return constructor.new(_6521.ClutchHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None
    ...
    def system_deflection_results(self) -> '_2420.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2420.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
