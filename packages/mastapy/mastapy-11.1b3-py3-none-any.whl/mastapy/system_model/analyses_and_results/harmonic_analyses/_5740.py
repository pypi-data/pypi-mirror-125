...
class PartToPartShearCouplingConnectionHarmonicAnalysis(_5674.CouplingConnectionHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2494.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2494.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
