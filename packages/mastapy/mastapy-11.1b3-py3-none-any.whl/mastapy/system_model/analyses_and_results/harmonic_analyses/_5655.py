...
class BoltedJointHarmonicAnalysis(_5760.SpecialisedAssemblyHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2417.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2417.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
