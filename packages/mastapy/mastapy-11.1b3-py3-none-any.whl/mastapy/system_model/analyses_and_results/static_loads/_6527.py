...
class ConceptCouplingLoadCase(_6540.CouplingLoadCase):
    ...
    def speed_ratio_specification_method(self) -> '_1923.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1923.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value is not None else None
    ...
    def speed_ratio_vs_time(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.SpeedRatioVsTime) if self.wrapped.SpeedRatioVsTime is not None else None
    ...
    def speed_ratio_pid_control(self) -> '_1357.PIDControlSettings':
        ...
        return constructor.new(_1357.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl is not None else None
