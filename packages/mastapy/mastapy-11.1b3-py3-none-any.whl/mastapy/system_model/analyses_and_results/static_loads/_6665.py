...
class TorqueConverterLoadCase(_6540.CouplingLoadCase):
    ...
    def lock_up_clutch_pressure_time_profile(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.LockUpClutchPressureTimeProfile) if self.wrapped.LockUpClutchPressureTimeProfile is not None else None
