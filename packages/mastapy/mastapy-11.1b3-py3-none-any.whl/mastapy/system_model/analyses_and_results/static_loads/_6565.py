...
from mastapy.system_model.analyses_and_results.static_loads import _6560, _6568
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6560.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
