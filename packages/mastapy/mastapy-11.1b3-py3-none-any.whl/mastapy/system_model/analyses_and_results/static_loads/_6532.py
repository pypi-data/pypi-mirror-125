...
class ConicalGearManufactureError(_6579.GearManufactureError):
    ...
    def pitch_errors_concave_flank(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.PitchErrorsConcaveFlank) if self.wrapped.PitchErrorsConcaveFlank is not None else None
    ...
    def pitch_errors_convex_flank(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.PitchErrorsConvexFlank) if self.wrapped.PitchErrorsConvexFlank is not None else None
