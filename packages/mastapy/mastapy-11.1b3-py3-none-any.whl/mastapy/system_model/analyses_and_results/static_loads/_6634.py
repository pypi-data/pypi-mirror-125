...
class RingPinsLoadCase(_6615.MountableComponentLoadCase):
    ...
    def all_ring_pins_manufacturing_error(self) -> '_6504.AllRingPinsManufacturingError':
        ...
        return constructor.new(_6504.AllRingPinsManufacturingError)(self.wrapped.AllRingPinsManufacturingError) if self.wrapped.AllRingPinsManufacturingError is not None else None
