...
class CylindricalGearSetLoadCase(_6583.GearSetLoadCase):
    ...
    def reset_micro_geometry(self) -> '_6632.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6632.ResetMicroGeometryOptions)(value) if value is not None else None
    ...
    def overridden_micro_geometry(self) -> '_1041.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1041.CylindricalGearSetMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry is not None else None
    ...
    def ltca(self) -> '_998.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_998.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA is not None else None
