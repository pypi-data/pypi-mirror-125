...
class KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis(_6129.ConicalGearMeshCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6034.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6034.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6034.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6034.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis))
        return value
