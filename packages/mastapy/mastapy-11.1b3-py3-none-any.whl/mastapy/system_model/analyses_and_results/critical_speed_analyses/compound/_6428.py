...
class KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis(_6394.ConicalGearCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6299.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6299.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6299.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6299.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis))
        return value
