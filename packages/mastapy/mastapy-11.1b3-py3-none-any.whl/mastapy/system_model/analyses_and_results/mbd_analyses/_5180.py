...
class RootAssemblyMultibodyDynamicsAnalysis(_5083.AssemblyMultibodyDynamicsAnalysis):
    ...
    def multibody_dynamics_analysis_inputs(self) -> '_2352.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2352.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs is not None else None
