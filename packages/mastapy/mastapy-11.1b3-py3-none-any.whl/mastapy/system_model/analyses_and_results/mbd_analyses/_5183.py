...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5114.ConnectorMultibodyDynamicsAnalysis):
    ...
    def peak_dynamic_force(self) -> '_5223.DynamicForceVector3DResult':
        ...
        return constructor.new(_5223.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce is not None else None
    ...
    def peak_dynamic_force_angular(self) -> '_5225.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5225.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular is not None else None
