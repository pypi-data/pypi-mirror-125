...
class WindTurbineSingleBladeDetails(_0.APIBase):
    ...
    def edgewise_modes(self) -> '_2194.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2194.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes is not None else None
    ...
    def flapwise_modes(self) -> '_2194.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2194.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes is not None else None
