...
class SplineHalfDesign(_1172.DetailedRigidConnectorHalfDesign):
    ...
    def heat_treatment(self) -> '_1182.HeatTreatmentTypes':
        ...
        return constructor.new(_1182.HeatTreatmentTypes)(value) if value is not None else None
    ...
    def fit_and_tolerance(self) -> '_1205.FitAndTolerance':
        ...
        return constructor.new(_1205.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance is not None else None
