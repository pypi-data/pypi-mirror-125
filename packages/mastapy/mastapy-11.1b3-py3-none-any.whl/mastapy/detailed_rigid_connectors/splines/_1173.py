...
class CustomSplineHalfDesign(_1198.SplineHalfDesign):
    ...
    def total_tooth_thickness_or_space_width_tolerance(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.TotalToothThicknessOrSpaceWidthTolerance) if self.wrapped.TotalToothThicknessOrSpaceWidthTolerance is not None else None
