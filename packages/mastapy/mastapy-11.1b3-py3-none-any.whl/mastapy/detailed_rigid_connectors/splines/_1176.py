...
class DIN5480SplineHalfDesign(_1203.StandardSplineHalfDesign):
    ...
    def manufacturing_type(self) -> '_1186.ManufacturingTypes':
        ...
        return constructor.new(_1186.ManufacturingTypes)(value) if value is not None else None
    ...
    def finishing_method(self) -> '_1195.FinishingMethods':
        ...
        return constructor.new(_1195.FinishingMethods)(value) if value is not None else None
