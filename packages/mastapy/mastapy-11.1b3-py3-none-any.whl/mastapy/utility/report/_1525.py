...
from mastapy.utility.report import _1526, _1529
...
TItem = TypeVar('TItem', bound='_1529.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1526.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
