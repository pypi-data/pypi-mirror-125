...
from mastapy.bearings.bearing_results.rolling import _1716
...
class LoadedAxialThrustNeedleRollerBearingElement(_1716.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
