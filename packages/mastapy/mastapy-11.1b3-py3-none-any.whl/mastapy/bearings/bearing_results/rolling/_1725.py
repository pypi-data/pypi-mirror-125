...
class LoadedBallBearingResults(_1756.LoadedRollingBearingResults):
    ...
    def friction_model_for_gyroscopic_moment(self) -> '_1699.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new(_1699.FrictionModelForGyroscopicMoment)(value) if value is not None else None
    ...
    def track_truncation(self) -> '_1799.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1799.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation is not None else None
