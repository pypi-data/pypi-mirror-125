...
class LoadedRollingBearingResults(_1682.LoadedDetailedBearingResults):
    ...
    def fluid_film_temperature_source(self) -> '_1615.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1615.FluidFilmTemperatureOptions)(value) if value is not None else None
    ...
    def outer_ring_fitting_at_assembly(self) -> '_1836.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1836.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly is not None else None
    ...
    def outer_ring_fitting_at_operating_conditions(self) -> '_1836.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1836.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions is not None else None
    ...
    def inner_ring_fitting_at_assembly(self) -> '_1834.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1834.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly is not None else None
    ...
    def inner_ring_fitting_at_operating_conditions(self) -> '_1834.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1834.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions is not None else None
    ...
    def din732(self) -> '_1696.DIN732Results':
        ...
        return constructor.new(_1696.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 is not None else None
    ...
    def iso762006(self) -> '_1828.ISO762006Results':
        ...
        return constructor.new(_1828.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 is not None else None
    ...
    def maximum_static_contact_stress(self) -> '_1784.MaximumStaticContactStress':
        ...
        return constructor.new(_1784.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress is not None else None
    ...
    def skf_module_results(self) -> '_1822.SKFModuleResults':
        ...
        return constructor.new(_1822.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults is not None else None
