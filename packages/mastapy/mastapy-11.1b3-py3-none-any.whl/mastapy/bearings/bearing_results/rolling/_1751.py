...
from mastapy.bearings.bearing_results.rolling import _1791, _1737
...
class LoadedRollerBearingElement(_1737.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1791.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1791.ResultsAtRollerOffset))
        return value
