...
from mastapy.bearings.bearing_results.rolling import _1706
...
class LoadedAngularContactThrustBallBearingResults(_1706.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
