...
class CaseHardeningProperties(_0.APIBase):
    ...
    def hardness_profile_calculation_method(self) -> '_991.HardnessProfileCalculationMethod':
        ...
        return constructor.new(_991.HardnessProfileCalculationMethod)(value) if value is not None else None
    ...
    def heat_treatment_type(self) -> '_992.HeatTreatmentType':
        ...
        return constructor.new(_992.HeatTreatmentType)(value) if value is not None else None
