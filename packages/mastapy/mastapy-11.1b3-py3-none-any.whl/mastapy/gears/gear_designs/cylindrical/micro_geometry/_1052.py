...
class MeshAlignment(_0.APIBase):
    ...
    def gear_a_alignment(self) -> '_1046.GearAlignment':
        ...
        return constructor.new(_1046.GearAlignment)(self.wrapped.GearAAlignment) if self.wrapped.GearAAlignment is not None else None
    ...
    def gear_b_alignment(self) -> '_1046.GearAlignment':
        ...
        return constructor.new(_1046.GearAlignment)(self.wrapped.GearBAlignment) if self.wrapped.GearBAlignment is not None else None
