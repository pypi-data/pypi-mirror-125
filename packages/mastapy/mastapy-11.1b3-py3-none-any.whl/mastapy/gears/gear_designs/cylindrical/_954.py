...
class CylindricalGearDesignConstraints(_1579.NamedDatabaseItem):
    '''CylindricalGearDesignConstraints
    ...
    @property
    def design_constraints(self) -> 'List[_953.CylindricalGearDesignConstraint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_953.CylindricalGearDesignConstraint))
        return value
