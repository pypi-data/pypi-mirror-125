...
class StraightBevelDiffGearMeshRating(_493.ConicalGearMeshRating):
    ...
    def straight_bevel_diff_gear_mesh(self) -> '_902.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_902.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh is not None else None
