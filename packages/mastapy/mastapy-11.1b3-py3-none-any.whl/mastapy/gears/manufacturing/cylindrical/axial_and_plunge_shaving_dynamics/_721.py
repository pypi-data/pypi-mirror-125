...
class ShavingDynamicsCalculationForDesignedGears(_720.ShavingDynamicsCalculation['T'], Generic[T]):
    ...
    def start_of_shaving_profile(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value is not None else None
    ...
    def end_of_shaving_profile(self) -> '_964.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_964.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value is not None else None
