...
class HobbingProcessProfileCalculation(_620.HobbingProcessCalculation):
    ...
    def right_flank(self) -> '_616.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_616.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
    ...
    def left_flank(self) -> '_616.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_616.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
