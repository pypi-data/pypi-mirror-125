...
class PocketingPowerLossCoefficients(_1579.NamedDatabaseItem):
    ...
    def raw_pocketing_power_loss_lookup_table(self) -> '_1349.GriddedSurfaceAccessor':
        ...
        return constructor.new(_1349.GriddedSurfaceAccessor)(self.wrapped.RawPocketingPowerLossLookupTable) if self.wrapped.RawPocketingPowerLossLookupTable is not None else None
