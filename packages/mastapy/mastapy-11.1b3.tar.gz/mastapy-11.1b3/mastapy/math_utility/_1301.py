...
class MassProperties(_0.APIBase):
    ...
    def inertia_tensor_about_origin(self) -> '_1300.InertiaTensor':
        ...
        return constructor.new(_1300.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin is not None else None
    ...
    def inertia_tensor_about_centre_of_mass(self) -> '_1300.InertiaTensor':
        ...
        return constructor.new(_1300.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass is not None else None
