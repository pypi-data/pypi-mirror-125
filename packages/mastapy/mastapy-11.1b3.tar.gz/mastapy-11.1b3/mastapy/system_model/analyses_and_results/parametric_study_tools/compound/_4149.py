...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4172.ComponentCompoundParametricStudyTool):
    '''AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4001.AbstractShaftOrHousingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4001.AbstractShaftOrHousingParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4001.AbstractShaftOrHousingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4001.AbstractShaftOrHousingParametricStudyTool))
        return value
