...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4158.BevelDifferentialGearCompoundParametricStudyTool):
    '''BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4015.BevelDifferentialSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4015.BevelDifferentialSunGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4015.BevelDifferentialSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4015.BevelDifferentialSunGearParametricStudyTool))
        return value
