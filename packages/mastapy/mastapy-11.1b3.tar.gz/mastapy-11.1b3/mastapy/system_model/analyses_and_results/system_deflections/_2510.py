...
class ShaftSectionEndResultsSystemDeflection(_0.APIBase):
    ...
    def displacements(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.Displacements) if self.wrapped.Displacements is not None else None
    ...
    def forces(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.Forces) if self.wrapped.Forces is not None else None
