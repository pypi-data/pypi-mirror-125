...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2593.ConicalGearSetCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2477.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2477.KlingelnbergCycloPalloidConicalGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2477.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2477.KlingelnbergCycloPalloidConicalGearSetSystemDeflection))
        return value
