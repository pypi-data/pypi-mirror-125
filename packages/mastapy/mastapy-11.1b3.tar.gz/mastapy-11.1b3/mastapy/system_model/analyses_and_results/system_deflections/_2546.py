...
class WormGearSystemDeflection(_2469.GearSystemDeflection):
    ...
    def power_flow_results(self) -> '_3866.WormGearPowerFlow':
        ...
        return constructor.new(_3866.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def component_detailed_analysis(self) -> '_339.WormGearRating':
        ...
        return constructor.new(_339.WormGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
