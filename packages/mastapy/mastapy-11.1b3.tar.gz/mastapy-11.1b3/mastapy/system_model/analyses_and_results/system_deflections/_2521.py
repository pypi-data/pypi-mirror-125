...
class StraightBevelDiffGearMeshSystemDeflection(_2414.BevelGearMeshSystemDeflection):
    ...
    def connection_load_case(self) -> '_6652.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6652.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None
    ...
    def power_flow_results(self) -> '_3846.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3846.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_360.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_360.StraightBevelDiffGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
    ...
    def component_detailed_analysis(self) -> '_360.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_360.StraightBevelDiffGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
