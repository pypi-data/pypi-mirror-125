...
class SystemDeflection(_7234.FEAnalysis):
    ...
    def overall_efficiency_results(self) -> '_2485.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2485.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults is not None else None
    ...
    def analysis_options(self) -> '_2535.SystemDeflectionOptions':
        ...
        return constructor.new(_2535.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions is not None else None
