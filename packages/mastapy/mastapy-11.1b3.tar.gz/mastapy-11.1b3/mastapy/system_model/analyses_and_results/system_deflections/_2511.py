...
class ShaftSectionSystemDeflection(_121.Bar):
    ...
    def left_end(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd is not None else None
    ...
    def right_end(self) -> '_2510.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2510.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd is not None else None
