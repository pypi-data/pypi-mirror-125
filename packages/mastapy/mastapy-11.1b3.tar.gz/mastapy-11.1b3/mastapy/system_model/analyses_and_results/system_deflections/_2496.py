...
class PartToPartShearCouplingSystemDeflection(_2439.CouplingSystemDeflection):
    ...
    def part_to_part_shear_coupling_connection(self) -> '_2494.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2494.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection is not None else None
    ...
    def power_flow_results(self) -> '_3821.PartToPartShearCouplingPowerFlow':
        ...
        return constructor.new(_3821.PartToPartShearCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
