...
class PartToPartShearCouplingHalfSystemDeflection(_2438.CouplingHalfSystemDeflection):
    ...
    def power_flow_results(self) -> '_3820.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3820.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
