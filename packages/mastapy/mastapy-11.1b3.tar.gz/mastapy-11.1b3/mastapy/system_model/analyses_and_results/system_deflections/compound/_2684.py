...
class WormGearCompoundSystemDeflection(_2618.GearCompoundSystemDeflection):
    ...
    def duty_cycle_rating(self) -> '_337.WormGearDutyCycleRating':
        ...
        return constructor.new(_337.WormGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating is not None else None
    ...
    def worm_duty_cycle_rating(self) -> '_337.WormGearDutyCycleRating':
        ...
        return constructor.new(_337.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating is not None else None
