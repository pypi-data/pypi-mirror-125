...
class SpiralBevelGearSetSystemDeflection(_2415.BevelGearSetSystemDeflection):
    ...
    def power_flow_results(self) -> '_3842.SpiralBevelGearSetPowerFlow':
        ...
        return constructor.new(_3842.SpiralBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_369.SpiralBevelGearSetRating':
        ...
        return constructor.new(_369.SpiralBevelGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
    ...
    def component_detailed_analysis(self) -> '_369.SpiralBevelGearSetRating':
        ...
        return constructor.new(_369.SpiralBevelGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
