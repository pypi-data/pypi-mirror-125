...
class ZerolBevelGearMeshSystemDeflection(_2414.BevelGearMeshSystemDeflection):
    ...
    def connection_load_case(self) -> '_6678.ZerolBevelGearMeshLoadCase':
        ...
        return constructor.new(_6678.ZerolBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None
    ...
    def power_flow_results(self) -> '_3868.ZerolBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3868.ZerolBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    def rating(self) -> '_334.ZerolBevelGearMeshRating':
        ...
        return constructor.new(_334.ZerolBevelGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
    ...
    def component_detailed_analysis(self) -> '_334.ZerolBevelGearMeshRating':
        ...
        return constructor.new(_334.ZerolBevelGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
