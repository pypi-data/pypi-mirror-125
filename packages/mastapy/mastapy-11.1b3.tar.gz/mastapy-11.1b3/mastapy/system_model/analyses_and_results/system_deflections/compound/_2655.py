...
class ShaftCompoundSystemDeflection(_2560.AbstractShaftCompoundSystemDeflection):
    ...
    def shaft_duty_cycle_damage_results(self) -> '_2656.ShaftDutyCycleSystemDeflection':
        ...
        return constructor.new(_2656.ShaftDutyCycleSystemDeflection)(self.wrapped.ShaftDutyCycleDamageResults) if self.wrapped.ShaftDutyCycleDamageResults is not None else None
