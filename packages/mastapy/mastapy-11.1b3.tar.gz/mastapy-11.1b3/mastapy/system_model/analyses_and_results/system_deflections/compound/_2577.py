...
class BevelGearSetCompoundSystemDeflection(_2565.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    '''BevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2415.BevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2415.BevelGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2415.BevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2415.BevelGearSetSystemDeflection))
        return value
