...
class CylindricalGearSetAdvancedSystemDeflection(_7025.GearSetAdvancedSystemDeflection):
    ...
    def micro_geometry(self) -> '_1041.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1041.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry is not None else None
    ...
    def component_detailed_analysis(self) -> '_427.CylindricalGearSetRating':
        ...
        return constructor.new(_427.CylindricalGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
