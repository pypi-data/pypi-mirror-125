...
class KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection(_7129.ConicalGearMeshCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7032.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7032.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_7032.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7032.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection))
        return value
