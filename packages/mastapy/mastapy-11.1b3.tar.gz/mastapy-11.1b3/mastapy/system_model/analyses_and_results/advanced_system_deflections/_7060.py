...
class RootAssemblyAdvancedSystemDeflection(_6970.AssemblyAdvancedSystemDeflection):
    ...
    def advanced_system_deflection_inputs(self) -> '_6964.AdvancedSystemDeflection':
        ...
        return constructor.new(_6964.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs is not None else None
