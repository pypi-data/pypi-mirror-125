...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7130
...
class KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection(_7130.ConicalGearSetCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7033.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7033.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7033.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7033.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection))
        return value
