...
class CylindricalGearMeshAdvancedSystemDeflection(_7024.GearMeshAdvancedSystemDeflection):
    ...
    def active_flank(self) -> '_288.CylindricalFlanks':
        ...
        return constructor.new(_288.CylindricalFlanks)(value) if value is not None else None
    ...
    def gear_mesh_design(self) -> '_959.CylindricalGearMeshDesign':
        ...
        return constructor.new(_959.CylindricalGearMeshDesign)(self.wrapped.GearMeshDesign) if self.wrapped.GearMeshDesign is not None else None
    ...
    def point_with_maximum_contact_pressure(self) -> '_802.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_802.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure is not None else None
    ...
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1296.FourierSeries':
        ...
        return constructor.new(_1296.FourierSeries)(self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod) if self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod is not None else None
    ...
    def connection_load_case(self) -> '_6550.CylindricalGearMeshLoadCase':
        ...
        return constructor.new(_6550.CylindricalGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None
    ...
    def component_detailed_analysis(self) -> '_420.CylindricalGearMeshRating':
        ...
        return constructor.new(_420.CylindricalGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
