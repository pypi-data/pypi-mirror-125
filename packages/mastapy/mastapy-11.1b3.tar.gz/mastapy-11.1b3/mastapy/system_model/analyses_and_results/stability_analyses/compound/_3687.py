...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3652
...
class PlanetaryGearSetCompoundStabilityAnalysis(_3652.CylindricalGearSetCompoundStabilityAnalysis):
    '''PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3556.PlanetaryGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3556.PlanetaryGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3556.PlanetaryGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3556.PlanetaryGearSetStabilityAnalysis))
        return value
