...
class GuideDxfModelHarmonicAnalysis(_5662.ComponentHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2470.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2470.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
