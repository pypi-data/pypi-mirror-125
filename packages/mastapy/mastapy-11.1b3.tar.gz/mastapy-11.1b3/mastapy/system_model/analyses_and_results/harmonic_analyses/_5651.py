...
class BevelDifferentialSunGearHarmonicAnalysis(_5647.BevelDifferentialGearHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2413.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2413.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
