...
class OilSealHarmonicAnalysis(_5673.ConnectorHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2492.OilSealSystemDeflection':
        ...
        return constructor.new(_2492.OilSealSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
