...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def excitation_selection(self) -> '_5796.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5796.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection is not None else None
    ...
    def modal_analysis_options(self) -> '_4874.ModalAnalysisOptions':
        ...
        return constructor.new(_4874.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions is not None else None
