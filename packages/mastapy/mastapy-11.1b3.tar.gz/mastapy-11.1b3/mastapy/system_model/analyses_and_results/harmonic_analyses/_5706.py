...
class FlexiblePinAssemblyHarmonicAnalysis(_5760.SpecialisedAssemblyHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2466.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2466.FlexiblePinAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
