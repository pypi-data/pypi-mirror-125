...
class CylindricalGearMeshHarmonicAnalysis(_5710.GearMeshHarmonicAnalysis):
    ...
    def advanced_system_deflection_results(self) -> '_7012.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7012.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults is not None else None
