...
class BevelDifferentialGearMeshHarmonicAnalysis(_5653.BevelGearMeshHarmonicAnalysis):
    ...
    def connection_load_case(self) -> '_6511.BevelDifferentialGearMeshLoadCase':
        ...
        return constructor.new(_6511.BevelDifferentialGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None
    ...
    def system_deflection_results(self) -> '_2409.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2409.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
