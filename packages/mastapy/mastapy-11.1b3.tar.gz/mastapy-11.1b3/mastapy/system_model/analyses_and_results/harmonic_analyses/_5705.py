...
class FEPartHarmonicAnalysis(_5638.AbstractShaftOrHousingHarmonicAnalysis):
    ...
    def coupled_modal_analysis(self) -> '_4850.FEPartModalAnalysis':
        ...
        return constructor.new(_4850.FEPartModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis is not None else None
    ...
    def export(self) -> '_5718.HarmonicAnalysisFEExportOptions':
        ...
        return constructor.new(_5718.HarmonicAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    def results(self) -> '_5806.FEPartHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5806.FEPartHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results is not None else None
