...
class ZerolBevelGearSetHarmonicAnalysis(_5654.BevelGearSetHarmonicAnalysis):
    ...
    def system_deflection_results(self) -> '_2548.ZerolBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2548.ZerolBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
