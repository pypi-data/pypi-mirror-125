...
class SynchroniserPartCompoundMultibodyDynamicsAnalysis(_5266.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    '''SynchroniserPartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5204.SynchroniserPartMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5204.SynchroniserPartMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5204.SynchroniserPartMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5204.SynchroniserPartMultibodyDynamicsAnalysis))
        return value
