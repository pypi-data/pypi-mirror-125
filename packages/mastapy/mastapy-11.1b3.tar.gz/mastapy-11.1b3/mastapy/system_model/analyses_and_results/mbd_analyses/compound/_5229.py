...
class AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis(_5252.ComponentCompoundMultibodyDynamicsAnalysis):
    '''AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5077.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5077.AbstractShaftOrHousingMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5077.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5077.AbstractShaftOrHousingMultibodyDynamicsAnalysis))
        return value
