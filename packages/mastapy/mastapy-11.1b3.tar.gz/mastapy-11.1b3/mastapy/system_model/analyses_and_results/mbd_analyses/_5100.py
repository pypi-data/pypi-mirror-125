...
class ClutchMultibodyDynamicsAnalysis(_5117.CouplingMultibodyDynamicsAnalysis):
    ...
    def clutch_connection(self) -> '_5098.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5098.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection is not None else None
