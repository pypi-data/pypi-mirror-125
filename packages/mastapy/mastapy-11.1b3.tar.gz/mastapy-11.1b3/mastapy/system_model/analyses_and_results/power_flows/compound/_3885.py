...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3882
...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3882.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3752.BevelDifferentialPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3752.BevelDifferentialPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3752.BevelDifferentialPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3752.BevelDifferentialPlanetGearPowerFlow))
        return value
