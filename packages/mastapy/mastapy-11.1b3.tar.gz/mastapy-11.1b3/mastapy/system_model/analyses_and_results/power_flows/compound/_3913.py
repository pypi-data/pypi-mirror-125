...
class CVTPulleyCompoundPowerFlow(_3959.PulleyCompoundPowerFlow):
    '''CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3780.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3780.CVTPulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3780.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3780.CVTPulleyPowerFlow))
        return value
