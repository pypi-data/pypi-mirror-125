...
class CylindricalGearCompoundPowerFlow(_3929.GearCompoundPowerFlow):
    ...
    def gear_duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating is not None else None
    ...
    def cylindrical_gear_duty_cycle_rating(self) -> '_417.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_417.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearDutyCycleRating) if self.wrapped.CylindricalGearDutyCycleRating is not None else None
