...
class CVTPulleyAdvancedTimeSteppingAnalysisForModulation(_6790.PulleyAdvancedTimeSteppingAnalysisForModulation):
    ...
    def component_design(self) -> '_2300.CVTPulley':
        ...
        return constructor.new(_2300.CVTPulley)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    def system_deflection_results(self) -> '_2441.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2441.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
