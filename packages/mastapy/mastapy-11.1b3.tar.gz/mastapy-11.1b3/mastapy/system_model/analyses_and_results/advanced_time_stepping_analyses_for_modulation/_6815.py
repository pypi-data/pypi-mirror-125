...
class SynchroniserAdvancedTimeSteppingAnalysisForModulation(_6800.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    ...
    def assembly_load_case(self) -> '_6660.SynchroniserLoadCase':
        ...
        return constructor.new(_6660.SynchroniserLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase is not None else None
    ...
    def system_deflection_results(self) -> '_2532.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2532.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
