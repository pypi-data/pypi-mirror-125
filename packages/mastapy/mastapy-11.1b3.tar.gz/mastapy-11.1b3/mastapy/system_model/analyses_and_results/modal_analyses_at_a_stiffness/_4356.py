...
class PartModalAnalysisAtAStiffness(_7238.PartStaticLoadAnalysisCase):
    ...
    def modal_analysis_at_a_stiffness(self) -> '_2350.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2350.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffness) if self.wrapped.ModalAnalysisAtAStiffness is not None else None
