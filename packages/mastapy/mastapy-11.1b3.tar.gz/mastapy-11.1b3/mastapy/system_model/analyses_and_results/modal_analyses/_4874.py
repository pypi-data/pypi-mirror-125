...
class ModalAnalysisOptions(_0.APIBase):
    ...
    def frequency_response_options_for_reports(self) -> '_4852.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4852.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports is not None else None
