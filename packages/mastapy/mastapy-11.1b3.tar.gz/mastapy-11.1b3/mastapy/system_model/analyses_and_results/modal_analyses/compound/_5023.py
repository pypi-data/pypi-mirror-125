...
class MountableComponentCompoundModalAnalysis(_4971.ComponentCompoundModalAnalysis):
    '''MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4875.MountableComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4875.MountableComponentModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4875.MountableComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4875.MountableComponentModalAnalysis))
        return value
