...
class KlingelnbergCycloPalloidHypoidGearModalAnalysis(_4862.KlingelnbergCycloPalloidConicalGearModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2481.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        return constructor.new(_2481.KlingelnbergCycloPalloidHypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
