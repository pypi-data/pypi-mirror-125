...
class PlanetaryConnectionModalAnalysis(_4897.ShaftToMountableComponentConnectionModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2497.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2497.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
