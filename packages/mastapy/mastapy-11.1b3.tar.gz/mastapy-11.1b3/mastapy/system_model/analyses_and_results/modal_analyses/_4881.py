...
class PartToPartShearCouplingModalAnalysis(_4833.CouplingModalAnalysis):
    ...
    def system_deflection_results(self) -> '_2496.PartToPartShearCouplingSystemDeflection':
        ...
        return constructor.new(_2496.PartToPartShearCouplingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
