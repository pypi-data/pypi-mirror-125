...
class ConicalGearLoadCase(_6578.GearLoadCase):
    ...
    def gear_manufacture_errors(self) -> '_6532.ConicalGearManufactureError':
        ...
        return constructor.new(_6532.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None
