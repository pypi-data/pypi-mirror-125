...
class ConicalGearMeshLoadCase(_6580.GearMeshLoadCase):
    ...
    def results_from_imported_xml(self) -> '_1097.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_1097.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML is not None else None
