...
class CylindricalGearLoadCase(_6578.GearLoadCase):
    ...
    def gear_manufacture_errors(self) -> '_6549.CylindricalGearManufactureError':
        ...
        return constructor.new(_6549.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None
    ...
    def overridden_micro_geometry(self) -> '_1036.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1036.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry is not None else None
