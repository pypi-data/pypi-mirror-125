...
class PartCompoundDynamicAnalysis(_7236.PartCompoundAnalysis):
    '''PartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6046.PartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6046.PartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6046.PartDynamicAnalysis))
        return value
