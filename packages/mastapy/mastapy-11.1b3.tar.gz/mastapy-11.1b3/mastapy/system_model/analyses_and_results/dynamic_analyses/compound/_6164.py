...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6130
...
class KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis(_6130.ConicalGearSetCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6035.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6035.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6035.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6035.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis))
        return value
