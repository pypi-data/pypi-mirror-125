...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6131
...
class AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6131.ConnectionCompoundDynamicAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5969.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5969.AbstractShaftToMountableComponentConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5969.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5969.AbstractShaftToMountableComponentConnectionDynamicAnalysis))
        return value
