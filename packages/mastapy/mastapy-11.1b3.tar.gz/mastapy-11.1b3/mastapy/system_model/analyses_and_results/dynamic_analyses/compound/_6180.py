...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6145
...
class PlanetaryGearSetCompoundDynamicAnalysis(_6145.CylindricalGearSetCompoundDynamicAnalysis):
    '''PlanetaryGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6051.PlanetaryGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6051.PlanetaryGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6051.PlanetaryGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6051.PlanetaryGearSetDynamicAnalysis))
        return value
