...
class SynchroniserPartCompoundCriticalSpeedAnalysis(_6401.CouplingHalfCompoundCriticalSpeedAnalysis):
    '''SynchroniserPartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6348.SynchroniserPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6348.SynchroniserPartCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6348.SynchroniserPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6348.SynchroniserPartCriticalSpeedAnalysis))
        return value
