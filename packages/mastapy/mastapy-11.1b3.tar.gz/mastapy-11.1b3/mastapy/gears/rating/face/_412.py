...
class FaceGearMeshRating(_325.GearMeshRating):
    ...
    def active_flank(self) -> '_291.GearFlanks':
        ...
        return constructor.new(_291.GearFlanks)(value) if value is not None else None
    ...
    def mesh_load_case(self) -> '_824.FaceMeshLoadCase':
        ...
        return constructor.new(_824.FaceMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase is not None else None
    ...
    def gear_set_rating(self) -> '_415.FaceGearSetRating':
        ...
        return constructor.new(_415.FaceGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating is not None else None
    ...
    def face_gear_mesh(self) -> '_931.FaceGearMeshDesign':
        ...
        return constructor.new(_931.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh is not None else None
