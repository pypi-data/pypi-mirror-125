...
class CylindricalGearRatingSettings(_1371.PerMachineSettings):
    ...
    def tip_relief_in_scuffing_calculation(self) -> '_446.TipReliefScuffingOptions':
        ...
        return constructor.new(_446.TipReliefScuffingOptions)(value) if value is not None else None
    ...
    def dynamic_factor_method(self) -> '_433.DynamicFactorMethods':
        ...
        return constructor.new(_433.DynamicFactorMethods)(value) if value is not None else None
    ...
    def gear_blank_factor_calculation_option(self) -> '_434.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_434.GearBlankFactorCalculationOptions)(value) if value is not None else None
    ...
    def film_thickness_equation_for_scuffing(self) -> '_443.ScuffingMethods':
        ...
        return constructor.new(_443.ScuffingMethods)(value) if value is not None else None
    ...
    def micropitting_rating_method(self) -> '_437.MicropittingRatingMethod':
        ...
        return constructor.new(_437.MicropittingRatingMethod)(value) if value is not None else None
    ...
    def permissible_bending_stress_method(self) -> '_440.RatingMethod':
        ...
        return constructor.new(_440.RatingMethod)(value) if value is not None else None
    ...
    def chosen_tooth_thickness_for_bending_strength(self) -> '_447.ToothThicknesses':
        ...
        return constructor.new(_447.ToothThicknesses)(value) if value is not None else None
