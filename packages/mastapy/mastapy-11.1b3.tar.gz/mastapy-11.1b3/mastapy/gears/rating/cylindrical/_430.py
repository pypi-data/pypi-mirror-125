...
class CylindricalMeshSingleFlankRating(_331.MeshSingleFlankRating):
    ...
    def contact_ratio_source(self) -> '_286.ContactRatioDataSource':
        ...
        return constructor.new(_286.ContactRatioDataSource)(value) if value is not None else None
    ...
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_1009.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_1009.ScuffingCoefficientOfFrictionMethods)(value) if value is not None else None
    ...
    def sorted_scuffing_results(self) -> '_425.CylindricalGearScuffingResults':
        ...
        return constructor.new(_425.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults is not None else None
    ...
    def sorted_scuffing_results_without_special_values(self) -> '_425.CylindricalGearScuffingResults':
        ...
        return constructor.new(_425.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues is not None else None
