...
class CylindricalGearRating(_326.GearRating):
    ...
    def vdi2737_safety_factor(self) -> '_448.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_448.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor is not None else None
