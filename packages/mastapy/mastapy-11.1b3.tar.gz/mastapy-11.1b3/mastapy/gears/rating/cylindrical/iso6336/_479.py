...
class ISO6336AbstractMetalMeshSingleFlankRating(_477.ISO6336AbstractMeshSingleFlankRating):
    ...
    def scuffing_rating_method_flash_temperature_method(self) -> '_441.ScuffingFlashTemperatureRatingMethod':
        ...
        return constructor.new(_441.ScuffingFlashTemperatureRatingMethod)(value) if value is not None else None
    ...
    def scuffing_rating_method_integral_temperature_method(self) -> '_442.ScuffingIntegralTemperatureRatingMethod':
        ...
        return constructor.new(_442.ScuffingIntegralTemperatureRatingMethod)(value) if value is not None else None
    ...
    def scuffing_temperature_method(self) -> '_1011.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_1011.ScuffingTemperatureMethodsISO)(value) if value is not None else None
    ...
    def sorted_micro_pitting_results(self) -> '_421.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_421.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults is not None else None
