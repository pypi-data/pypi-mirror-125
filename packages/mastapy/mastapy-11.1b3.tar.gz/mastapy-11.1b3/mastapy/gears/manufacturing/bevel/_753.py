...
class ManufacturingMachine(_1579.NamedDatabaseItem):
    ...
    def machine_type(self) -> '_752.MachineTypes':
        ...
        return constructor.new(_752.MachineTypes)(value) if value is not None else None
    ...
    def wheel_formate_machine_type(self) -> '_766.WheelFormatMachineTypes':
        ...
        return constructor.new(_766.WheelFormatMachineTypes)(value) if value is not None else None
