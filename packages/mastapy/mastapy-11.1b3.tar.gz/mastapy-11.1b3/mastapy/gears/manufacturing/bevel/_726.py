...
class AbstractTCA(_0.APIBase):
    ...
    def conical_mesh_misalignments(self) -> '_1091.ConicalMeshMisalignments':
        ...
        return constructor.new(_1091.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments is not None else None
