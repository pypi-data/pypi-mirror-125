...
class RoughCutterCreationSettings(_0.APIBase):
    ...
    def rough_tool_clearances(self) -> '_667.ManufacturingOperationConstraints':
        ...
        return constructor.new(_667.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances is not None else None
    ...
    def finish_tool_clearances(self) -> '_667.ManufacturingOperationConstraints':
        ...
        return constructor.new(_667.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances is not None else None
