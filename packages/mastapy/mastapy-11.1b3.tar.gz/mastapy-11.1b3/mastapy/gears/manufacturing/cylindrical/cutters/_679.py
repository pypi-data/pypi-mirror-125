...
class CylindricalGearFormGrindingWheel(_685.CylindricalGearRealCutterDesign):
    ...
    def right_hand_cutting_edge_shape(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.RightHandCuttingEdgeShape) if self.wrapped.RightHandCuttingEdgeShape is not None else None
