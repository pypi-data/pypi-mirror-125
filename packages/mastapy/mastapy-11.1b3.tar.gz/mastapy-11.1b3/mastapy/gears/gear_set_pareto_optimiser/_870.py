...
from mastapy.gears.gear_set_pareto_optimiser import _872
...
class ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase(_872.ParetoFaceRatingOptimisationStrategyDatabase):
    '''ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase
