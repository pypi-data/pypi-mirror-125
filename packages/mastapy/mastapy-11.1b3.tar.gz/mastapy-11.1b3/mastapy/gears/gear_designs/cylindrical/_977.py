...
from mastapy.gears.gear_designs.cylindrical import _1021, _939
...
class CylindricalMeshLinearBacklashSpecification(_1021.TolerancedValueSpecification['_939.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
