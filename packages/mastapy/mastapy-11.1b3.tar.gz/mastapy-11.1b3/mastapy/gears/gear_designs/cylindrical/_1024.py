...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    def normal_thickness(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness is not None else None
    ...
    def normal_thickness_at_specified_diameter(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter is not None else None
    ...
    def chordal_span(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan is not None else None
    ...
    def over_balls(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls is not None else None
    ...
    def transverse_thickness(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness is not None else None
    ...
    def transverse_thickness_at_specified_diameter(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter is not None else None
    ...
    def profile_shift_coefficient(self) -> '_973.CylindricalGearToothThicknessSpecification[_1452.Number]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1452.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient is not None else None
    ...
    def profile_shift(self) -> '_973.CylindricalGearToothThicknessSpecification[_1436.LengthShort]':
        ...
        return constructor.new(_973.CylindricalGearToothThicknessSpecification)[_1436.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift is not None else None
