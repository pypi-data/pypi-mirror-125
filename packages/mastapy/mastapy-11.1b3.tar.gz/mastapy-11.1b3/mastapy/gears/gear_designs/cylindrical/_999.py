...
class LtcaSettings(_1366.IndependentReportablePropertiesBase['LtcaSettings']):
    ...
    def load_case_modifiable_settings(self) -> '_998.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_998.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings is not None else None
