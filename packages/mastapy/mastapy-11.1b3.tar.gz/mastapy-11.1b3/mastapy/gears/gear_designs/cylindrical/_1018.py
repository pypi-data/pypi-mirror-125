...
class TiffAnalysisSettings(_1366.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    ...
    def measured_residual_stress_profile_property(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.MeasuredResidualStressProfileProperty) if self.wrapped.MeasuredResidualStressProfileProperty is not None else None
    ...
    def surface_material_properties(self) -> '_990.HardenedMaterialProperties':
        ...
        return constructor.new(_990.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties is not None else None
    ...
    def core_material_properties(self) -> '_990.HardenedMaterialProperties':
        ...
        return constructor.new(_990.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties is not None else None
