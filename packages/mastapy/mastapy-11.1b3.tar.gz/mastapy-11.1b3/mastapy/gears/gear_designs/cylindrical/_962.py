...
class CylindricalGearPinionTypeCutter(_946.CylindricalGearAbstractRack):
    ...
    def left_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_963.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
    ...
    def right_flank(self) -> '_963.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_963.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
