...
class ConicalGearCutter(_0.APIBase):
    ...
    def cutter_gauge_length(self) -> '_1093.CutterGaugeLengths':
        ...
        return constructor.new(_1093.CutterGaugeLengths)(value) if value is not None else None
    ...
    def cutter_blade_type(self) -> '_1092.CutterBladeType':
        ...
        return constructor.new(_1092.CutterBladeType)(value) if value is not None else None
    ...
    def input_toprem_as(self) -> '_1101.TopremEntryType':
        ...
        return constructor.new(_1101.TopremEntryType)(value) if value is not None else None
    ...
    def outer_toprem_letter_concave(self) -> '_1102.TopremLetter':
        ...
        return constructor.new(_1102.TopremLetter)(value) if value is not None else None
