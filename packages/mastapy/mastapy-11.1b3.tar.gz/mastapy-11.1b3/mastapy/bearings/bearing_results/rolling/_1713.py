...
class LoadedAsymmetricSphericalRollerBearingRow(_1753.LoadedRollerBearingRow):
    ...
    def loaded_bearing(self) -> '_1712.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1712.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
