...
class LoadedCylindricalRollerBearingResults(_1747.LoadedNonBarrelRollerBearingResults):
    ...
    def permissible_continuous_axial_load(self) -> '_1788.PermissibleContinuousAxialLoadResults':
        ...
        return constructor.new(_1788.PermissibleContinuousAxialLoadResults)(self.wrapped.PermissibleContinuousAxialLoad) if self.wrapped.PermissibleContinuousAxialLoad is not None else None
