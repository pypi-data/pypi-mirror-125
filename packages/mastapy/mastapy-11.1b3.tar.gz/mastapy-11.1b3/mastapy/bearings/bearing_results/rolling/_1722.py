...
class LoadedBallBearingDutyCycle(_1687.LoadedRollingBearingDutyCycle):
    ...
    def track_truncation_inner_summary(self) -> '_1589.DutyCyclePropertySummaryPercentage[_1725.LoadedBallBearingResults]':
        ...
        return constructor.new(_1589.DutyCyclePropertySummaryPercentage)[_1725.LoadedBallBearingResults](self.wrapped.TrackTruncationInnerSummary) if self.wrapped.TrackTruncationInnerSummary is not None else None
    ...
    def track_truncation_outer_summary(self) -> '_1589.DutyCyclePropertySummaryPercentage[_1725.LoadedBallBearingResults]':
        ...
        return constructor.new(_1589.DutyCyclePropertySummaryPercentage)[_1725.LoadedBallBearingResults](self.wrapped.TrackTruncationOuterSummary) if self.wrapped.TrackTruncationOuterSummary is not None else None
