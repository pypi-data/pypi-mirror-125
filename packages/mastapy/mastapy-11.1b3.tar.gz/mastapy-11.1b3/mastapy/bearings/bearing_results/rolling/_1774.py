...
from mastapy.bearings.bearing_results.rolling import _1742
...
class LoadedThreePointContactBallBearingElement(_1742.LoadedMultiPointContactBallBearingElement):
    '''LoadedThreePointContactBallBearingElement
