...
from mastapy.bearings.bearing_results.rolling import _1747
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1747.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
