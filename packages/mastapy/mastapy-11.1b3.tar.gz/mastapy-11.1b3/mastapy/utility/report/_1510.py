...
class CustomReport(_1520.CustomReportItemContainer):
    ...
    def cad_table_border_style(self) -> '_1506.CadTableBorderType':
        ...
        return constructor.new(_1506.CadTableBorderType)(value) if value is not None else None
    ...
    def page_size_for_cad_export(self) -> '_1505.CadPageSize':
        ...
        return constructor.new(_1505.CadPageSize)(value) if value is not None else None
    ...
    def include_report_check(self) -> '_1537.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1537.DefinitionBooleanCheckOptions)(value) if value is not None else None
