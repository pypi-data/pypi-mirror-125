...
class CustomReportPropertyItem(_0.APIBase):
    ...
    def font_weight(self) -> '_1540.FontWeight':
        ...
        return constructor.new(_1540.FontWeight)(value) if value is not None else None
    ...
    def font_style(self) -> '_1539.FontStyle':
        ...
        return constructor.new(_1539.FontStyle)(value) if value is not None else None
    ...
    def horizontal_position(self) -> '_1500.CellValuePosition':
        ...
        return constructor.new(_1500.CellValuePosition)(value) if value is not None else None
