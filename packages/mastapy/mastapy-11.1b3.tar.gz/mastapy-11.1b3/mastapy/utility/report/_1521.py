...
from mastapy.utility.report import _1522, _1523
...
T = TypeVar('T', bound='_1523.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1522.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
