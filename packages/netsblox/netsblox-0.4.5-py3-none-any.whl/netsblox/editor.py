...
class Pixabay:
    ...
    def get_image(self, url: str) -> Any:
        ...
        :returns: the requested image
        '''
        return self._client._call('Pixabay', 'getImage', { 'url': url })
    def search_all(self, keywords: str, max_height: Optional[float] = None, min_height: Optional[float] = None) -> List[dict]:
        ...
        '''
        res = self._client._call('Pixabay', 'searchAll', { 'keywords': keywords, 'maxHeight': max_height, 'minHeight': min_height })
        return _common.vectorize(dict)(res)
    def search_illustration(self, keywords: str, max_height: Optional[float] = None, min_height: Optional[float] = None) -> List[dict]:
        ...
        :returns: list of matching images
        '''
        res = self._client._call('Pixabay', 'searchIllustration', { 'keywords': keywords, 'maxHeight': max_height, 'minHeight': min_height })
        return _common.vectorize(dict)(res)
    def search_photo(self, keywords: str, max_height: Optional[float] = None, min_height: Optional[float] = None) -> List[dict]:
        ...
        :returns: list of matching images
        '''
        res = self._client._call('Pixabay', 'searchPhoto', { 'keywords': keywords, 'maxHeight': max_height, 'minHeight': min_height })
        return _common.vectorize(dict)(res)
