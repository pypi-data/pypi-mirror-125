...
void bch_compute_even_syndromes(struct bch_control *bch, unsigned int *syn)
{
	int i;
...
EXPORT_SYMBOL_GPL(bch_compute_even_syndromes);
			      ...
			      unsigned int *syn)
{
    ...
    bch_compute_even_syndromes(bch, syn);
}
 ...
 * @m:          Galois field order, should be in the range 5-31
