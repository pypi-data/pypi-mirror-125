"""
Settings for Linets with CORREOS_CHILE courier are all namespaced in the LINETS setting.
...
class APISettings:
    ...
    properties. For example:
        ...
        print(api_settings.CORREOS_CHILE)
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'DJANGO_CORREOS_CHILE', {})
...
def reload_api_settings(*args, **kwargs):
    ...
    if setting == 'DJANGO_CORREOS_CHILE':
        api_settings.reload()
