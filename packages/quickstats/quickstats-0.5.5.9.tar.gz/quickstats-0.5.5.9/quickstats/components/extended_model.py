...
class ExtendedModel(AbstractObject):
    ...
    def print_summary(self, items:Optional[List]=None, suppress_print:bool=False, save_as:Optional[str]=None):
        if items is None:
            items = ['workspace', 'dataset', 'category', 'poi', 'detailed_nuisance_parameter']
        summary_str = ""
        # workspace
