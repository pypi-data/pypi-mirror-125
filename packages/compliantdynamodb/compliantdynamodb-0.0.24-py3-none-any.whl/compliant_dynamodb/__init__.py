...
class CompliantDynamoDb(
    ...
    def __init__(
        ...
        *,
        ...
        config_rule_list: typing.Any = None,
        ...
        :param scope: -
        :param id: -
        :param backup_plan_start_time: provide a cron schedule that sets the start time of the backup. Default: Schedule - Schedule.cron({ hour: '21', minute: '0', }),
        :param backup_vault_name: name of the backup vault. Can only contain letters, numbers and _,- Default: - table name + '-backup-vault'
        :param config_rule_list: interface parameter description test. Default: - dynamodb table default settings
        ...
        props = CompliantDynamoDbProps(
            ...
            config_rule_list=config_rule_list,
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "config_rule_list": "configRuleList",
    },
)
class CompliantDynamoDbProps(aws_cdk.aws_dynamodb.TableProps):
    def __init__(
        ...
        *,
        ...
        if config_rule_list is not None:
            self._values["config_rule_list"] = config_rule_list
    ...
    def backup_plan_start_time(self) -> typing.Optional[aws_cdk.aws_events.Schedule]:
        '''provide a cron schedule that sets the start time of the backup.

        :default: Schedule - Schedule.cron({ hour: '21', minute: '0', }),
        '''
    ...
    def backup_vault_name(self) -> typing.Optional[builtins.str]:
        ...
        :default: - table name + '-backup-vault'
        '''
        result = self._values.get("backup_vault_name")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def config_rule_list(self) -> typing.Any:
        '''interface parameter description test.

        :default: - dynamodb table default settings

        :type: {RULE_IDENTIFIER : boolean}
        '''
        result = self._values.get("config_rule_list")
