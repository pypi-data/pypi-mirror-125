...
from ??? import aws_memorydb as aws
from"aws-cdk-lib"
```
'''
import abc
...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        cluster_endpoint: typing.Optional[typing.Union["CfnCluster.EndpointProperty", _IResolvable_da3f097b]] = None,
    ...
    def acl_name(self) -> typing.Optional[builtins.str]:
        ...
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "aclName"))

    @acl_name.setter
    def acl_name(self, value: typing.Optional[builtins.str]) -> None:
        jsii.set(self, "aclName", value)
    ...
    def cluster_endpoint(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnCluster.EndpointProperty", _IResolvable_da3f097b]], jsii.get(self, "clusterEndpoint"))
    ...
    def node_type(self) -> typing.Optional[builtins.str]:
        ...
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "nodeType"))

    @node_type.setter
    def node_type(self, value: typing.Optional[builtins.str]) -> None:
