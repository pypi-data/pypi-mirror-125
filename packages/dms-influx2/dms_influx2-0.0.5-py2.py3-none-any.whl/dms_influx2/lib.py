...
class DmsInflux2(InfluxDBClient):
    def __init__(self, url=None, token=None, org=None, enable_gzip=True, timezone_offset=None):
        ...
        if timezone_offset is None:
            ...
            timezone_offset = int(now.utcoffset().total_seconds() / 60 / 60)
        self.time_shift = f'{timezone_offset}h'
    ...
    def _get_tables(self, **kwargs) -> list:
        ...
        return self._perform_query(query=get_flux_query(**kwargs,
    ...
    def list_descriptions(self, bucket, measurement=None, time_range=None) -> list:
        ...
        return self._list_distinct_tags(bucket=bucket,
                                        measurement=measurement,
                                        time_range=time_range,
                                        tag='description')
