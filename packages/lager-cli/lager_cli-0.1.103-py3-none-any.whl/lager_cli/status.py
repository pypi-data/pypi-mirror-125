...
class TTYIO:
    ...
    """
    def __init__(self, line_ending=b'', opost=False, is_fixture=False, serial_channel=0):
...
async def display_job_output(connection_params, test_runner, interactive, line_ending, message_timeout, overall_timeout, eof_timeout, success_regex=None, failure_regex=None, opost=False, serial_channel=0, ptty=False):
    """
    ...
    if ptty:
        ...
        io_source = TTYIO(line_ending, opost, is_fixture, serial_channel)
    else:
...
def run_job_output(connection_params, test_runner, interactive, line_ending, message_timeout, overall_timeout, eof_timeout, debug=False, success_regex=None, failure_regex=None, opost=False, serial_channel=0, ptty=False):
    """
    ...
    try:
        matcher = trio.run(display_job_output, connection_params, test_runner, interactive, line_ending, message_timeout, overall_timeout, eof_timeout, success_regex, failure_regex, opost, serial_channel, ptty)
