...
# -*- coding: utf-8 -*-
#
# jupyter_widget_echo_testing documentation build configuration file
#
...
project = 'jupyter_widget_echo_testing'
copyright = '2021, Kyle Barron'
author = 'Kyle Barron'
...
_version_py = os.path.join(repo, 'jupyter_widget_echo_testing', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_widget_echo_testingdoc'
...
latex_documents = [
    (master_doc, 'jupyter_widget_echo_testing.tex', 'jupyter_widget_echo_testing Documentation',
     'Kyle Barron', 'manual'),
]
...
man_pages = [
    (master_doc,
    'jupyter_widget_echo_testing',
    'jupyter_widget_echo_testing Documentation',
     [author], 1)
]
