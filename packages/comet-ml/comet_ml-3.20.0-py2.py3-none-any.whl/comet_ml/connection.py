...
from .config import DEFAULT_PARAMETERS_UPDATE_INTERVAL_SECONDS, DEFAULT_WS_JOIN_TIMEOUT
...
class RestServerConnection(object):
    ...
    def update_experiment_status(self, run_id, project_id, is_alive, offline=False):
        ...
        parameters_update_interval = data.get(
            "parameter_update_interval_millis",
            DEFAULT_PARAMETERS_UPDATE_INTERVAL_SECONDS * 1000,
        )
        ...
        return_data = {
            ...
            "parameters_update_interval": parameters_update_interval,
        }
