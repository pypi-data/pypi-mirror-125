...
GIT_REPO_NOT_FOUND = "Couldn't find a Git repository in %r and lookings in parents. You can override where Comet is looking for a Git Patch by setting the configuration `COMET_GIT_DIRECTORY`"
