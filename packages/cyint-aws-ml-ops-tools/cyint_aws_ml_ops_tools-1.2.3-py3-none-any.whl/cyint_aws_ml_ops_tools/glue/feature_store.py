...
def define_feature_group(
    ...
    data_lake_bucket_name = os.environ['DATA_LAKE_BUCKET'] if data_lake_bucket is None else data_lake_bucket
    ...
    offline_store_config_object = {} if offline_store_config is None else offline_store_config
