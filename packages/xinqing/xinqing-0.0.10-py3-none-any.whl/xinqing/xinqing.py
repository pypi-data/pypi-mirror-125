...
# import vlc
import os
from .playsound122 import playsound
...
relative_mp3_file_path='./typing_long.mp3'

os.chdir(cur_file_folder)
...
class Xinqing:
    def __init__(self):
        ...
        #self.p = multiprocessing.Process(target=playsound, args=(mp3_file_path,))
    ...
    def do_what(self):
        ...
        # self.sound.play()
        # try:
        #    playsound(mp3_file_path,False)
        # except:
        #    raise "playsound error"
