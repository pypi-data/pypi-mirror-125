...
from data_point_client.api.data_point import data_point_get_data_points_all
...
class GnistaDataPoints:
    ...
    def get_data_point_list(self) -> Generator[GnistaDataPoint, None, None]:
        ...
        data_point_list = data_point_get_data_points_all.sync(client=client, existence=[EnDataPointExistenceDTO.FULL])
