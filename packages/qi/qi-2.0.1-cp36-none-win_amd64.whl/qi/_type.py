...
from .qi_python import Object as _Object
...
_ToInheritMetaSignature = _MetaSignature(
    '_ToInheritMetaSignature', (object, ), {})
...
# eg: qi.bind(Void, AnyArguments)        this is not a tuple. (m not in tuple,
#                                        mean anythings)
...
def _isinstance(a, type):
    ...
    """
    if type != Object:
        raise NotImplementedError("isinstance is only implemented for Object"
                                  "right now")
    try:
