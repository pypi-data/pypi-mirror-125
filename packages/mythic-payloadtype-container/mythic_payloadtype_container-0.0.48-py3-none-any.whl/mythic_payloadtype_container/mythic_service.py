    ...
    async with message.process():
        ...
        if command == "create_payload_with_code":
            ...
            try:
                ...
                message = {"task": task.to_json(), "message": "[-] Mythic error while creating/running create_tasking: \n" + str(e)}
                await send_status(
                    message=json.dumps(message),
                    command="command_transform",
            ...
            print_flush("[*] Container versions and information can be found at: https://docs.mythic-c2.net/customizing/payload-type-development/container-syncing#current-payloadtype-versions")
