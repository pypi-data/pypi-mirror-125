...
function GetOciSubcommands_iam() {
    $ociSubcommands = @{
        'iam' = 'api-key auth-token authentication-policy availability-domain bulk-action-resource-type-collection bulk-edit-tags-resource-type-collection compartment customer-secret-key dynamic-group fault-domain group identity-provider identity-provider-group idp-group-mapping mfa-totp-device network-sources policy region region-subscription scim-client-credentials smtp-credential swift-password tag tag-default tag-namespace tagging-work-request tagging-work-request-error tagging-work-request-log tenancy ui-password ui-password-information user user-group-membership work-request'
        ...
        'iam tag' = 'bulk-delete bulk-edit create create-tag-default-tag-definition-validator create-tag-enum-tag-definition-validator delete get list list-cost-tracking update update-tag-default-tag-definition-validator update-tag-enum-tag-definition-validator'
        ...
        'iam user' = 'create create-o-auth-client-credential delete delete-o-auth-client-credential get list list-o-auth-client-credentials update update-o-auth-client-credential update-user-capabilities update-user-state'
