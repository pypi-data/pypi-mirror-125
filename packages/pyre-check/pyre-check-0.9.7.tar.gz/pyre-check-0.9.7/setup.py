...
def main() -> None:
    ...
    run(
        ...
        runtime_dependencies=json.loads("""["async-generator", "click", "dataclasses;python_version=='3.6'", "dataclasses-json", "libcst>=0.3.6", "psutil", "pyre-extensions", "pywatchman", "tabulate", "typing-extensions"]"""),
        long_description=long_description,
    )
