...
"""
class Inference_V2(object):
    def __init__(self, dataset, model, patch_size, step_size = 0.5,  is_deep_supervision = False):
        self.dataset = dataset
        self.model = model
    ...
    def get_next_coords(self):
        # 방향 정하기
        # 각 축의 마지막 step인지 판단
        # step 시 위치를 판단하는 함수 이를 테면 중앙 coords => 
