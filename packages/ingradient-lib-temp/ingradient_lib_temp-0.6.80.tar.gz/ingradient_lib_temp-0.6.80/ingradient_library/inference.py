...
class InferenceV2(object):
    def __init__(self, dataset, model, patch_size, n_classes, step_size = [0.5, 0.5, 0.5], postprocessing = None, device = None,
                 batch_size = 2, conected_component = True, gaussian_filter = False, deep_supervision = False):
