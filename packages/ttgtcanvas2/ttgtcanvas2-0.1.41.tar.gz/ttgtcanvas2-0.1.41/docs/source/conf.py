...
# -*- coding: utf-8 -*-
#
# ttgtcanvas2 documentation build configuration file
#
...
project = 'ttgtcanvas2'
copyright = '2021, Indresh Vishwakarma'
...
_version_py = os.path.join(repo, 'ttgtcanvas2', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ttgtcanvas2doc'
...
latex_documents = [
    (master_doc, 'ttgtcanvas2.tex', 'ttgtcanvas2 Documentation',
     'Indresh Vishwakarma', 'manual'),
]
