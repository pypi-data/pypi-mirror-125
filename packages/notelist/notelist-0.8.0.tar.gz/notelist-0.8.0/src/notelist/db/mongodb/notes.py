...
class MongoDbNoteManager(NoteManager):
    """MongoDB note manager."""
    ...
    def setup(self):
        ...
        # Create index. The collection is created if it doesn't exist.
        fields = [("notebook_id", ASCENDING)]
        self._col.create_index(fields, unique=True, name="notebook_id_index")
