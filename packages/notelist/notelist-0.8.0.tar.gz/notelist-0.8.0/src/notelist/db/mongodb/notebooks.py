...
class MongoDbNotebookManager(NotebookManager):
    """MongoDB notebook manager."""
    ...
    def setup(self):
        ...
        # Create indexes. The collection is created if it doesn't exist.
