...
class ManualInputTopLevel(tk.Toplevel):
    def __init__(self,supportList):
        ...
        leftFrame = tk.Frame(master=self,background="yellow")
        leftFrame.grid(row=0,column=0,sticky='nsew')
        leftFrame.grid_propagate(False)

        companyLable = tk.Label(leftFrame,text="Company",background='#B522BA',font=("Arial", 15))
        ...
        policyLable = tk.Label(leftFrame,text="Policy No.",background='#B522BA',font=("Arial", 15))
        ...
        rightFrame = tk.Frame(master=self,background="blue")
