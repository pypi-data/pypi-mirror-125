...
class EditSettingTopLevel(tk.Toplevel):
    def __init__(self):
        ...
        mainFrame = tk.Frame(master=self,background="yellow")
        mainFrame.grid(row=0,column=0,sticky='nsew')
        mainFrame.grid_propagate(False)
        
        #Output Path related
        outputPathLable = tk.Label(mainFrame,text="Output Path",background='#B522BA',font=("Arial", 13))
        ...
        #Input Path related
        inputPathLable = tk.Label(mainFrame,text="Input Path",background='#B522BA',font=("Arial", 13))
