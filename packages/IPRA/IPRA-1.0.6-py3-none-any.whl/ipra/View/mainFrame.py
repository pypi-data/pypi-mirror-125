...
class MainApplication(tk.Tk):
    ...
    def __init__(self):
        ...
        frame_open_excel = tk.Frame(master=self.main_frame,background="yellow")
        frame_open_excel.grid(row=0,column=0,sticky='nsew')
        frame_open_excel.grid_propagate(0)

        #Display Policy no. and running status
        self.frame_running_state = tk.Frame(master=self.main_frame,background="green")
        ...
        frame_exeRobot = tk.Frame(master=self.main_frame,background="blue")
