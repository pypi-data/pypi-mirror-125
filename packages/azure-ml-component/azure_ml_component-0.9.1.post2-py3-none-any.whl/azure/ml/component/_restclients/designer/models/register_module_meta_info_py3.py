...
class RegisterModuleMetaInfo(Model):
    ...
    def __init__(self, *, namespace: str=None, module_name: str=None, module_version: str=None, module_entity_from_yaml=None, set_as_default_version: bool=None, family_id: str=None, **kwargs) -> None:
