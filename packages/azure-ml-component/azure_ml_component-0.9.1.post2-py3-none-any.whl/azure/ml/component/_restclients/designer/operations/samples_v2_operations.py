...
class SamplesV2Operations(object):
    ...
    def open_sample_and_get_draft(
        ...
        return deserialized
    open_sample_and_get_draft.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/Samples/open/{name}'}
