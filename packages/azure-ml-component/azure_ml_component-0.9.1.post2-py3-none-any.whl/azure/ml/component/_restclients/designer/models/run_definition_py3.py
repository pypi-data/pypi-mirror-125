...
class RunDefinition(Model):
    ...
    def __init__(self, *, configuration=None, snapshot_id: str=None, snapshots=None, parent_run_id: str=None, run_type: str=None, display_name: str=None, primary_metric_name: str=None, description: str=None, properties=None, tags=None, **kwargs) -> None:
