...
from pkm_buildsys.semver.version_constraint import VersionConstraint
from pkm_buildsys.semver.version_range import VersionRange
from pkm_buildsys.version.exceptions import InvalidVersion
from pkm_buildsys.version.markers import parse_marker

from pkm_main.locations import REPOSITORY_CACHE_DIR
from pkm_main.utils._compat import to_str
from pkm_main.utils.patterns import wheel_file_re
...
class PyPiRepository(RemoteRepository):
    ...
    def get_release_info(self, name: str, version: str, project: ManagedProject) -> "PackageInfo":
        ...
        package = data.to_package()
        if package.python_constraint.intersect(project.env.python_constraint).is_empty():
            # this package is not usable for this project - we can stop trying to bring more information
            return data
