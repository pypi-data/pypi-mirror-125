...
from pkm_buildsys.factory import Factory
...
from pkm_buildsys.utils.helpers import parse_requires
from pkm_buildsys.utils.helpers import temporary_directory
from pkm_buildsys.version.markers import InvalidMarker
from pkm_main.utils.env import EnvCommandError
from pkm_main.utils.env import ephemeral_environment
from pkm_main.utils.setup_reader import SetupReader
...
class PackageInfo:
    ...
    def to_package(
        ...
        """
        Create a new `pkm_buildsys.packages.package.Package` instance using metadata from this instance.
    ...
    def _get_poetry_package(path: Path) -> Optional[ProjectPackage]:
        ...
        if Project.has_poetry_section(path.joinpath("pyproject.toml")):
