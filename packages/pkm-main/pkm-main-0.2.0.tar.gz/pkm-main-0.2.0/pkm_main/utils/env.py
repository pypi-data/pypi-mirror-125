...
from pkm_buildsys.utils import toml
from pkm_buildsys.utils.props_ext import cached_property
...
from pkm_buildsys.version.markers import BaseMarker

from pkm_main.console import console
from pkm_main.locations import CACHE_DIR

from pkm_main.utils._compat import decode
from pkm_main.utils._compat import encode
from pkm_main.utils._compat import list_to_shell_command
from pkm_main.utils._compat import metadata
from pkm_main.utils.helpers import is_dir_writable
from pkm_main.utils.helpers import paths_csv
from pkm_main.utils.helpers import temporary_directory
    ...
    def create_venv(
        ...
        if not supported_python.allows(Version.parse(python_patch)):
            ...
            for python_to_try in reversed(
                ...
                console.println(f"<debug>Trying {python}</debug>", Verbosity.DEBUG)
    ...
    def get_system_env(cls, naive: bool = False) -> Union["SystemEnv", "GenericEnv"]:
        ...
        if not naive:
            if prefix.joinpath("poetry_env").exists():
                ...
                from pkm_main.locations import data_dir
