...
"""
    ...
    def handle(self) -> int:
        ...
        from pkm_buildsys.vcs.git import GitConfig
        from pkm_main.layouts import layout
        from pkm_main.utils.env import SystemEnv
        ...
        for requirement in requirements:
            ...
            if url_parsed.scheme and url_parsed.netloc:
                ...
                if url_parsed.scheme in ["git+https", "git+ssh"]:
                    ...
                    from pkm_buildsys.vcs.git import ParsedUrl
    ...
    def _validate_author(self, author: str, default: str) -> Optional[str]:
        from pkm_buildsys.packages.package import AUTHOR_REGEX
    ...
    def _validate_license(self, license: str) -> str:
        from pkm_buildsys.spdx.helpers import license_by_id
