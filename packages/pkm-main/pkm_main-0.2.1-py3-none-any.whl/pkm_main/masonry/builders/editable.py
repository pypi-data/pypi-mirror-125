...
from pkm_buildsys.masonry.builders.builder import Builder
from pkm_buildsys.masonry.builders.sdist import SdistBuilder
from pkm_buildsys.masonry.utils.package_include import PackageInclude
from pkm_buildsys.semver.version import Version

from pkm_main.console import console
from pkm_main.utils._compat import WINDOWS
from pkm_main.utils._compat import decode
from pkm_main.utils.helpers import is_dir_writable
from pkm_main.utils.pip import pip_editable_install

if TYPE_CHECKING:
    from cleo.io.io import IO  # noqa

    from pkm_buildsys.poetry import Poetry
...
class EditableBuilder(Builder):
    ...
    def _add_dist_info(self, added_files: List[Path]) -> None:
        from pkm_buildsys.masonry.builders.wheel import WheelBuilder
