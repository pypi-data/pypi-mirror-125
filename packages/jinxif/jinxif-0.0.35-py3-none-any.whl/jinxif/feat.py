...
def filter_cellpose_xy(
    ...
    for s_slide in sorted(es_slide):
        ...
        df_xy_slide.to_csv(s_path_segdir + config.d_nconv['s_format_csv_centroidxy'].format(s_slide))
...
def _thresh_cytoplasm(
    ...
    #ls_neg_cells = df_mi.loc[(df_mi.loc[:,f'{s_thresh_marker}_cytoplasm'] < i_thresh_manual), :].index.tolist() this is wrong becasue of nas
