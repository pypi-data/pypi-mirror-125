...
class MessageProcessor(threading.Thread):
    ...
    def process_client_message(self, message, client):
        ...
        # Если это сообщение, то добавляем его в очередь сообщений. Ответ не требуется.
            ...
            # За такую структуру условий можно бить, но мне пока что так проще понимать код
            # множество and в строке сбивает
        ...
        # Если это запрос контакт-листа
            ...
            if USER in message and self.names[message[USER]] == client:
        ...
        # Если это добавление контакта
            ...
            if ACCOUNT_NAME in message and USER in message:
                if self.names[message[USER]] == client:
