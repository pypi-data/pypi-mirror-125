...
def getImageCluster( lon_deg,lat_deg,   delta_long, delta_lat,zoom,printlog,imgsavepath,style = 4,apikey = '',access_token = '',styleid = 'light'):
    ...
    if (style == 4 )|(style == 'light' ):
        access_token = 'pk.eyJ1IjoibmkxbzEiLCJhIjoiY2pldGxtNGhyMGtnNTJ3cGU4Ymt6c3Z3ciJ9.pqgh09z8NCQfONAuukSUPA'
...
def plot_map(plt,bounds,zoom,style=4,imgsavepath = r'/Users/yuqing/Nutstore Files/我的坚果云/python_new/',printlog = False,apikey = '',access_token = '',styleid = 'light'):
    '''
