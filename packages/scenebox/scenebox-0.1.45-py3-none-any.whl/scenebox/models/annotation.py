...
from ..constants import (AnnotationMediaTypes, AnnotationTypes, AssetsConstants)
...
class Annotation(object):
    def __init__(self, **kwargs):
        ...
        self.ground_truth: str = "true" if kwargs.get("ground_truth", True) else "false"
        self.masks: List[ObjectAccess] = kwargs.get("masks", [])
