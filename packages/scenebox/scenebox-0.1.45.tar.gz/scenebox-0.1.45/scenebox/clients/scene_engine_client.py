...
class SceneEngineClient(object):
    ...
    def search_similar_assets(self,
       ...
       """
        ...
        if not resp.ok:
            raise SimilaritySearchError("finding {} assets similar to {} failed: {}".format(asset_type, id, resp.content))
    ...
    def display_dashboard(self, dashboard_name: str):
        ...
        """
        self.__display_url(url="projects?project={}".format(dashboard_name))
