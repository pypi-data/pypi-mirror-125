...
class CorporateActionsKey(System.Object):
    """Unique definition key for a collection of corporate actions for a Market and SecurityType"""

    EquityUsa: QuantConnect.Data.Auxiliary.CorporateActionsKey
    ...
    @staticmethod
    @typing.overload
    def Create(symbol: typing.Union[QuantConnect.Symbol, str]) -> QuantConnect.Data.Auxiliary.CorporateActionsKey:
        """Helper method to create a new instance from a Symbol"""
        ...

    @staticmethod
    @typing.overload
    def Create(securityIdentifier: QuantConnect.SecurityIdentifier) -> QuantConnect.Data.Auxiliary.CorporateActionsKey:
...
class FactorFileZipHelper(System.Object):
    ...
    @staticmethod
    def ReadFactorFileZip(file: System.IO.Stream, mapFileResolver: QuantConnect.Data.Auxiliary.MapFileResolver, market: str, securityType: QuantConnect.SecurityType) -> System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.Auxiliary.FactorFile]]:
