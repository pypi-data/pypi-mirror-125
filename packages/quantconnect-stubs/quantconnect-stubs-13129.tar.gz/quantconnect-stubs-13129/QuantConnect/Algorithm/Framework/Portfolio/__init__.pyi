...
class EqualWeightingAlphaStreamsPortfolioConstructionModel(System.Object, QuantConnect.Algorithm.Framework.Portfolio.IPortfolioConstructionModel):
    """
    ...
    def GetAlphaWeight(self, portfolioState: QuantConnect.Data.Custom.AlphaStreams.AlphaStreamsPortfolioState, totalUsablePortfolioValue: float, cashBook: QuantConnect.Securities.CashBook) -> float:
        """
        Determines the portfolio weight to give a specific alpha. Default implementation just returns equal weighting
        
        This method is protected.
        
        :param portfolioState: The alphas portfolio state to get the weight for
        :param totalUsablePortfolioValue: This algorithms usable total portfolio value
        :param cashBook: This algorithms cash book
        :returns: The weight to use on this alphas positions.
        """
        ...
