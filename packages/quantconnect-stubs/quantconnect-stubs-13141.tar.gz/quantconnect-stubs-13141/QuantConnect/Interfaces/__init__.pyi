...
class IMapFileProvider(metaclass=abc.ABCMeta):
    ...
    def Get(self, corporateActionsKey: QuantConnect.Data.Auxiliary.CorporateActionsKey) -> QuantConnect.Data.Auxiliary.MapFileResolver:
        """
        Gets a MapFileResolver representing all the map
        files for the specified market
        
        :param corporateActionsKey: Key used to fetch a map file resolver. Specifying market and security type
