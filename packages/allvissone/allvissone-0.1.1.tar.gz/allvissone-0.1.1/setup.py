...
VERSION = '0.1.1'
DESCRIPTION = 'Install all Data Science Visualization package in single line'
LONG_DESCRIPTION = 'A package that allow you to install all python data science visualization packages in single line of code and save your time.'
