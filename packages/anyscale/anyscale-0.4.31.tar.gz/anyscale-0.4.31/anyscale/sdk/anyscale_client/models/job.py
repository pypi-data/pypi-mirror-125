...
class Job(object):
    ...
    def __init__(self, id=None, ray_session_name=None, ray_job_id=None, name=None, status=None, created_at=None, finished_at=None, cluster_id=None, namespace_id=None, runtime_environment_id=None, project_id=None, creator_id=None, local_vars_configuration=None):  # noqa: E501
