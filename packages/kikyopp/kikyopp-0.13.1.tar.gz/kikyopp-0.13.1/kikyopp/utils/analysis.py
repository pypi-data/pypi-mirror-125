...
from kikyopp.utils.constants import YURI_API_HOST
...
@retry_rest_api
def get_data_custom_tags(data_source: str, id: str) -> list:
    resp = requests.get(
        f'{YURI_API_HOST}/analysis/api/simple-search/data-custom-tags',
        params={
