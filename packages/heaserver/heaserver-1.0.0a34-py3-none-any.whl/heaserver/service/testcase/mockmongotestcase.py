...
def get_test_case_cls(href: Union[str, URL],
                      ...
                      expected_opener_body: Optional[Dict[str, Any]] = None) -> Type[mongotestcase.MongoTestCase]:
    """
...
def get_test_case_cls_default(coll: str,
                              ...
                              expected_opener: Optional[LinkSpec] = None) -> Type[mongotestcase.MongoTestCase]:
    if href is None:
        href_ = URL(f'/{coll}/')
    else:
        href_ = str(href)
