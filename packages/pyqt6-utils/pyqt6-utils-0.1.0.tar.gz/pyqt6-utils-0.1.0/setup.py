...
setuptools.setup(
    ...
    # Имя дистрибутива пакета. Оно должно быть уникальным, поэтому добавление
    # вашего имени пользователя в конце является обычным делом.
    name="pyqt6-utils",
    ...
    # Имя автора.
    author="gloger2003 (Anight Studio)",

    # Его почта.
    author_email="excelsior7554@gmail.com",

    # Краткое описание, которое будет показано на странице PyPi.
    description="Utils for PyQt6 (In past: pyqt6-forms)",

    # Длинное описание, которое будет отображаться на странице PyPi.
    # Использует README.md репозитория для заполнения.
    # long_description="README: https://github.com/gloger2003/pyqt6-forms",
    ...
    url="https://github.com/gloger2003/pyqt6-forms",
