...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.detectDurationLabel = QtWidgets.QLabel(self.layoutWidget)
        self.detectDurationLabel.setObjectName("detectDurationLabel")
        self.horizontalLayout_17.addWidget(self.detectDurationLabel)
        self.detectabilityDurationEdit = QtWidgets.QLineEdit(self.layoutWidget)
        self.detectabilityDurationEdit.setObjectName("detectabilityDurationEdit")
        self.horizontalLayout_17.addWidget(self.detectabilityDurationEdit)
        self.durStepLabel = QtWidgets.QLabel(self.layoutWidget)
        self.durStepLabel.setObjectName("durStepLabel")
        self.horizontalLayout_17.addWidget(self.durStepLabel)
        self.durStepEdit = QtWidgets.QLineEdit(self.layoutWidget)
        self.durStepEdit.setObjectName("durStepEdit")
        self.horizontalLayout_17.addWidget(self.durStepEdit)
        self.detectMagDropLabel = QtWidgets.QLabel(self.layoutWidget)
        self.detectMagDropLabel.setObjectName("detectMagDropLabel")
        self.horizontalLayout_17.addWidget(self.detectMagDropLabel)
        self.detectabilityMagDropEdit = QtWidgets.QLineEdit(self.layoutWidget)
        self.detectabilityMagDropEdit.setObjectName("detectabilityMagDropEdit")
        self.horizontalLayout_17.addWidget(self.detectabilityMagDropEdit)
        self.calcDetectabilityButton = QtWidgets.QPushButton(self.layoutWidget)
        self.calcDetectabilityButton.setObjectName("calcDetectabilityButton")
        self.horizontalLayout_17.addWidget(self.calcDetectabilityButton)
        self.verticalLayout_2.addLayout(self.horizontalLayout_17)
        spacerItem4 = QtWidgets.QSpacerItem(555, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.calcStatsFromBaselineRegionsButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">When this button is clicked,&nbsp;all the points included in the marked \'baseline\' regions will be collected and used to calculate the baseline mean,&nbsp;noise-sigma,&nbsp;and the noise-correlation coefficients.&nbsp;Unless a \'trim\' is performed,&nbsp;these values will be used during error bar estimations and \'false-positive\' estimation.</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">NOTE:</span><span style=\" font-size:18pt;\"> If a \'trim\' is performed,&nbsp;</span><span style=\" font-size:18pt; font-weight:600;\">the baseline mean will be determined from the \'fit\' to the trimmed data,</span><span style=\" font-size:18pt;\">&nbsp;but the noise-sigma and noise-correlation coefficients extracted from the marked \'background\' regions will continue to override those obtained from the trimmed light-curve.</span></p><p><span style=\" font-size:18pt;\">This is done so that if the mean baseline level on either side of the event appears to be a little different than the overall baseline,&nbsp;one can get improved baseline noise stats by using points from the entire light-curve,&nbsp;yet trim the light-curve around the event and allow the \'finder/fitter\' to calculate a baseline mean from the immediately adjacent points.</span></p></body></html>"))
        self.calcStatsFromBaselineRegionsButton.setText(_translate("MainWindow", "Calc baseline mean/sigma/corr coeffs"))
        self.detectDurationLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Enter the expected duration of the event in seconds (or a duration you want to use for test purposes). </span></p></body></html>"))
        ...
        self.calcDetectabilityButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">This button activates a special version of the False-Positive calculator to help determine whether an occultation observation planned for the near future is detectable given the star signal available from the observation location, the expected duration of the event, and the expected magDrop of the event. </span></p><p><span style=\" font-size:18pt; color:#fc0107;\">Please keep in mind that this is a simulation using random numbers, so repeated calculations with the same duration and magDrop will naturally give slightly different answers.</span></p><p><span style=\" font-size:18pt;\">The workflow is as follows:</span></p><p><span style=\" font-size:18pt;\">1. Make a video of the target star with at least a few hundred frames. The video needs to be long enough and under the anticipated observation conditions and camera settings to be used during the actual event so that a valid estimate of the expected intensity of the target star, the noise level, and the correlation coefficients of that noise during the actual event can be obtained.</span></p><p><span style=\" font-size:18pt;\">2. Use PyMovie (or Tangra or LiMovie) to extract a light-curve from the video.</span></p><p><span style=\" font-size:18pt;\">3. Read the light-curve into PyOTE, then click on two points in the light-curve plot to designate those points that should be used for the needed intensity and noise calculations.</span></p><p><span style=\" font-size:18pt;\">4. Click the </span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">Mark baseline region</span><span style=\" font-size:18pt;\"> button (to the left above this one), then the </span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">Calc baseline stats</span><span style=\" font-size:18pt;\"> button to the right - this is what triggers the extraction of the needed intensity and noise data, a pre-requisite to performing the next step:</span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\"> Calc detectability</span><span style=\" font-size:18pt;\">.</span></p><p><span style=\" font-size:18pt;\">5. Before clicking the </span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">Calc detectability</span><span style=\" font-size:18pt;\"> button, you must fill in the expected duration of the event in seconds.</span></p><p><span style=\" font-size:18pt;\">6. Next, fill in the expected magDrop (a positive number).</span></p><p><span style=\" font-size:18pt;\">7. Click the</span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\"> Calc detectability</span><span style=\" font-size:18pt;\"> button and, after a pause while 50,000 trial observations are computed, a False-Positive plot will appear. The position of the red vertical line relative to the black line tells the detectability story: if the red line is to right of the black line, the event has a high probabilty of being detected - if the red line is to the left of the black line it has a lower probability of detection, with that probablity decreasing as the red line moves more and more to the left of the black line. </span></p><p><br/></p></body></html>"))
        ...
        self.writeCSVButton.setText(_translate("MainWindow", "Save current light-curve"))
