...
def _adjustSyllabification(
    adjustedPhoneList: List[str], syllableList: List[List[int, str]]
):
    """
...
def _findBestPronunciation(isleWordList: List[List[str], List[int]], aPron: List[str]):
    """
...
def _getSyllableNucleus(phoneList: List[str]) -> int:
    """
