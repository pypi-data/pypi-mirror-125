...
__Note that this documentation, though still valid, has not been updated for a while and paramparse now has lots of advanced text file processing capabilities involving hierarchical named sections with templating and sequencing that are not documented here.__    
