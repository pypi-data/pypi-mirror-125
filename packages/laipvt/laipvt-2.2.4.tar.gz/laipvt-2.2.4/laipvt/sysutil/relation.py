...
module_require_tfserver = ("ocr_standard", "captcha", "nlp", "ocr_seal_server")
tfserver_name = {
    ...
    "nlp": ["bert-service-tf"],
    "ocr_seal_server": ["ocr-seal-tf-serving"]
}
...
module_info = {
    ...
    38: ("ocr_seal_server", "印章识别(标准版 CPU)"),
    39: ("ocr_seal_server_gpu", "印章识别(标准版 GPU)"),
