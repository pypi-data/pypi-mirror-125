...
def get_allocation_stats():
    rxb__bron = [get_allocation_stats_arr(), get_allocation_stats_dec(),
        get_allocation_stats_pq(), get_allocation_stats_qa()]
    mrlxn__tqtzk, noed__lyib, vibx__imhq, mavo__wmsr = 0, 0, 0, 0
    for tmmjq__haofa in rxb__bron:
        mrlxn__tqtzk += tmmjq__haofa[0]
        noed__lyib += tmmjq__haofa[1]
        vibx__imhq += tmmjq__haofa[2]
        mavo__wmsr += tmmjq__haofa[3]
    return mrlxn__tqtzk, noed__lyib, vibx__imhq, mavo__wmsr
