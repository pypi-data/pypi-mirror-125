...
class Jpeg(Type):
    ...
    def __init__(self):
        super(Jpeg, self).__init__(mime=Jpeg.MIME, extension=Jpeg.EXTENSION)
...
class Heic(isobmff._IsoBmff):
    ...
    def __init__(self):
        super(Heic, self).__init__(mime=Heic.MIME, extension=Heic.EXTENSION)
...
class Dcm(Type):
    ...
    def __init__(self):
        super(Dcm, self).__init__(mime=Dcm.MIME, extension=Dcm.EXTENSION)
...
class Dwg(Type):
    ...
    def __init__(self):
        super(Dwg, self).__init__(mime=Dwg.MIME, extension=Dwg.EXTENSION)
...
class Xcf(Type):
    ...
    def __init__(self):
        super(Xcf, self).__init__(mime=Xcf.MIME, extension=Xcf.EXTENSION)
