...
LED_INVERT     = pfc.get_config_param(cfg, 'LED_INVERT')      # True to invert the signal (when using NPN transistor level shift)
...
if __name__ == '__main__':
  ...
  parser.add_argument("-a", "--animation-mode", default="demo", choices=["demo", "color-wipe", "theater-chase", "rainbow", "sunrise", "sunset"], help="type of animation to start")
  parser.add_argument("-n", "--named-color",    default="blue", choices=["red", "aqua", "blue", "green", "yellow", "fuchsia", "white", "maroon", "black", "orange", "compWhite"], help="Color to use")
  parser.add_argument("-o", "--rgb-order",      default=LED_RGB_ORDER, choices=["RGB", "GRB", "BRG", "RBG", "GBR", "BGR"], help="order in which to pass the colors")
  parser.add_argument("-d", "--duration",       default=30, action='store', help="duration in seconds --animation=sunrise is going to last")
