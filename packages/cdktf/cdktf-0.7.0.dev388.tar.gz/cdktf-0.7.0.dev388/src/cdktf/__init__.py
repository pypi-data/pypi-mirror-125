...
class ComplexObject(metaclass=jsii.JSIIMeta, jsii_type="cdktf.ComplexObject"):
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="isSingleItem")
    def _is_single_item(self) -> builtins.bool:
        '''
        :stability: experimental
        '''
        return typing.cast(builtins.bool, jsii.get(self, "isSingleItem"))

    @_is_single_item.setter
    def _is_single_item(self, value: builtins.bool) -> None:
        jsii.set(self, "isSingleItem", value)
