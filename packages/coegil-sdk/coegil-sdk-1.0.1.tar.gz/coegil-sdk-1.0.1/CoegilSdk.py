...
class Coegil:
    ...
    def save_file(self, asset_id: str, artifact_name: str, contents: Union[str, bytes]) -> NoReturn:
        """
        Reads the contents of a file artifact.
        Args:
            asset_id (str): The asset's unique identifier.
        ...
        Returns:
            A contents of the file
        """
        self._upload_file(asset_id, artifact_name, contents)
    ...
    def _put_s3_object(self, bucket, key, body: Union[IO, str, bytes], content_type: str = None, credential_override=None):
