...
[boto3.ApplicationDiscoveryService 1.19.5](https://boto3.amazonaws.com/v1/documentation/api/1.19.5/reference/services/discovery.html#ApplicationDiscoveryService)
