...
from powerbot_backtesting.utils.helper_functions import _cache_data, _find_cache, _get_file_cachepath
...
class ApiExporter(BaseExporter):
    ...
    def get_contracts(self,
                      ...
                      delivery_areas: list[str] = None) -> list[dict]:
        """
        ...
        Returns:
            dict{key: (list[str])}: Dictionary of Lists containing Contracts
        """
