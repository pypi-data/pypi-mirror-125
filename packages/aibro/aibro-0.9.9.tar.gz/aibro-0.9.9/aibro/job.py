...
class Job(object):
    ...
    @hybridmethod
    def get_tensorboard_logs(cls, job_id, directory="."):
        """[reference]
    ...
    def get_tensorboard_logs(self, directory="."):
        check_authentication()
    ...
    @hybridmethod
    def replay_job(cls, job_id):
        """[reference]
        https://doc.aipaca.ai/#replay_job
        """
        job = cls(job_id)
        _replay_job(job.job_id)
