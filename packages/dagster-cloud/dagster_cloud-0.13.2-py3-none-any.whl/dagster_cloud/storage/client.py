...
class GqlShimClient(AbstractContextManager):
    ...
    def __init__(self, transport, fetch_schema_from_transport=False):
...
def create_proxy_client(url: str, config_value: Dict[str, Any], fetch_schema_from_transport=False):
