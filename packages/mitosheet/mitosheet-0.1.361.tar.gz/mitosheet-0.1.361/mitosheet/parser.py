...
def get_column_header_match_tuples(
    ...
    """
    column_header_match_tuples: List[Tuple[Any]] = []
    ...
    for column_header in column_headers_sorted:
        ...
        re.sub(str(column_header), find_column_headers, formula)
...
def parse_formula(
    ...
    return f'df[\'{column_header}\'] = {code_with_functions}', functions, column_header_dependencies