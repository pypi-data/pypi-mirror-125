...
class Site(object):
    ...
    When this is set to `True`, base lino :class:`Model<lino.core.Model>` class
    will inherit from mixins that comes along side the apps related to
    ElasticSearch and is mandatory to set it to `True` in the event of having
    ElasticSearch on the application stack.
