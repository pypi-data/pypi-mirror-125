...
def build(serviceName, version, base_url, **kw):
    ...
    Usage Examples - Data Services:
        ...
        api_response = dataservice.accounts().customers().list(dealer_code="D123")
        api_response = dataservice.accounts().customers().list(branch_uid="123e4567-e89b-12d3-a456-426614174000")
        ...
        api_response = dataservice.summaries().machineParts().list(dealer_code="d123")
        ...
        api_response = dataservice.summaries().machineOwners().list(dealer_code="d123")
