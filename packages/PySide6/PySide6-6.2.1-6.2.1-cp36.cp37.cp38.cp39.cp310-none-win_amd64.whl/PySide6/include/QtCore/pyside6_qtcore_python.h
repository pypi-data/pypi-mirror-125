...
enum : int {
    ...
    SBK_QFLAGS_QABSTRACTITEMMODEL_CHECKINDEXOPTION_IDX       = 92,
    ...
    SBK_QFLAGS_QBYTEARRAY_BASE64OPTION_IDX                   = 93,
    ...
    SBK_QCBORVALUE_ENCODINGOPTION_IDX                        = 43,
    SBK_QFLAGS_QCBORVALUE_ENCODINGOPTION_IDX                 = 95,
    SBK_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX              = 42,
    SBK_QFLAGS_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX       = 94,
    SBK_QCBORVALUE_TYPE_IDX                                  = 44,
    SBK_QCBORVALUE_IDX                                       = 41,
    SBK_QCHILDEVENT_IDX                                      = 45,
    SBK_QCOLLATOR_IDX                                        = 46,
    SBK_QCOLLATORSORTKEY_IDX                                 = 47,
    SBK_QCOMMANDLINEOPTION_FLAG_IDX                          = 49,
    SBK_QFLAGS_QCOMMANDLINEOPTION_FLAG_IDX                   = 96,
    SBK_QCOMMANDLINEOPTION_IDX                               = 48,
    SBK_QCOMMANDLINEPARSER_SINGLEDASHWORDOPTIONMODE_IDX      = 52,
    SBK_QCOMMANDLINEPARSER_OPTIONSAFTERPOSITIONALARGUMENTSMODE_IDX = 51,
    SBK_QCOMMANDLINEPARSER_IDX                               = 50,
    SBK_QCONCATENATETABLESPROXYMODEL_IDX                     = 53,
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 419,
    SBK_QCOREAPPLICATION_IDX                                 = 54,
    SBK_QCRYPTOGRAPHICHASH_ALGORITHM_IDX                     = 56,
    SBK_QCRYPTOGRAPHICHASH_IDX                               = 55,
    SBK_QDATASTREAM_VERSION_IDX                              = 61,
    SBK_QDATASTREAM_BYTEORDER_IDX                            = 58,
    SBK_QDATASTREAM_STATUS_IDX                               = 60,
    SBK_QDATASTREAM_FLOATINGPOINTPRECISION_IDX               = 59,
    SBK_QDATASTREAM_IDX                                      = 57,
    SBK_QDATE_IDX                                            = 62,
    ...
    SBK_QFLAGS_QDIR_FILTER_IDX                               = 97,
    SBK_QDIR_SORTFLAG_IDX                                    = 69,
    SBK_QFLAGS_QDIR_SORTFLAG_IDX                             = 98,
    SBK_QDIR_IDX                                             = 67,
    SBK_QDIRITERATOR_ITERATORFLAG_IDX                        = 71,
    SBK_QFLAGS_QDIRITERATOR_ITERATORFLAG_IDX                 = 99,
    ...
    SBK_QFLAGS_QEVENTLOOP_PROCESSEVENTSFLAG_IDX              = 100,
    SBK_QEVENTLOOP_IDX                                       = 79,
    SBK_QFACTORYINTERFACE_IDX                                = 81,
    SBK_QFILE_IDX                                            = 82,
    SBK_QFILEDEVICE_FILEERROR_IDX                            = 84,
    SBK_QFILEDEVICE_FILETIME_IDX                             = 86,
    SBK_QFILEDEVICE_PERMISSION_IDX                           = 88,
    SBK_QFLAGS_QFILEDEVICE_PERMISSION_IDX                    = 103,
    SBK_QFILEDEVICE_FILEHANDLEFLAG_IDX                       = 85,
    SBK_QFLAGS_QFILEDEVICE_FILEHANDLEFLAG_IDX                = 101,
    SBK_QFILEDEVICE_MEMORYMAPFLAG_IDX                        = 87,
    SBK_QFLAGS_QFILEDEVICE_MEMORYMAPFLAG_IDX                 = 102,
    SBK_QFILEDEVICE_IDX                                      = 83,
    SBK_QFILEINFO_IDX                                        = 89,
    SBK_QFILESELECTOR_IDX                                    = 90,
    SBK_QFILESYSTEMWATCHER_IDX                               = 91,
    ...
    SBK_QIODEVICE_IDX                                        = 147,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 149,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 104,
    SBK_QIODEVICEBASE_IDX                                    = 148,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 150,
    SBK_QITEMSELECTION_IDX                                   = 151,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 153,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 105,
    SBK_QITEMSELECTIONMODEL_IDX                              = 152,
    SBK_QITEMSELECTIONRANGE_IDX                              = 154,
    SBK_QJSONARRAY_IDX                                       = 155,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 157,
    SBK_QJSONDOCUMENT_IDX                                    = 156,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 159,
    SBK_QJSONPARSEERROR_IDX                                  = 158,
    SBK_QJSONVALUE_TYPE_IDX                                  = 161,
    SBK_QJSONVALUE_IDX                                       = 160,
    SBK_QKEYCOMBINATION_IDX                                  = 162,
    SBK_QLIBRARY_LOADHINT_IDX                                = 164,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 106,
    SBK_QLIBRARY_IDX                                         = 163,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 166,
    SBK_QLIBRARYINFO_IDX                                     = 165,
    SBK_QLINE_IDX                                            = 167,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 169,
    SBK_QLINEF_IDX                                           = 168,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 175,
    SBK_QLOCALE_SCRIPT_IDX                                   = 422,
    SBK_QLOCALE_COUNTRY_IDX                                  = 171,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 176,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 174,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 177,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 108,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 173,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 420,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 172,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 107,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 421,
    SBK_QLOCALE_IDX                                          = 170,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 179,
    SBK_QLOCKFILE_IDX                                        = 178,
    SBK_QMARGINS_IDX                                         = 180,
    SBK_QMARGINSF_IDX                                        = 181,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 182,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 183,
    SBK_QMETACLASSINFO_IDX                                   = 184,
    SBK_QMETAENUM_IDX                                        = 185,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 187,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 188,
    SBK_QMETAMETHOD_IDX                                      = 186,
    SBK_QMETAOBJECT_CALL_IDX                                 = 190,
    SBK_QMETAOBJECT_IDX                                      = 189,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 191,
    SBK_QMETAPROPERTY_IDX                                    = 192,
    SBK_QMETATYPE_TYPE_IDX                                   = 194,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 195,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 109,
    SBK_QMETATYPE_IDX                                        = 193,
    SBK_QMIMEDATA_IDX                                        = 196,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 198,
    SBK_QMIMEDATABASE_IDX                                    = 197,
    SBK_QMIMETYPE_IDX                                        = 199,
    SBK_QMODELINDEX_IDX                                      = 200,
    SBK_QMODELROLEDATA_IDX                                   = 201,
    SBK_QMUTEX_IDX                                           = 202,
    SBK_QOBJECT_IDX                                          = 203,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 205,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 204,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 206,
    SBK_QPAUSEANIMATION_IDX                                  = 207,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 208,
    SBK_QPLUGINLOADER_IDX                                    = 209,
    SBK_QPOINT_IDX                                           = 210,
    SBK_QPOINTF_IDX                                          = 211,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 217,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 218,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 215,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 216,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 214,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 213,
    SBK_QPROCESS_IDX                                         = 212,
    SBK_QPROCESSENVIRONMENT_IDX                              = 219,
    SBK_QPROPERTYANIMATION_IDX                               = 220,
    SBK_QRANDOMGENERATOR_IDX                                 = 221,
    SBK_QRANDOMGENERATOR64_IDX                               = 222,
    SBK_QREADLOCKER_IDX                                      = 223,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 225,
    SBK_QREADWRITELOCK_IDX                                   = 224,
    SBK_QRECT_IDX                                            = 226,
    SBK_QRECTF_IDX                                           = 227,
    SBK_QRECURSIVEMUTEX_IDX                                  = 228,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 232,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 111,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 231,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 230,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 110,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 233,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 112,
    SBK_QREGULAREXPRESSION_IDX                               = 229,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 234,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 235,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 237,
    SBK_QRESOURCE_IDX                                        = 236,
    SBK_QRUNNABLE_IDX                                        = 238,
    SBK_QSAVEFILE_IDX                                        = 239,
    SBK_QSEMAPHORE_IDX                                       = 240,
    SBK_QSEMAPHORERELEASER_IDX                               = 241,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 242,
    SBK_QSETTINGS_STATUS_IDX                                 = 246,
    SBK_QSETTINGS_FORMAT_IDX                                 = 244,
    SBK_QSETTINGS_SCOPE_IDX                                  = 245,
    SBK_QSETTINGS_IDX                                        = 243,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 248,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 249,
    SBK_QSHAREDMEMORY_IDX                                    = 247,
    SBK_QSIGNALBLOCKER_IDX                                   = 250,
    SBK_QSIGNALMAPPER_IDX                                    = 251,
    SBK_QSIZE_IDX                                            = 252,
    SBK_QSIZEF_IDX                                           = 253,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 254,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 256,
    SBK_QSOCKETNOTIFIER_IDX                                  = 255,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 257,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 260,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 259,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 113,
    SBK_QSTANDARDPATHS_IDX                                   = 258,
    SBK_QSTORAGEINFO_IDX                                     = 261,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 263,
    SBK_QSTRINGCONVERTER_IDX                                 = 262,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 265,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 114,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 264,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 266,
    SBK_QSTRINGDECODER_IDX                                   = 267,
    SBK_QSTRINGENCODER_IDX                                   = 268,
    SBK_QSTRINGLISTMODEL_IDX                                 = 269,
    SBK_QSYSINFO_SIZES_IDX                                   = 272,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 271,
    SBK_QSYSINFO_IDX                                         = 270,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 274,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 275,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 273,
    SBK_QTEMPORARYDIR_IDX                                    = 276,
    SBK_QTEMPORARYFILE_IDX                                   = 277,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 280,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 279,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 115,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 278,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 284,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 282,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 285,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 283,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 116,
    SBK_QTEXTSTREAM_IDX                                      = 281,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 286,
    SBK_QTHREAD_PRIORITY_IDX                                 = 288,
    SBK_QTHREAD_IDX                                          = 287,
    SBK_QTHREADPOOL_IDX                                      = 289,
    SBK_QTIME_IDX                                            = 290,
    SBK_QTIMELINE_STATE_IDX                                  = 293,
    SBK_QTIMELINE_DIRECTION_IDX                              = 292,
    SBK_QTIMELINE_IDX                                        = 291,
