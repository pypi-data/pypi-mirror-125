...
class TrajectoryDataList(WDLResourceList):
    """List of :class:`~cognite.well_model.client.models.trajectory_rows.TrajectoryRows` objects"""
...
class DepthMeasurementDataList(WDLResourceList):
    """List of :class:`~cognite.well_model.client.models.depth_measurement_rows.DepthMeasurementRows` objects"""
