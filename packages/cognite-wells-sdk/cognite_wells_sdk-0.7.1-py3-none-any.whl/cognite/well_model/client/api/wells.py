...
class WellsAPI(BaseAPI):
    ...
    def retrieve(self, asset_external_id: Optional[str] = None, matching_id: Optional[str] = None) -> Well:
        ...
        Examples:
            Get well by asset external id
                ...
                >>> well = wm.wells.retrieve(asset_external_id="wells/F-5")

            Get well by matching_id
                >>> from cognite.well_model import CogniteWellsClient
                >>> wm = CogniteWellsClient()
                >>> well = wm.wells.retrieve(matching_id="180d4f5e-38f0-4dcb-b601-d3644b9009f0")
        """
    ...
    def list(
        ...
        Args:
            ...
            quadrants (PropertyFilter, optional): List of quadrants or :class:`~cognite.well_model.NotSet`
            regions (PropertyFilter, optional): List of regions or :class:`~cognite.well_model.NotSet`
            blocks (PropertyFilter, optional): List of blocks or :class:`~cognite.well_model.NotSet`
            fields (PropertyFilter, optional): List of fields or :class:`~cognite.well_model.NotSet`
            operators (PropertyFilter, optional): List of operators or :class:`~cognite.well_model.NotSet`
            ...
            well_types (PropertyFilter, optional): List of well types or :class:`~cognite.well_model.NotSet`
            licenses (PropertyFilter, optional):  List of licenses or :class:`~cognite.well_model.NotSet`
