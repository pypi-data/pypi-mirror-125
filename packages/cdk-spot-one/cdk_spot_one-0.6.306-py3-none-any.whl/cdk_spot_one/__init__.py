...
from cdk_spot_one import SpotInstance, AmiOSType, ami_finder
...
SpotInstance(stack, "SpotInstanceUbuntu",
    vpc=vpc,
    custom_ami_id=ami_finder(AmiOSType.UBUNTU_20_04_ARM64).get_image(stack).image_id,
...
@jsii.enum(jsii_type="cdk-spot-one.AmiOSType")
