...
class OpenLeap():
    ...
    def __init__(self, 
        ...
        if SCREEN_SHOW: NORMALIZED_POSITION=False
                    ...
                    if n_hands >= 1:
                        ...
                        if self.left_or_right(index, hand, 'position'):
                            ...
                            if self.SCREEN_SHOW:
                                ...
                                x1, y1, z1 = self.get_position(index, self.mp_hands.HandLandmark.INDEX_FINGER_TIP, normalized=self.NORMALIZED_POSITION)
                                x2, y2, z2 = self.get_position(index, self.mp_hands.HandLandmark.THUMB_TIP, normalized=self.NORMALIZED_POSITION)
