...
class BaseDataSource(Fco):
    ...
    def start_stream_preview(self, table_name: str) -> StreamingQuery:
        ...
        df = data_source_helper.get_stream_dataframe_with_options(spark, self.stream_ds, None)
    ...
    def get_dataframe(
        ...
        """
        Returns this data sources data as a Tecton DataFrame.
        ...
        :return: A Tecton DataFrame containing the data sources source data.
        """
