...
class SodaDataMonitor:
    ...
    def from_dict(obj: Any) -> 'SodaDataMonitor':
        ...
        return SodaDataMonitor(last_run, status, targets, title, value)
...
class DatasetSodaDataQuality:
    ...
    def from_dict(obj: Any) -> 'DatasetSodaDataQuality':
        ...
        return DatasetSodaDataQuality(id, aspect_type, created_at, entity_id, dataset_soda_data_quality_id, latest, monitors, profiles)
