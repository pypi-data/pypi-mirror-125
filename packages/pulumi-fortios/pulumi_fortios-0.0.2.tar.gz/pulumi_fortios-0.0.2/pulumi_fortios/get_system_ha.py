...
class GetSystemHaResult:
    ...
    def __init__(__self__, arps=None, arps_interval=None, authentication=None, cpu_threshold=None, encryption=None, ftp_proxy_threshold=None, gratuitous_arps=None, group_id=None, group_name=None, ha_direct=None, ha_eth_type=None, ha_mgmt_interfaces=None, ha_mgmt_status=None, ha_uptime_diff_margin=None, hb_interval=None, hb_lost_threshold=None, hbdev=None, hc_eth_type=None, hello_holddown=None, http_proxy_threshold=None, id=None, imap_proxy_threshold=None, inter_cluster_session_sync=None, key=None, l2ep_eth_type=None, link_failed_signal=None, load_balance_all=None, logical_sn=None, memory_compatible_mode=None, memory_threshold=None, mode=None, monitor=None, multicast_ttl=None, nntp_proxy_threshold=None, override=None, override_wait_time=None, password=None, pingserver_failover_threshold=None, pingserver_flip_timeout=None, pingserver_monitor_interface=None, pingserver_secondary_force_reset=None, pingserver_slave_force_reset=None, pop3_proxy_threshold=None, priority=None, route_hold=None, route_ttl=None, route_wait=None, schedule=None, secondary_vcluster=None, session_pickup=None, session_pickup_connectionless=None, session_pickup_delay=None, session_pickup_expectation=None, session_pickup_nat=None, session_sync_dev=None, smtp_proxy_threshold=None, ssd_failover=None, standalone_config_sync=None, standalone_mgmt_vdom=None, sync_config=None, sync_packet_balance=None, unicast_hb=None, unicast_hb_netmask=None, unicast_hb_peerip=None, uninterruptible_upgrade=None, vcluster2=None, vcluster_id=None, vdom=None, vdomparam=None, weight=None):
        ...
        if secondary_vcluster and not isinstance(secondary_vcluster, dict):
            raise TypeError("Expected argument 'secondary_vcluster' to be a dict")
    ...
    def ha_mgmt_interfaces(self) -> Sequence['outputs.GetSystemHaHaMgmtInterfaceResult']:
        """
    ...
    def secondary_vcluster(self) -> 'outputs.GetSystemHaSecondaryVclusterResult':
        """
...
class AwaitableGetSystemHaResult(GetSystemHaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemHaResult(
            arps=self.arps,
            ...
            secondary_vcluster=self.secondary_vcluster,
...
def get_system_ha(vdomparam: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemHaResult:
    """
    ...
    return AwaitableGetSystemHaResult(
        arps=__ret__.arps,
        arps_interval=__ret__.arps_interval,
        ...
        ha_eth_type=__ret__.ha_eth_type,
        ha_mgmt_interfaces=__ret__.ha_mgmt_interfaces,
        ...
        hello_holddown=__ret__.hello_holddown,
        http_proxy_threshold=__ret__.http_proxy_threshold,
        id=__ret__.id,
        imap_proxy_threshold=__ret__.imap_proxy_threshold,
        inter_cluster_session_sync=__ret__.inter_cluster_session_sync,
        key=__ret__.key,
        l2ep_eth_type=__ret__.l2ep_eth_type,
        ...
        nntp_proxy_threshold=__ret__.nntp_proxy_threshold,
        override=__ret__.override,
        override_wait_time=__ret__.override_wait_time,
        password=__ret__.password,
        pingserver_failover_threshold=__ret__.pingserver_failover_threshold,
        pingserver_flip_timeout=__ret__.pingserver_flip_timeout,
        pingserver_monitor_interface=__ret__.pingserver_monitor_interface,
        pingserver_secondary_force_reset=__ret__.pingserver_secondary_force_reset,
        pingserver_slave_force_reset=__ret__.pingserver_slave_force_reset,
        pop3_proxy_threshold=__ret__.pop3_proxy_threshold,
        priority=__ret__.priority,
        route_hold=__ret__.route_hold,
        route_ttl=__ret__.route_ttl,
        route_wait=__ret__.route_wait,
        schedule=__ret__.schedule,
        secondary_vcluster=__ret__.secondary_vcluster,
        session_pickup=__ret__.session_pickup,
        session_pickup_connectionless=__ret__.session_pickup_connectionless,
        session_pickup_delay=__ret__.session_pickup_delay,
        session_pickup_expectation=__ret__.session_pickup_expectation,
        session_pickup_nat=__ret__.session_pickup_nat,
        session_sync_dev=__ret__.session_sync_dev,
        smtp_proxy_threshold=__ret__.smtp_proxy_threshold,
        ssd_failover=__ret__.ssd_failover,
        standalone_config_sync=__ret__.standalone_config_sync,
