...
__all__ = ['NetworkingInterfacePortArgs', 'NetworkingInterfacePort']

@pulumi.input_type
class NetworkingInterfacePortArgs:
...
@pulumi.input_type
class _NetworkingInterfacePortState:
    def __init__(__self__, *,
                 alias: Optional[pulumi.Input[str]] = None,
                 allowaccess: Optional[pulumi.Input[str]] = None,
                 defaultgw: Optional[pulumi.Input[str]] = None,
...
class NetworkingInterfacePort(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        loopback1 = fortios.NetworkingInterfacePort("loopback1",
            alias="cc1",
        ...
        vlan1 = fortios.NetworkingInterfacePort("vlan1",
            allowaccess="ping",
            defaultgw="enable",
            distance="33",
            interface="port2",
        ...
        test1 = fortios.NetworkingInterfacePort("test1",
            alias="dkeeew",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NetworkingInterfacePortArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides a resource to configure interface settings of FortiOS.
        ...
        :param str resource_name: The name of the resource.
        :param NetworkingInterfacePortArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NetworkingInterfacePortArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworkingInterfacePortArgs.__new__(NetworkingInterfacePortArgs)
        ...
        super(NetworkingInterfacePort, __self__).__init__(
            'fortios:index/networkingInterfacePort:NetworkingInterfacePort',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[str]] = None,
            vdom: Optional[pulumi.Input[str]] = None,
            vlanid: Optional[pulumi.Input[str]] = None) -> 'NetworkingInterfacePort':
        """
        ...
        __props__ = _NetworkingInterfacePortState.__new__(_NetworkingInterfacePortState)
        ...
        __props__.__dict__["vdom"] = vdom
        __props__.__dict__["vlanid"] = vlanid
        return NetworkingInterfacePort(resource_name, opts=opts, __props__=__props__)
