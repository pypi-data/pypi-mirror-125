...
@pulumi.output_type
class GetSystemPasswordPolicyResult:
    """
...
class AwaitableGetSystemPasswordPolicyResult(GetSystemPasswordPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemPasswordPolicyResult(
...
def get_system_password_policy(vdomparam: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemPasswordPolicyResult:
    """
