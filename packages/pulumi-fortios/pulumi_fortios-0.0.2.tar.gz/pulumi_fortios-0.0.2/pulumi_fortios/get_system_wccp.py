...
__all__ = [
    'GetSystemWccpResult',
    'AwaitableGetSystemWccpResult',
    'get_system_wccp',
]

@pulumi.output_type
class GetSystemWccpResult:
    """
...
class AwaitableGetSystemWccpResult(GetSystemWccpResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemWccpResult(
...
def get_system_wccp(service_id: Optional[str] = None,
                    vdomparam: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemWccpResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:index/getSystemWccp:GetSystemWccp', __args__, opts=opts, typ=GetSystemWccpResult).value

    return AwaitableGetSystemWccpResult(
