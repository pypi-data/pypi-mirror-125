...
@pulumi.output_type
class GetFirewallAddressResult:
    """
    ...
    def fsso_groups(self) -> Sequence['outputs.GetFirewallAddressFssoGroupResult']:
        """
    ...
    @property
    @pulumi.getter
    def lists(self) -> Sequence['outputs.GetFirewallAddressListResult']:
        """
...
class AwaitableGetFirewallAddressResult(GetFirewallAddressResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFirewallAddressResult(
...
def get_firewall_address(name: Optional[str] = None,
                         vdomparam: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallAddressResult:
    """
