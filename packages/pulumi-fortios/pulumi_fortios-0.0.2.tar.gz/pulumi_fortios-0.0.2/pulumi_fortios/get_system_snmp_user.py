...
__all__ = [
    'GetSystemSnmpUserResult',
    'AwaitableGetSystemSnmpUserResult',
    'get_system_snmp_user',
]

@pulumi.output_type
class GetSystemSnmpUserResult:
    """
    A collection of values returned by GetSystemSnmpUser.
    """
    def __init__(__self__, auth_proto=None, auth_pwd=None, events=None, ha_direct=None, id=None, name=None, notify_hosts=None, notify_hosts6=None, priv_proto=None, priv_pwd=None, queries=None, query_port=None, security_level=None, source_ip=None, source_ipv6=None, status=None, trap_lport=None, trap_rport=None, trap_status=None, vdomparam=None):
...
class AwaitableGetSystemSnmpUserResult(GetSystemSnmpUserResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemSnmpUserResult(
...
def get_system_snmp_user(name: Optional[str] = None,
                         vdomparam: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemSnmpUserResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:index/getSystemSnmpUser:GetSystemSnmpUser', __args__, opts=opts, typ=GetSystemSnmpUserResult).value

    return AwaitableGetSystemSnmpUserResult(
