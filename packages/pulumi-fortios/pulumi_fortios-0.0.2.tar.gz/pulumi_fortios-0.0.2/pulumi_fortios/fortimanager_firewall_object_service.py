...
class FortimanagerFirewallObjectService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test1 = fortios.FortimanagerFirewallObjectService("test1",
            category="Email",
        ...
        test2 = fortios.FortimanagerFirewallObjectService("test2",
            category="Web Access",
            comment="test obj service",
            icmp_code=3,
            icmp_type=2,
            protocol="ICMP")
        test3 = fortios.FortimanagerFirewallObjectService("test3",
