...
class FirewallSecurityPolicy1Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dstaddrs: Destination address and address group names.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dstintfs: Outgoing (egress) interface.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] srcaddrs: Source address and address group names.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] srcintfs: Incoming (ingress) interface.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] devices: Device type category.
        ...
        :param pulumi.Input[str] internet_service: Enable/disable use of Internet Services for this policy. If enabled, destination address and service are not used.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] internet_service_ids: Internet Service ID.
        :param pulumi.Input[str] internet_service_src: Enable/disable use of Internet Services in source for this policy. If enabled, source address is not used.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] internet_service_src_ids: Internet Service source ID.
        :param pulumi.Input[str] ippool: Enable to use IP Pools for source NAT.
        :param pulumi.Input[str] ips_sensor: Name of an existing IPS sensor.
        :param pulumi.Input[str] logtraffic: Enable or disable logging. Log all sessions or security profile sessions.
        :param pulumi.Input[str] logtraffic_start: Record logs when a session starts and ends.
        ...
        :param pulumi.Input[str] status: Enable or disable this policy.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] users: Names of individual users that can authenticate with this policy.
        :param pulumi.Input[str] utm_status: Enable to add one or more security profiles (AV, IPS, etc.) to the firewall policy.
...
class FirewallSecurityPolicy1(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test1 = fortios.FirewallSecurityPolicy1("test1",
            action="accept",
        ...
        test2 = fortios.FirewallSecurityPolicy1("test2",
            action="accept",
            application_list="block-high-risk",
            av_profile="wifi-default",
            capture_packet="enable",
        ...
        test1 = fortios.FirewallSecurityPolicy1("test1",
            ...
            internet_service="enable",
            internet_service_ids=[5242880],
            internet_service_src="enable",
            internet_service_src_ids=[65643],
            ippool="disable",
            ips_sensor="protect_client",
            logtraffic="all",
            logtraffic_start="enable",
