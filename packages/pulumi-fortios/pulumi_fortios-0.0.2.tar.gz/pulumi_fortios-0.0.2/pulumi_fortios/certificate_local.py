...
__all__ = ['CertificateLocalArgs', 'CertificateLocal']
...
class CertificateLocal(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CertificateLocalArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CertificateLocalArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(CertificateLocal, __self__).__init__(
            'fortios:index/certificateLocal:CertificateLocal',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            source_ip: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'CertificateLocal':
        """
