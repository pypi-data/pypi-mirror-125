...
__all__ = [
    'GetSystemPasswordPolicyGuestAdminResult',
    'AwaitableGetSystemPasswordPolicyGuestAdminResult',
    'get_system_password_policy_guest_admin',
]

@pulumi.output_type
class GetSystemPasswordPolicyGuestAdminResult:
    """
...
class AwaitableGetSystemPasswordPolicyGuestAdminResult(GetSystemPasswordPolicyGuestAdminResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemPasswordPolicyGuestAdminResult(
...
def get_system_password_policy_guest_admin(vdomparam: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemPasswordPolicyGuestAdminResult:
    """
