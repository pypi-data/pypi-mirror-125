...
@pulumi.output_type
class GetFirewallServiceGroupResult:
    """
    ...
    @property
    @pulumi.getter
    def members(self) -> Sequence['outputs.GetFirewallServiceGroupMemberResult']:
        """
...
class AwaitableGetFirewallServiceGroupResult(GetFirewallServiceGroupResult):
...
def get_firewall_service_group(name: Optional[str] = None,
                               vdomparam: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallServiceGroupResult:
    """
