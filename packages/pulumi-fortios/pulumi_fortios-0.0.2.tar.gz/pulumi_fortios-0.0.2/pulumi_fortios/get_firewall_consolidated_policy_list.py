...
__all__ = [
    'GetFirewallConsolidatedPolicyListResult',
    'AwaitableGetFirewallConsolidatedPolicyListResult',
    'get_firewall_consolidated_policy_list',
]

@pulumi.output_type
class GetFirewallConsolidatedPolicyListResult:
    """
...
class AwaitableGetFirewallConsolidatedPolicyListResult(GetFirewallConsolidatedPolicyListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFirewallConsolidatedPolicyListResult(
            filter=self.filter,
            id=self.id,
...
def get_firewall_consolidated_policy_list(filter: Optional[str] = None,
                                          vdomparam: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallConsolidatedPolicyListResult:
    """
