...
@pulumi.output_type
class GetSystemSnmpSysinfoResult:
    """
...
class AwaitableGetSystemSnmpSysinfoResult(GetSystemSnmpSysinfoResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemSnmpSysinfoResult(
...
def get_system_snmp_sysinfo(vdomparam: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemSnmpSysinfoResult:
    """
