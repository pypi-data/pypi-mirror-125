...
__all__ = [
    'GetSystemCentralManagementResult',
    'AwaitableGetSystemCentralManagementResult',
    'get_system_central_management',
]

@pulumi.output_type
class GetSystemCentralManagementResult:
    """
    ...
    def server_lists(self) -> Sequence['outputs.GetSystemCentralManagementServerListResult']:
        """
...
class AwaitableGetSystemCentralManagementResult(GetSystemCentralManagementResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemCentralManagementResult(
...
def get_system_central_management(vdomparam: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemCentralManagementResult:
    """
