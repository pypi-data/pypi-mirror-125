...
@pulumi.output_type
class GetRouterbgpNeighborResult:
    """
...
class AwaitableGetRouterbgpNeighborResult(GetRouterbgpNeighborResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRouterbgpNeighborResult(
...
def get_routerbgp_neighbor(ip: Optional[str] = None,
                           vdomparam: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRouterbgpNeighborResult:
    """
