...
class FortimanagerFirewallObjectAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test1 = fortios.FortimanagerFirewallObjectAddress("test1",
            associated_intf="any",
            comment="test obj address",
            fqdn="fqdn.google.com",
            type="fqdn")
        test2 = fortios.FortimanagerFirewallObjectAddress("test2",
            allow_routing="disable",
            associated_intf="any",
            comment="test obj address",
            subnet="2.2.2.0 255.255.255.0",
            type="ipmask")
        test3 = fortios.FortimanagerFirewallObjectAddress("test3",
            associated_intf="any",
            comment="test obj address",
            end_ip="2.2.2.100",
            start_ip="2.2.2.1",
