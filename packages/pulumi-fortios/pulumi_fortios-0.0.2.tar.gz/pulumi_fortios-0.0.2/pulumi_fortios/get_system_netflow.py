...
class AwaitableGetSystemNetflowResult(GetSystemNetflowResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemNetflowResult(
...
def get_system_netflow(vdomparam: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemNetflowResult:
    """
