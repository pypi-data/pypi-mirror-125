...
@pulumi.output_type
class GetSystemResourceLimitsResult:
    """
...
class AwaitableGetSystemResourceLimitsResult(GetSystemResourceLimitsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemResourceLimitsResult(
...
def get_system_resource_limits(vdomparam: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemResourceLimitsResult:
    """
