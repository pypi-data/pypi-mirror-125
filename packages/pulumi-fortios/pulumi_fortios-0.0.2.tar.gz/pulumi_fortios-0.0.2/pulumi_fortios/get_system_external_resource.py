...
@pulumi.output_type
class GetSystemExternalResourceResult:
    """
    A collection of values returned by GetSystemExternalResource.
    """
    def __init__(__self__, category=None, comments=None, id=None, interface=None, interface_select_method=None, name=None, password=None, refresh_rate=None, resource=None, source_ip=None, status=None, type=None, user_agent=None, username=None, uuid=None, vdomparam=None):
...
class AwaitableGetSystemExternalResourceResult(GetSystemExternalResourceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemExternalResourceResult(
...
def get_system_external_resource(name: Optional[str] = None,
                                 vdomparam: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemExternalResourceResult:
    """
