...
__all__ = ['FortimanagerObjectAdomRevisionArgs', 'FortimanagerObjectAdomRevision']

@pulumi.input_type
class FortimanagerObjectAdomRevisionArgs:
...
@pulumi.input_type
class _FortimanagerObjectAdomRevisionState:
    def __init__(__self__, *,
                 adom: Optional[pulumi.Input[str]] = None,
                 created_by: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
...
class FortimanagerObjectAdomRevision(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FortimanagerObjectAdomRevision("test1",
            created_by="fortinet",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FortimanagerObjectAdomRevisionArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports Create/Read/Update/Delete object adom revision for FortiManager.
        ...
        :param str resource_name: The name of the resource.
        :param FortimanagerObjectAdomRevisionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FortimanagerObjectAdomRevisionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FortimanagerObjectAdomRevisionArgs.__new__(FortimanagerObjectAdomRevisionArgs)
        ...
        super(FortimanagerObjectAdomRevision, __self__).__init__(
            'fortios:index/fortimanagerObjectAdomRevision:FortimanagerObjectAdomRevision',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[str]] = None,
            locked: Optional[pulumi.Input[int]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'FortimanagerObjectAdomRevision':
        """
        ...
        __props__ = _FortimanagerObjectAdomRevisionState.__new__(_FortimanagerObjectAdomRevisionState)
        ...
        __props__.__dict__["locked"] = locked
        __props__.__dict__["name"] = name
        return FortimanagerObjectAdomRevision(resource_name, opts=opts, __props__=__props__)
