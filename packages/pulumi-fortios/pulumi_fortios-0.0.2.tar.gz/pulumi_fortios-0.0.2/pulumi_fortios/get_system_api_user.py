...
__all__ = [
    'GetSystemApiUserResult',
    'AwaitableGetSystemApiUserResult',
    'get_system_api_user',
]

@pulumi.output_type
class GetSystemApiUserResult:
    """
    ...
    @property
    @pulumi.getter
    def trusthosts(self) -> Sequence['outputs.GetSystemApiUserTrusthostResult']:
        """
    ...
    @property
    @pulumi.getter
    def vdoms(self) -> Sequence['outputs.GetSystemApiUserVdomResult']:
        """
...
class AwaitableGetSystemApiUserResult(GetSystemApiUserResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemApiUserResult(
...
def get_system_api_user(name: Optional[str] = None,
                        vdomparam: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemApiUserResult:
    """
