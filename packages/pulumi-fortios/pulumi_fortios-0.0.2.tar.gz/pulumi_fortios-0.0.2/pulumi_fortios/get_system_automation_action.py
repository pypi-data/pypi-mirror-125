...
@pulumi.output_type
class GetSystemAutomationActionResult:
    """
    ...
    def email_tos(self) -> Sequence['outputs.GetSystemAutomationActionEmailToResult']:
        """
    ...
    @property
    @pulumi.getter
    def headers(self) -> Sequence['outputs.GetSystemAutomationActionHeaderResult']:
        """
    ...
    def sdn_connectors(self) -> Sequence['outputs.GetSystemAutomationActionSdnConnectorResult']:
        """
...
class AwaitableGetSystemAutomationActionResult(GetSystemAutomationActionResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetSystemAutomationActionResult(
...
def get_system_automation_action(name: Optional[str] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemAutomationActionResult:
    """
