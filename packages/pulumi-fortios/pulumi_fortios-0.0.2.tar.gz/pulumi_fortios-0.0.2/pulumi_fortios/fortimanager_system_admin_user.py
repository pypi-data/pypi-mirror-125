...
__all__ = ['FortimanagerSystemAdminUserArgs', 'FortimanagerSystemAdminUser']

@pulumi.input_type
class FortimanagerSystemAdminUserArgs:
...
@pulumi.input_type
class _FortimanagerSystemAdminUserState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 password: Optional[pulumi.Input[str]] = None,
                 profileid: Optional[pulumi.Input[str]] = None,
...
class FortimanagerSystemAdminUser(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test1 = fortios.FortimanagerSystemAdminUser("test1",
            ...
            user_type="local",
            userid="user1")
        test2 = fortios.FortimanagerSystemAdminUser("test2",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FortimanagerSystemAdminUserArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource supports Create/Read/Update/Delete admin user for FortiManager
        ...
        :param str resource_name: The name of the resource.
        :param FortimanagerSystemAdminUserArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FortimanagerSystemAdminUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FortimanagerSystemAdminUserArgs.__new__(FortimanagerSystemAdminUserArgs)
        ...
        super(FortimanagerSystemAdminUser, __self__).__init__(
            'fortios:index/fortimanagerSystemAdminUser:FortimanagerSystemAdminUser',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            trusthost3: Optional[pulumi.Input[str]] = None,
            user_type: Optional[pulumi.Input[str]] = None,
            userid: Optional[pulumi.Input[str]] = None) -> 'FortimanagerSystemAdminUser':
        """
        ...
        __props__ = _FortimanagerSystemAdminUserState.__new__(_FortimanagerSystemAdminUserState)
        ...
        __props__.__dict__["user_type"] = user_type
        __props__.__dict__["userid"] = userid
        return FortimanagerSystemAdminUser(resource_name, opts=opts, __props__=__props__)
