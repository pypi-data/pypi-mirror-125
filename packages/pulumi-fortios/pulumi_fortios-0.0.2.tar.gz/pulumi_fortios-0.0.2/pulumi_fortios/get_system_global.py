...
class AwaitableGetSystemGlobalResult(GetSystemGlobalResult):
...
def get_system_global(vdomparam: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemGlobalResult:
    """
