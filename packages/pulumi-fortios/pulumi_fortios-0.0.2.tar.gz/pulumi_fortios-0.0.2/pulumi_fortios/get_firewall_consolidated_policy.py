...
__all__ = [
    'GetFirewallConsolidatedPolicyResult',
    'AwaitableGetFirewallConsolidatedPolicyResult',
    'get_firewall_consolidated_policy',
]

@pulumi.output_type
class GetFirewallConsolidatedPolicyResult:
    """
    ...
    def app_categories(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyAppCategoryResult']:
        """
    ...
    def app_groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyAppGroupResult']:
        """
    ...
    @property
    @pulumi.getter
    def applications(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyApplicationResult']:
        """
    ...
    @property
    @pulumi.getter
    def dstaddr4s(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyDstaddr4Result']:
        """
    ...
    @property
    @pulumi.getter
    def dstaddr6s(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyDstaddr6Result']:
        """
    ...
    @property
    @pulumi.getter
    def dstintfs(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyDstintfResult']:
        """
    ...
    def fsso_groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyFssoGroupResult']:
        """
    ...
    @property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyGroupResult']:
        """
    ...
    def internet_service_custom_groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceCustomGroupResult']:
        """
    ...
    def internet_service_customs(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceCustomResult']:
        """
    ...
    def internet_service_groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceGroupResult']:
        """
    ...
    def internet_service_ids(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceIdResult']:
        """
    ...
    def internet_service_names(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceNameResult']:
        """
    ...
    def internet_service_src_custom_groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceSrcCustomGroupResult']:
        """
    ...
    def internet_service_src_customs(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceSrcCustomResult']:
        """
    ...
    def internet_service_src_groups(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceSrcGroupResult']:
        """
    ...
    def internet_service_src_ids(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceSrcIdResult']:
        """
    ...
    def internet_service_src_names(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyInternetServiceSrcNameResult']:
        """
    ...
    @property
    @pulumi.getter
    def poolname4s(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyPoolname4Result']:
        """
    ...
    @property
    @pulumi.getter
    def poolname6s(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyPoolname6Result']:
        """
    ...
    @property
    @pulumi.getter
    def services(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyServiceResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddr4s(self) -> Sequence['outputs.GetFirewallConsolidatedPolicySrcaddr4Result']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddr6s(self) -> Sequence['outputs.GetFirewallConsolidatedPolicySrcaddr6Result']:
        """
    ...
    @property
    @pulumi.getter
    def srcintfs(self) -> Sequence['outputs.GetFirewallConsolidatedPolicySrcintfResult']:
        """
    ...
    def url_categories(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyUrlCategoryResult']:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetFirewallConsolidatedPolicyUserResult']:
        """
...
class AwaitableGetFirewallConsolidatedPolicyResult(GetFirewallConsolidatedPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFirewallConsolidatedPolicyResult(
            action=self.action,
...
def get_firewall_consolidated_policy(policyid: Optional[int] = None,
                                     vdomparam: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallConsolidatedPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:index/getFirewallConsolidatedPolicy:GetFirewallConsolidatedPolicy', __args__, opts=opts, typ=GetFirewallConsolidatedPolicyResult).value

    return AwaitableGetFirewallConsolidatedPolicyResult(
