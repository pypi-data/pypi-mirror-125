...
class GetFirewallInternetServiceResult:
    ...
    """
    def __init__(__self__, database=None, direction=None, extra_ip_range_number=None, fosid=None, icon_id=None, id=None, ip_number=None, ip_range_number=None, name=None, obsolete=None, reputation=None, singularity=None, sld_id=None, vdomparam=None):
