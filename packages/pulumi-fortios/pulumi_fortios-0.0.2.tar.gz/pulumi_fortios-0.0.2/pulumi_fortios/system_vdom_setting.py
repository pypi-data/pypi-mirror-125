...
__all__ = ['SystemVdomSettingArgs', 'SystemVdomSetting']

@pulumi.input_type
class SystemVdomSettingArgs:
...
class SystemVdomSetting(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test2 = fortios.SystemVdomSetting("test2",
            short_name="aa1122",
            temporary="0")
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SystemVdomSettingArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides a resource to configure VDOM of FortiOS. The API user of the token for this feature should have a super admin profile, It can be set in CLI while GUI does not allow.
        ...
        :param str resource_name: The name of the resource.
        :param SystemVdomSettingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SystemVdomSettingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SystemVdomSettingArgs.__new__(SystemVdomSettingArgs)

            __props__.__dict__["name"] = name
            __props__.__dict__["short_name"] = short_name
            __props__.__dict__["temporary"] = temporary
        super(SystemVdomSetting, __self__).__init__(
            'fortios:index/systemVdomSetting:SystemVdomSetting',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            short_name: Optional[pulumi.Input[str]] = None,
            temporary: Optional[pulumi.Input[str]] = None) -> 'SystemVdomSetting':
        """
        ...
        __props__ = _SystemVdomSettingState.__new__(_SystemVdomSettingState)

        __props__.__dict__["name"] = name
        __props__.__dict__["short_name"] = short_name
        __props__.__dict__["temporary"] = temporary
        return SystemVdomSetting(resource_name, opts=opts, __props__=__props__)
