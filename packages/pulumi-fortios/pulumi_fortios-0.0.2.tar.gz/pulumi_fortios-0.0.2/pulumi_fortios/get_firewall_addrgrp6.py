...
__all__ = [
    'GetFirewallAddrgrp6Result',
    'AwaitableGetFirewallAddrgrp6Result',
    'get_firewall_addrgrp6',
]

@pulumi.output_type
class GetFirewallAddrgrp6Result:
    """
    A collection of values returned by GetFirewallAddrgrp6.
    """
    def __init__(__self__, color=None, comment=None, id=None, members=None, name=None, taggings=None, uuid=None, vdomparam=None, visibility=None):
    ...
    @property
    @pulumi.getter
    def members(self) -> Sequence['outputs.GetFirewallAddrgrp6MemberResult']:
        """
    ...
    @property
    @pulumi.getter
    def taggings(self) -> Sequence['outputs.GetFirewallAddrgrp6TaggingResult']:
        """
...
class AwaitableGetFirewallAddrgrp6Result(GetFirewallAddrgrp6Result):
...
def get_firewall_addrgrp6(name: Optional[str] = None,
                          vdomparam: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallAddrgrp6Result:
    """
