...
__all__ = [
    'GetSystemNat64Result',
    'AwaitableGetSystemNat64Result',
    'get_system_nat64',
]

@pulumi.output_type
class GetSystemNat64Result:
    """
    ...
    def secondary_prefixes(self) -> Sequence['outputs.GetSystemNat64SecondaryPrefixResult']:
        """
...
class AwaitableGetSystemNat64Result(GetSystemNat64Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemNat64Result(
...
def get_system_nat64(vdomparam: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemNat64Result:
    """
