...
__all__ = [
    'GetRouterPolicyResult',
    'AwaitableGetRouterPolicyResult',
    'get_router_policy',
]

@pulumi.output_type
class GetRouterPolicyResult:
    """
    ...
    @property
    @pulumi.getter
    def dstaddrs(self) -> Sequence['outputs.GetRouterPolicyDstaddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def dsts(self) -> Sequence['outputs.GetRouterPolicyDstResult']:
        """
    ...
    def input_devices(self) -> Sequence['outputs.GetRouterPolicyInputDeviceResult']:
        """
    ...
    def internet_service_customs(self) -> Sequence['outputs.GetRouterPolicyInternetServiceCustomResult']:
        """
    ...
    def internet_service_ids(self) -> Sequence['outputs.GetRouterPolicyInternetServiceIdResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddrs(self) -> Sequence['outputs.GetRouterPolicySrcaddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcs(self) -> Sequence['outputs.GetRouterPolicySrcResult']:
        """
...
class AwaitableGetRouterPolicyResult(GetRouterPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRouterPolicyResult(
            action=self.action,
...
def get_router_policy(seq_num: Optional[int] = None,
                      vdomparam: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRouterPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:index/getRouterPolicy:GetRouterPolicy', __args__, opts=opts, typ=GetRouterPolicyResult).value

    return AwaitableGetRouterPolicyResult(
