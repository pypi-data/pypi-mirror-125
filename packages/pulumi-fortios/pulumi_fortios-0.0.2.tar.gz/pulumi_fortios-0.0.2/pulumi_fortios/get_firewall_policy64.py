...
__all__ = [
    'GetFirewallPolicy64Result',
    'AwaitableGetFirewallPolicy64Result',
    'get_firewall_policy64',
]

@pulumi.output_type
class GetFirewallPolicy64Result:
    """
    ...
    @property
    @pulumi.getter
    def dstaddrs(self) -> Sequence['outputs.GetFirewallPolicy64DstaddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def poolnames(self) -> Sequence['outputs.GetFirewallPolicy64PoolnameResult']:
        """
    ...
    @property
    @pulumi.getter
    def services(self) -> Sequence['outputs.GetFirewallPolicy64ServiceResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddrs(self) -> Sequence['outputs.GetFirewallPolicy64SrcaddrResult']:
        """
...
class AwaitableGetFirewallPolicy64Result(GetFirewallPolicy64Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFirewallPolicy64Result(
            action=self.action,
...
def get_firewall_policy64(policyid: Optional[int] = None,
                          vdomparam: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallPolicy64Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:index/getFirewallPolicy64:GetFirewallPolicy64', __args__, opts=opts, typ=GetFirewallPolicy64Result).value

    return AwaitableGetFirewallPolicy64Result(
