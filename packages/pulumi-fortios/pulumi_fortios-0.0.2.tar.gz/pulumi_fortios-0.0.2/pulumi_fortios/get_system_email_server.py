...
@pulumi.output_type
class GetSystemEmailServerResult:
    """
...
class AwaitableGetSystemEmailServerResult(GetSystemEmailServerResult):
...
def get_system_email_server(vdomparam: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemEmailServerResult:
    """
