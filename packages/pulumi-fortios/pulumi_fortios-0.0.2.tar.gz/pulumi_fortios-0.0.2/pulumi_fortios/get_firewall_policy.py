...
class GetFirewallPolicyResult:
    ...
    def app_categories(self) -> Sequence['outputs.GetFirewallPolicyAppCategoryResult']:
        """
    ...
    def app_groups(self) -> Sequence['outputs.GetFirewallPolicyAppGroupResult']:
        """
    ...
    @property
    @pulumi.getter
    def applications(self) -> Sequence['outputs.GetFirewallPolicyApplicationResult']:
        """
    ...
    def custom_log_fields(self) -> Sequence['outputs.GetFirewallPolicyCustomLogFieldResult']:
        """
    ...
    @property
    @pulumi.getter
    def devices(self) -> Sequence['outputs.GetFirewallPolicyDeviceResult']:
        """
    ...
    @property
    @pulumi.getter
    def dstaddr6s(self) -> Sequence['outputs.GetFirewallPolicyDstaddr6Result']:
        """
    ...
    @property
    @pulumi.getter
    def dstaddrs(self) -> Sequence['outputs.GetFirewallPolicyDstaddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def dstintfs(self) -> Sequence['outputs.GetFirewallPolicyDstintfResult']:
        """
    ...
    def fsso_groups(self) -> Sequence['outputs.GetFirewallPolicyFssoGroupResult']:
        """
    ...
    @property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetFirewallPolicyGroupResult']:
        """
    ...
    def internet_service_custom_groups(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceCustomGroupResult']:
        """
    ...
    def internet_service_customs(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceCustomResult']:
        """
    ...
    def internet_service_groups(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceGroupResult']:
        """
    ...
    def internet_service_ids(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceIdResult']:
        """
    ...
    def internet_service_names(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceNameResult']:
        """
    ...
    def internet_service_src_custom_groups(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceSrcCustomGroupResult']:
        """
    ...
    def internet_service_src_customs(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceSrcCustomResult']:
        """
    ...
    def internet_service_src_groups(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceSrcGroupResult']:
        """
    ...
    def internet_service_src_ids(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceSrcIdResult']:
        """
    ...
    def internet_service_src_names(self) -> Sequence['outputs.GetFirewallPolicyInternetServiceSrcNameResult']:
        """
    ...
    def ntlm_enabled_browsers(self) -> Sequence['outputs.GetFirewallPolicyNtlmEnabledBrowserResult']:
        """
    ...
    @property
    @pulumi.getter
    def poolname6s(self) -> Sequence['outputs.GetFirewallPolicyPoolname6Result']:
        """
    ...
    @property
    @pulumi.getter
    def poolnames(self) -> Sequence['outputs.GetFirewallPolicyPoolnameResult']:
        """
    ...
    def rtp_addrs(self) -> Sequence['outputs.GetFirewallPolicyRtpAddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def services(self) -> Sequence['outputs.GetFirewallPolicyServiceResult']:
        """
    ...
    def src_vendor_macs(self) -> Sequence['outputs.GetFirewallPolicySrcVendorMacResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddr6s(self) -> Sequence['outputs.GetFirewallPolicySrcaddr6Result']:
        """
    ...
    @property
    @pulumi.getter
    def srcaddrs(self) -> Sequence['outputs.GetFirewallPolicySrcaddrResult']:
        """
    ...
    @property
    @pulumi.getter
    def srcintfs(self) -> Sequence['outputs.GetFirewallPolicySrcintfResult']:
        """
    ...
    def ssl_mirror_intfs(self) -> Sequence['outputs.GetFirewallPolicySslMirrorIntfResult']:
        """
    ...
    def url_categories(self) -> Sequence['outputs.GetFirewallPolicyUrlCategoryResult']:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetFirewallPolicyUserResult']:
        """
