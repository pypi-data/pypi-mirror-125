...
__all__ = [
    'GetFirewallShaperTrafficShaperResult',
    'AwaitableGetFirewallShaperTrafficShaperResult',
    'get_firewall_shaper_traffic_shaper',
]

@pulumi.output_type
class GetFirewallShaperTrafficShaperResult:
    """
...
class AwaitableGetFirewallShaperTrafficShaperResult(GetFirewallShaperTrafficShaperResult):
...
def get_firewall_shaper_traffic_shaper(name: Optional[str] = None,
                                       vdomparam: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallShaperTrafficShaperResult:
    """
