...
@pulumi.output_type
class GetSystemFortiguardResult:
    """
...
class AwaitableGetSystemFortiguardResult(GetSystemFortiguardResult):
...
def get_system_fortiguard(vdomparam: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemFortiguardResult:
    """
