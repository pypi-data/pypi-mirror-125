...
__all__ = [
    'GetSystemGreTunnelListResult',
    'AwaitableGetSystemGreTunnelListResult',
    'get_system_gre_tunnel_list',
]

@pulumi.output_type
class GetSystemGreTunnelListResult:
    """
...
class AwaitableGetSystemGreTunnelListResult(GetSystemGreTunnelListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemGreTunnelListResult(
            filter=self.filter,
            id=self.id,
...
def get_system_gre_tunnel_list(filter: Optional[str] = None,
                               vdomparam: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemGreTunnelListResult:
    """
