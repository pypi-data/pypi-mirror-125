...
class FortimanagerJSONRPCRequest(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test1 = fortios.FortimanagerJSONRPCRequest("test1", json_content=\"\"\"{
          "method": "add",
          "params": [
            {
              "data": [
        ...
        \"\"\")
        test2 = fortios.FortimanagerJSONRPCRequest("test2", json_content=\"\"\"{
          "method": "add",
          "params": [
            {
              "data": [
        ...
        \"\"\")
        test3 = fortios.FortimanagerJSONRPCRequest("test3", json_content=\"\"\"{
          "method": "get",
          "params": [
            {
