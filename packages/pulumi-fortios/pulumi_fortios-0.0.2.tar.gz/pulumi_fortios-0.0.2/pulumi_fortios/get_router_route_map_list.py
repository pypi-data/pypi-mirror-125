...
__all__ = [
    'GetRouterRouteMapListResult',
    'AwaitableGetRouterRouteMapListResult',
    'get_router_route_map_list',
]

@pulumi.output_type
class GetRouterRouteMapListResult:
    """
...
class AwaitableGetRouterRouteMapListResult(GetRouterRouteMapListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRouterRouteMapListResult(
            filter=self.filter,
            id=self.id,
...
def get_router_route_map_list(filter: Optional[str] = None,
                              vdomparam: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRouterRouteMapListResult:
    """
