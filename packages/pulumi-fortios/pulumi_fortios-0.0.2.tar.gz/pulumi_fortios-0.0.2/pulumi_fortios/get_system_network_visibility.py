...
__all__ = [
    'GetSystemNetworkVisibilityResult',
    'AwaitableGetSystemNetworkVisibilityResult',
    'get_system_network_visibility',
]

@pulumi.output_type
class GetSystemNetworkVisibilityResult:
    """
...
class AwaitableGetSystemNetworkVisibilityResult(GetSystemNetworkVisibilityResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemNetworkVisibilityResult(
...
def get_system_network_visibility(vdomparam: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemNetworkVisibilityResult:
    """
