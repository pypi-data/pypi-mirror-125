...
@pulumi.output_type
class GetFirewallServiceCustomResult:
    """
    ...
    def app_categories(self) -> Sequence['outputs.GetFirewallServiceCustomAppCategoryResult']:
        """
    ...
    @property
    @pulumi.getter
    def applications(self) -> Sequence['outputs.GetFirewallServiceCustomApplicationResult']:
        """
...
class AwaitableGetFirewallServiceCustomResult(GetFirewallServiceCustomResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFirewallServiceCustomResult(
...
def get_firewall_service_custom(name: Optional[str] = None,
                                vdomparam: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallServiceCustomResult:
    """
    ...
    return AwaitableGetFirewallServiceCustomResult(
        ...
        app_service_type=__ret__.app_service_type,
        ...
        icmptype=__ret__.icmptype,
        id=__ret__.id,
        iprange=__ret__.iprange,
        name=__ret__.name,
        protocol=__ret__.protocol,
        protocol_number=__ret__.protocol_number,
        proxy=__ret__.proxy,
        sctp_portrange=__ret__.sctp_portrange,
