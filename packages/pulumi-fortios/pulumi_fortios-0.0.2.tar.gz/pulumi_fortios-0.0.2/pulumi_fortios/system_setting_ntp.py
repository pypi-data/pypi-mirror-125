...
__all__ = ['SystemSettingNTPArgs', 'SystemSettingNTP']

@pulumi.input_type
class SystemSettingNTPArgs:
...
class SystemSettingNTP(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test2 = fortios.SystemSettingNTP("test2",
            ntpservers=[
                "1.1.1.1",
                "3.3.3.3",
            ],
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SystemSettingNTPArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SystemSettingNTPArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SystemSettingNTPArgs.__new__(SystemSettingNTPArgs)
        ...
        super(SystemSettingNTP, __self__).__init__(
            'fortios:index/systemSettingNTP:SystemSettingNTP',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ntpservers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ntpsync: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'SystemSettingNTP':
        """
        ...
        __props__ = _SystemSettingNTPState.__new__(_SystemSettingNTPState)

        __props__.__dict__["ntpservers"] = ntpservers
        __props__.__dict__["ntpsync"] = ntpsync
        __props__.__dict__["type"] = type
        return SystemSettingNTP(resource_name, opts=opts, __props__=__props__)
