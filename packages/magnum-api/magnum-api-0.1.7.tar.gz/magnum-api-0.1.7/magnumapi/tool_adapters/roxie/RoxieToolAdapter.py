...
print('Loaded Tool Adapter version 0.0.1 for ROXIE VERS.10, UPDATE 3.1, 2015')
...
class RoxieToolAdapter(ToolAdapter):
    ...
    def __init__(self,
        ...
        :param input_folder_rel_path: a relative path to a directory with inputs
        ...
        """
        self.input_folder_rel_path = input_folder_rel_path
        self.input_file_path = os.path.join(input_folder_rel_path, input_file)
        self.output_file_path = os.path.join(input_folder_rel_path, output_file)
        self.cadata_file_path = os.path.join(input_folder_rel_path, cadata_file)
        self.cadata_file = cadata_file
        self.xml_output_file_path = os.path.join(input_folder_rel_path, xml_output_file)
        self.output_lines = []
    ...
    def update_force2d_with_field_scaling(roxie_force_input_path: str,
        ...
        """
        with open(roxie_force_input_path, 'r') as file_read:
            roxie_force_txt = file_read.readlines()
...
class TerminalRoxieToolAdapter(RoxieToolAdapter):
    ...
    def __init__(self,
        ...
        :param input_folder_rel_path: a relative path to input folder w.r.t. notebook location
        ...
        """
        super().__init__(input_folder_rel_path=input_folder_rel_path,
...
class DockerTerminalRoxieToolAdapter(TerminalRoxieToolAdapter):
    ...
    def __init__(self,
        ...
        self.file_to_unlink = os.path.join(input_folder_rel_path, 'm4_A.inp')
