...
import os
from simuwater import *
from swmmnodes import *
from swmmlinks import *
...
class Simulation(object):
    def __init__(self,
        ...
        if swr == None:
            swr = self.__path_getFileDirPath(swi) + '\\' + self.__path_getFileName(swi) + '.swr'
        if swo == None:
            swo = self.__path_getFileDirPath(swi) + '\\' + self.__path_getFileName(swi) + '.swo'
    ...
    def __path_getFileDirPath(file_path):
        name = os.path.basename(path)
        return os.path.abspath(name)
    
    def __path_getFileName(file_name, with_suffix = False):
        if with_suffix:
