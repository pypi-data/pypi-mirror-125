...
from typing import Any, Callable, cast, Dict, IO, Iterator, List, Mapping, Optional, TypeVar, Union
...
class APIRequest:
    ...
    def __init__(
        ...
        self.response_obj: Union[Dict, List, None] = None
        self.conn = self.conninfo.connect()
        self._headers: Dict[str, Any] = collections.OrderedDict()
