...
class GoogleApi():
    ...
    def __init__(self, credentials: str, token: dict = None, service_account: bool = False, debug=False, **kwargs):
    ...
    def __authenticate_using_service_account(self):
        ...
        http = credentials.authorize(httplib2.Http(timeout=HTTP_TIMEOUT))
