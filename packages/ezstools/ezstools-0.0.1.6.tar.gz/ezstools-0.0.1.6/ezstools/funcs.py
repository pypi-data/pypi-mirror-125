def ezs_print(content :'contenido' , color:'Color del mensaje' =None, end :'Final del contenido' ='\n', flush :'Limpiar buffer interno' =False, times :'Veces que se printea' =1, add :'Sumar al contenido (para contenido numerico)' =False, enumerate :'Enumerar Las veces que se printea' =False) -> "contenido" :
    """
