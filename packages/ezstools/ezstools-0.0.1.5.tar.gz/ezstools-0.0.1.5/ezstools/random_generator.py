...
def get_random_number_list(min_length :'Longitud minima' = 8, max_length: 'Longitud maxima' = 8, floats :'Usar flotantes?' = False, negatives :'Usar numeros negativos?' = False, binary :'Usar solo numeros del 1 al 0?' = False, r : 'Redondeamiento de los flotantes' = 2) -> list:
    if min_length > max_length:
        max_length = min_length
