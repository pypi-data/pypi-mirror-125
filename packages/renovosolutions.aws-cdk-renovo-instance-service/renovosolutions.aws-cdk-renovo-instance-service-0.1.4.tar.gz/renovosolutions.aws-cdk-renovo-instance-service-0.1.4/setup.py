    ...
    """
{
    ...
    "package_data": {
        "renovo-instance-service._jsii": [
            "cdk-library-renovo-instance-service@0.1.4.jsii.tgz"
        ],
        "renovo-instance-service": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-ec2>=1.130.0, <2.0.0",
        "aws-cdk.aws-iam>=1.130.0, <2.0.0",
        "aws-cdk.core>=1.130.0, <2.0.0",
        "constructs>=3.2.27, <4.0.0",
        "jsii>=1.41.0, <2.0.0",
        "publication>=0.0.3",
        "renovosolutions.aws-cdk-aspects-security-group>=0.1.3, <0.2.0",
        "renovosolutions.aws-cdk-managed-instance-role>=0.0.19, <0.0.20"
    ],
    "classifiers": [
