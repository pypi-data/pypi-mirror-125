    ...
    """
{
    ...
    "package_data": {
        "renovo-instance-service._jsii": [
            "cdk-library-renovo-instance-service@0.1.5.jsii.tgz"
        ],
        "renovo-instance-service": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "jsii>=1.41.0, <2.0.0",
        "publication>=0.0.3",
        "renovosolutions.aws-cdk-aspects-security-group>=0.1.4, <0.2.0",
        "renovosolutions.aws-cdk-managed-instance-role>=0.0.20, <0.0.21"
    ],
    "classifiers": [
