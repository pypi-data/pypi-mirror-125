...
class HeliosphereUrllib3Instrumentor(HeliosphereBaseHttpInstrumentor):
    ...
    def request_hook(span: Span, connection_pool, headers: Dict, body: str) -> None:
        HeliosphereUrllib3Instrumentor.base_request_hook(span, headers, body)
    ...
    def response_hook(span: Span, connection_pool, response) -> None:
        ...
        HeliosphereUrllib3Instrumentor.base_response_hook(span, response_headers, response_payload)
