...
from heliosphere.instrumentation.botocore.consts import AwsParam, AwsService, AwsAttribute, MAX_PAYLOAD_SIZE
...
class DynamoDBInstrumentor(object):
    ...
    def request_hook(self, span, operation_name, api_params):
        if AwsParam.TABLE_NAME in api_params:
            span.set_attribute(SpanAttributes.DB_NAME, api_params[AwsParam.TABLE_NAME])
