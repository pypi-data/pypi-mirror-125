...
from heliosphere import HeliosphereBase, HeliosphereTags
from heliosphere.instrumentation import default_instrumentation_list
...
class Heliosphere(HeliosphereBase):
