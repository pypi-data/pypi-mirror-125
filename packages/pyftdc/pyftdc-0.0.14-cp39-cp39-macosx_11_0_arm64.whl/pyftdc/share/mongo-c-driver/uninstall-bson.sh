...
save_pwd=$(pwd)
cd /Users/jorge/CLionProjects/mongo_ftdc/_skbuild/macosx-11.0-arm64-3.9/cmake-install/src/pyftdc/
...
printf "Removing file "lib/cmake/bson-1.0/bson-targets-release.cmake""
(rm -f "lib/cmake/bson-1.0/bson-targets-release.cmake" && printf "\n") || printf " ... not removed\n"
...
cd ..
printf "Removing top-level installation directory: "/Users/jorge/CLionProjects/mongo_ftdc/_skbuild/macosx-11.0-arm64-3.9/cmake-install/src/pyftdc/""
(rmdir "/Users/jorge/CLionProjects/mongo_ftdc/_skbuild/macosx-11.0-arm64-3.9/cmake-install/src/pyftdc/" 2>/dev/null && printf "\n") || printf " ... not removed (probably not empty)\n"
