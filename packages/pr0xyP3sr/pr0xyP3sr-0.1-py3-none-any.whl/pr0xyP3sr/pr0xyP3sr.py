...
def helpl():
	banner()
	print ("For single domain   : python pr0xyP3sr.py -p http://yourserver.com/ ")
	print ("For multiple domain : cat live-domain.txt | xargs -n1 -p50 python pr0xyP3sr.py --parse  " )
