...
# # @mySynSaver_process.docFunc
# # def insertRowProcess(colObj):
# #     dataList=[]
# #     rowList = []
# #     if type(colObj.value) == bytes:
# #         rowList.append(colObj.value.decode("utf8"))
# #     else:
# #         rowList.append(colObj.value)
...
# #             pool = ThreadPool()
# #             pool.map(insertRowProcess, rowItem.columns)
# #             pool.close()
# #             pool.join()
