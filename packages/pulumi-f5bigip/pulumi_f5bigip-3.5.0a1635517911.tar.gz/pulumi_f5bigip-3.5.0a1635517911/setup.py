...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '3.5.0-alpha.1635517911+6a78e705'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 3.5.0-alpha.1635517911+6a78e705`
                """)
            else:
                raise
