...
class MT9255Common(UniteInterface):
    ...
    def get_maxhub_share_macro(self):
        # MAXHUB SHARE
        ...
        if other_app_list and other_app_list.rfind('MAXHUB Share', 0, len(other_app_list)-1) != -1:
            ret = '#define CVT_EN_MAXHUB_SCREEN_SHARE'.ljust(self._space) + '1' + '\n'
        else:
            ret = '#define CVT_EN_MAXHUB_SCREEN_SHARE'.ljust(self._space) + '0' + '\n'
        return ret
