...
def plot_prices_against_time_series(
    ...
    time_series_description = df_data.iloc[0]["time_series_description"]
    df_plot = pd.merge(
    ...
    # hfont = {'fontname':'Roboto Regular'}

    # plt.title(str(ticker) + " price vs " + str(time_series_description),**csfont)
