...
from duckietown_challenges import DEFAULT_DTSERVER, read_submission_info
from . import logger

__all__ = ["make_readmes_templates_main"]
...
<a href="http://aido.duckietown.org"><img alt="logo" width="200"
src="https://www.duckietown.org/wp-content/uploads/2018/07/AIDO-768x512.png"/></a>
