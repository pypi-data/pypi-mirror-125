...
from azureml.automl.dnn.nlp.classification.io.read.dataloader import load_multiclass_dataset
...
class TestTextClassificationTrainerTests:
    ...
    def test_train_valid(self, get_by_id_mock, language_mock, trainer_mock, auto_config, auto_tokenizer,
        ...
        training_set, validation_set, label_list, _, _ = load_multiclass_dataset(
