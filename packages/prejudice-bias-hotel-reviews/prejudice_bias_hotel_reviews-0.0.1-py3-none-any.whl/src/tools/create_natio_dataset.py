...
my_parser = argparse.ArgumentParser(description='Creates a dataset for detecting nationality')
...
if __name__ == "__main__":
    ...
    # display a header :)
    res = pyfiglet.figlet_format('Nationality Dataset Creation')
    print(res)
    ...
    while True:
        ...
        for i, row in nationality.iterrows():
            ...
            print(f'{row.text}\n')
            prediction = input('Contains nationality, true (T), false (F) or set marker (X): ')
