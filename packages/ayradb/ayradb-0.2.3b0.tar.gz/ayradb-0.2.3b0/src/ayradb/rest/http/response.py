...
class Response:
    ...
    def from_byte_array(self, byte_array):
        ...
        parsable_bytes=0
        if byte_array.__len__()<self.body_parsing_start_pos+content_length:
            ...
            parsable_bytes=content_length
        #Parse all parsable bytes starting from the last byte parsed
