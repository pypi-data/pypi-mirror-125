...
from .bd import dbConductorCu, dbConductorAl, dbConductorCuStd, SITM
import numpy as np
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
| Web :  www.kelectric.org, 29/07/2021                                   |
| Version : 0.1.24rc6                                                    |
...
def version():
    ...
    print("                                                                          ")
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    print("| Python kelectric, 29/10/2021                                           |")
    print("| Version : 0.1.24rc6                                                    |")
    print("| Autor : Marco Polo Jacome Toss                                         |")
    print("| License: GNU Affero General Public License v3 (GPL-3.0)                |")
    print("| Requires: Python >=3.5                                                 |")
    print("| PyPi : https://pypi.org/project/kelectric/                             |")
...
def tricc(KVA,VP,VL,FP,IMP,Phase,Fm):

    if(KVA==None or VP==None or VL==None or FP== None or IMP==None or Phase==None or Fm==None):
        t = time.localtime()
        print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
        print("                    kelectric                                ")
        print("                 ",time.asctime(t))
        ...
        print("-------------------------------------------------------------")
        print("| Los parámetros no son correctos                           |")
        print("| para el módulo tricc(KVA,VP,VL,FP,IMP,PHASE,Fm)           |")
        print("-------------------------------------------------------------")
        return
    ...
    if Phase=="three-phase":
        ...
        InLLL=(KVA*1000)/(math.sqrt(3)*VL)
        Multiplicador=100/(IMP*FP)
        Isc=round((InLLL*Multiplicador*Fm)/1000,2)
        print(str(Isc)+" kA")
        ...
        InLN=(KVA*1000)/(VP)
        Multiplicador=100/(IMP*FP)
        Isc=round((InLL*Multiplicador*Fm)/1000,2)
        print(str(Isc)+" kA")
