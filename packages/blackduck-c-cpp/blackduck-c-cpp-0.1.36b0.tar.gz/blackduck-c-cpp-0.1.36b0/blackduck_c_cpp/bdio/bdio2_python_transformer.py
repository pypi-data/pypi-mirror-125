...
'''
Python wrapper to convert json to bdio2 format using
git@sig-gitlab.internal.synopsys.com:protecode-sc/katiska.git from bdba team.

This code need to be checked to be in sync with above repo 
@author Mayur kadu
@date March 11 2021
'''
...
class BDIO2Transformer:
    ...
    def __init__(self, cov_output, hub_api):
        ...
        self.vers_result = self.hub_api.hub.version_info['version'].split(".")
