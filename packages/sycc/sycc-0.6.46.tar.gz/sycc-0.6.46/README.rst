.. image:: https://img.shields.io/pypi/wheel/sycc/
...
::
    ...
    2.请合理使用使用本项目。如果您在使用项目时发现bug，可以发送emali到lwb@29@qq.com
    
    3.最终解释权归作者所有。

    4.别偷源代码！如果你发现有人窃取我的源代码，你可以通过电子邮件lwb29@qq.com告诉我，我会给你一些补偿
