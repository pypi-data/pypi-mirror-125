...
def pypi_org():
    ...
    try:
        ...
        if status == 0:
            ...
            if load_v(now_path+'/.net.txt')==1:
                ...
                while open_web in range(1,7):
                    ...
                    dd(1)
                print('\n')
                webbrowser.open('https://pypi.org/project/sycc/#description', new=0, autoraise=True)
        ...
        pass
def main():
    pdios();wf();pypi_org();user_key();A()
    print('\033[7;36m本次开始使用时间:\033[0m','\033[7;32m',start,'\033[0m','\033[\1;1m')
    while True:
        print('\033[1;1m【虹源三式】')
