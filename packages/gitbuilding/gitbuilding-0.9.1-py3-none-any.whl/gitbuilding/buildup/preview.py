...
class Previewer():
    ...
    def display_code(self, uri, alt_text, hover_text):
        """
        Returns
        """
        if self._enabled:
            return self._preview_code(uri, alt_text, hover_text)
        return self._static_markdown(uri, alt_text, hover_text)

    def _preview_code(self, uri, alt_text, hover_text):
        """
    ...
    def _static_markdown(self, uri, alt_text, hover_text):
        """
