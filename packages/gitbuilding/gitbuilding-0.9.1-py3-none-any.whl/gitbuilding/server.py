...
class GBWebPath():
    ...
    def gb_path_deduplicated(self):
        ...
        duplicate created by multipkle paths through the documentation this will
        return the orignal
        """
...
class GBServer(flask.Flask):
    ...
    def _raw_md(self, rawsubpath=None):
        ...
        return jsonify({"md": md, "page": rawsubpath})
    ...
    def _send_dynamic_file_obj(self, file_obj):
        ...
        write_local_file(filename, file_obj.content, ensure_relative=False, allow_external=True)
