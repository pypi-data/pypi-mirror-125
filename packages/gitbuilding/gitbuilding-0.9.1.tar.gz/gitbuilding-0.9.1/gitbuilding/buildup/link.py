...
class LinkData:
    ...
    def part(self):
        ...
        output link.
        """
        return not (self.step or self.output or self.bom or self.previewpage)
    ...
    def valid(self):
        ...
        """
        if self.step + self.output + self.bom + self.previewpage > 1:
