...
@LastEditTime: 2021-10-27 18:37:47
...
class ClientBaseHandler(FrameBaseHandler):
    ...
    def emoji_to_emoji_base64(self, text_str):
        ...
        :last_editors: HuangJianYi 
        """
        self.logging_link_error("【UpdateUserInfoHandler1】：" + CryptographyHelper.base64_encrypt(text_str, "utf-8"))
        self.logging_link_error("【UpdateUserInfoHandler2】：" + text_str)
        list_e = []
        for i in text_str:
            list_e.append(i)
        ...
        self.logging_link_error("【UpdateUserInfoHandler3】" + SevenHelper.json_dumps(list_e))
        return "".join(list_e)
