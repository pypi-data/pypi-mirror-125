...
class WebhooksApi(object):
    ...
    def webhook_get(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.webhook_get(async_req=True)
        >>> result = thread.get()
    ...
    def webhook_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_get_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def webhook_webhook_id_get(self, webhook_id, **kwargs):  # noqa: E501
        """Get Webhook Details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_webhook_id_get(webhook_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.webhook_webhook_id_get_with_http_info(webhook_id, **kwargs)  # noqa: E501
        else:
            (data) = self.webhook_webhook_id_get_with_http_info(webhook_id, **kwargs)  # noqa: E501
            return data

    def webhook_webhook_id_get_with_http_info(self, webhook_id, **kwargs):  # noqa: E501
        """Get Webhook Details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.webhook_webhook_id_get_with_http_info(webhook_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method webhook_webhook_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('webhook_id' not in params or
            ...
            raise ValueError("Missing the required parameter `webhook_id` when calling `webhook_webhook_id_get`")  # noqa: E501
