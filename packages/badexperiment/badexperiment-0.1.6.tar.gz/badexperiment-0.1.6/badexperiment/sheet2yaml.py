...
def get_pack_to_slot(slot_to_pack, iot_packages):
    slot_to_pack["ap_list"].loc[
        slot_to_pack["Associated Packages"] == "all"
        ] = slot_to_pack["Associated Packages"].apply(lambda _: iot_packages)

    slot_to_pack = slot_to_pack[["repaired_name", "ap_list"]]

    slot_to_pack = slot_to_pack.explode("ap_list")
    ...
    slot_to_pack = slot_to_pack.loc[slot_to_pack["ap_list"].ne("")]

    slot_to_pack = slot_to_pack.loc[slot_to_pack["ap_list"].ne("None")]

    slot_to_pack = slot_to_pack.loc[~slot_to_pack["ap_list"].isnull()]

    slot_to_pack = slot_to_pack[["ap_list", "repaired_name"]]
