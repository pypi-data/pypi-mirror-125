...
class ClientTransport(threading.Thread, QObject):
    ...
    def __init__(self, port, ip_address, database, username, passwd, keys):
        ...
        try:
            ...
            logger.critical(f'Потеряно соединение с сервером при обработке сообщения')
            raise ServerError('Потеряно соединение с сервером при обработке сообщения!')
    ...
    def connection_init(self, port, ip):
        ...
        logger.debug('Начало диалога авторизации')
        ...
        try:
            ...
            logger.debug('Ошибка соединения.', exc_info=e)
