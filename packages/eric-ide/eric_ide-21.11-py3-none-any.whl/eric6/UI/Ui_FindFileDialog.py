...
# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric6-21.11/eric/eric6/UI/FindFileDialog.ui'
#
...
class Ui_FindFileDialog(object):
    def setupUi(self, FindFileDialog):
        ...
        self.buttonBox.rejected.connect(FindFileDialog.close) # type: ignore
