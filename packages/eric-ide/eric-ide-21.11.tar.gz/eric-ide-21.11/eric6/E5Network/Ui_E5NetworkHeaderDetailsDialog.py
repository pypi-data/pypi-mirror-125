...
# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric6-21.11/eric/eric6/E5Network/E5NetworkHeaderDetailsDialog.ui'
#
...
class Ui_E5NetworkHeaderDetailsDialog(object):
    def setupUi(self, E5NetworkHeaderDetailsDialog):
        ...
        self.buttonBox.accepted.connect(E5NetworkHeaderDetailsDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(E5NetworkHeaderDetailsDialog.reject) # type: ignore
