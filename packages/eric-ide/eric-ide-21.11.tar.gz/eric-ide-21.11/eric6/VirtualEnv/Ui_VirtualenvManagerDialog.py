...
# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric6-21.11/eric/eric6/VirtualEnv/VirtualenvManagerDialog.ui'
#
...
class Ui_VirtualenvManagerDialog(object):
    def setupUi(self, VirtualenvManagerDialog):
        ...
        self.buttonBox.accepted.connect(VirtualenvManagerDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(VirtualenvManagerDialog.reject) # type: ignore
