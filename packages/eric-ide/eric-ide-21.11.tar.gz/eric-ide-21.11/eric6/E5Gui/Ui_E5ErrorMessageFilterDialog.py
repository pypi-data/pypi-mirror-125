...
# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric6-21.11/eric/eric6/E5Gui/E5ErrorMessageFilterDialog.ui'
#
...
class Ui_E5ErrorMessageFilterDialog(object):
    def setupUi(self, E5ErrorMessageFilterDialog):
        ...
        self.buttonBox.accepted.connect(E5ErrorMessageFilterDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(E5ErrorMessageFilterDialog.reject) # type: ignore
