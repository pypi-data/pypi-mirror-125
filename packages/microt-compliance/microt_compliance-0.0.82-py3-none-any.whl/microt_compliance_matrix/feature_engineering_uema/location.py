...
from microt_compliance_matrix.utils.uncompress_file import *
from microt_compliance_matrix.utils.get_haversine_distance import *
...
def get_distance_from_home(location, info_dict):
    ...
    if type(location) != str:
        distance_from_home_candidate_list = []
...
def match_feature(prompt_local_datetime_series, df_logs_combined, info_dict, participant_id):
    ...
    for idx in prompt_local_datetime_series.index:
        ...
        if p_id_exist_info_dict:
            ...
            distance_from_home = "JsonNF"  # this means this participant has no recovered lsf.json
