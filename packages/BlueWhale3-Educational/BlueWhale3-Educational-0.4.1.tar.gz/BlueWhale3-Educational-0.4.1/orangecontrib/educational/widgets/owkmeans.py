...
class OWKmeans(OWWidget):
    ...
    def _create_variables_box(self):
        ...
        gui.widgetLabel(self.variables_box, __("label.variables"))
    ...
    def _create_buttons_box(self):
        ...
        self.step_back_button = \
            gui.button(box, self, __("btn.step_back"), callback=self.step_back)
        gui.rubber(box)
        self.restart_button = \
            gui.button(box, self, __("btn.randomize"), callback=self.restart)
    ...
    def _update_buttons(self):
        ...
        self.step_button.setText(
            __("btn.reassign_membership")
            if self.k_means and self.k_means.waits_reassignment
            else __("btn.recompute_centroid"))
        ...
        self.auto_play_button.setText(__("btn.stop") if running else __("btn.run_simulation"))
