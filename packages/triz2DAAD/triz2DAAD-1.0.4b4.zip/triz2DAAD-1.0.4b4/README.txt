...
Triz2DAAD versión 1.0.4b4 211102 (c) 2019-21 Pedro Fernández
...
- La opción -dr creará una plantilla compatible con DAAD Ready 0.4.
...
**NUEVO**: la opción -dr creará una plantilla compatible con DAAD Ready 0.4. En este modo la barra de estado y la opción -md quedan desactivadas.
...
Triz2DAAD version 1.0.4b4 211102 (c) 2019-21 Pedro Fernández
...
- Option -dr will create a DAAD Ready 0.4 compatible template.
...
**NEW**: -dr option will create a DAAD Ready 0.4 compatible template. In this mode status line and -md options are disabled.
...
- **1.0.4b4** 211102
 ...
 - Retires unused [m] and [1] attributes from objects (just in case someone used them from triz2sce days)
