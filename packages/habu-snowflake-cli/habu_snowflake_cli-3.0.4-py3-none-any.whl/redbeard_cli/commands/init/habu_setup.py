...
def setup_clean_room_common(sf_connection, customer_account_id: str, is_provider: bool):
    ...
    snowflake_utils.run_query(
        sf_connection,
        "ALTER SHARE HABU_CLEAN_ROOM_COMMON_SHARE ADD ACCOUNTS = JYA07515 share_restrictions=false"
    )
...
def setup_data_connection_objects(sf_connection, customer_account_id: str):
    ...
    snowflake_utils.run_query(
        sf_connection,
        "ALTER SHARE HABU_DATA_CONNECTIONS_SHARE ADD ACCOUNTS = JYA07515 share_restrictions=false"
    )
