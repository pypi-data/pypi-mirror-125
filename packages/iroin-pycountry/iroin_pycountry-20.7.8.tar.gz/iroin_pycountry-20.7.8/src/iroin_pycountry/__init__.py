...
try:
    ...
    __version__ = pkg_resources.get_distribution("iroin_pycountry").version
except ImportError:
    __version__ = 'n/a'
...
LOCALES_DIR = resource_filename('iroin_pycountry', 'locales')
DATABASE_DIR = resource_filename('iroin_pycountry', 'databases')
...
class ExistingCountries(iroin_pycountry.db.Database):
...
class Scripts(iroin_pycountry.db.Database):
...
class Currencies(iroin_pycountry.db.Database):
...
class Languages(iroin_pycountry.db.Database):
...
class LanguageFamilies(iroin_pycountry.db.Database):
...
class Subdivision(iroin_pycountry.db.Data):
...
class Subdivisions(iroin_pycountry.db.Database):
