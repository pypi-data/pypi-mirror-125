...
if __name__=='__main__':
    ...
    hgt_uv_rh(data_name='grapes_meso_1km',rh_lev=700,uv_lev=700,
            area=[115.45-0.051,115.45+0.05,40.9-0.05,40.9+0.051],
            is_mask_terrain=True,add_background_style='satellite',background_zoom_level=14)
    plt.show()
