...
class DelayedJob(Document):
    ...
    meta = { "indexes": ["-scheduled_at", "jib"], "db_alias": "lgt_leads" }

class UserCreditStatementDocument(Document):
    meta = {"indexes": ["user_id", "-created_at", ("user_id", "action")], "db_alias": "lgt_leads"}
...
class UserFeedLead(Document):
    # meta = {"indexes": ["user_id", "$full_message_text", "created_at", ("user_id", "created_at")], "db_alias": "lgt_leads"}
