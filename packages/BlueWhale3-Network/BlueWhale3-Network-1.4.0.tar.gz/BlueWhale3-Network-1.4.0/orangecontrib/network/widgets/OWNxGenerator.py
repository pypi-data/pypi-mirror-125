...
def __(key):
    return i18n.t('network.OWNxGenerator.' + key)
...
class OWNxGenerator(widget.OWWidget):
    ...
    GRAPH_TYPES = (
        (path, __("Path"),
         __("defaults.path_len"), (10, 2, 100)),
        (cycle, __("Cycle"),
         __("with"), (10, 3, 100), __("nodes")),
        (complete, __("Complete"),
         __("with"), (5, 1, 100), __("nodes")),
        (complete_bipartite, __("Complete bipartite"),
         __("with"), (5, 1, 100), __("defaults.and"), (8, 1, 100), __("nodes")),
        (barbell, __("Barbell"),
         __("with"), (5, 1, 100), __("defaults.and"), (8, 1, 100), __("nodes")),
        (ladder, __("Ladder"),
         __("with"), (10, 2, 100), __("defaults.steps")),
        (circular_ladder, __("Circular ladder"),
         __("with"), (8, 2, 100), __("defaults.steps")),
        (grid, __("Grid"),
         __("defaults.grid_height"), (4, 2, 100), __("defaults.grid_width"), (5, 2, 100)),
        (hypercube, __("Hypercube"),
         ", ", (4, 1, 14), __("defaults.dimensional")),
        (star, __("Star"), __("with"), (10, 1, 1000), __("defaults.edges")),
        (lollipop, __("Lollipop"),
         __("with"), (5, 3, 30), __("defaults.nodes_stem"), (5, 3, 100), __("nodes")),
        (geometric, __("Geometric"),
         __("with"), (20, 2, 100), __("defaults.nodes"), (50, 1, 10000), __("defaults.edges"))
    )
    ...
    def __init__(self):
        ...
        self.bt_generate = gui.button(
            self.controlArea, self, __("regenerate_network"),
