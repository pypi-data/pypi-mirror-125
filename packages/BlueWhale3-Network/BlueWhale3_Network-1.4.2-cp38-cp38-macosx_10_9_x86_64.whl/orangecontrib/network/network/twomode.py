...
def __(key):
    return i18n.t('network.twomode.' + key)
...
Weighting = [WeightType(*x) for x in (
    (__("weight.no_weights"), _weight_no_weights),
    (__("weight.connections"), _weight_connections),
    (__("weight.weighted_connection"), _weight_weighted_connections),
    (__("weight.geo"), _weight_geo),
    (__("weight.geodeg"), _weight_geodeg),
    (__("weight.input"), _weight_input),
    (__("weight.output"), _weight_output),
    (__("weight.min"), _weight_min),
    (__("weight.max"), _weight_max)
)]
