...
class TopicRule(
    ...
    def __init__(
        ...
        *,
        ...
        :param topic_rule_name: (experimental) The name of the rule. Default: None

        :stability: experimental
        '''
        props = TopicRuleProps(sql=sql, topic_rule_name=topic_rule_name)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"sql": "sql", "topic_rule_name": "topicRuleName"},
)
