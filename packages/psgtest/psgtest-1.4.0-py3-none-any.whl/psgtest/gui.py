...
"""
    ...
    MM"""""""`YM          MP""""""`MM oo                     dP          M""""""""M                     dP   
    MM  mmmmm  M          M  mmmmm..M                        88          Mmmm  mmmM                     88   
    M'        .M dP    dP M.      `YM dP 88d8b.d8b. 88d888b. 88 .d8888b. MMMM  MMMM .d8888b. .d8888b. d8888P 
    MM  MMMMMMMM 88    88 MMMMMMM.  M 88 88'`88'`88 88'  `88 88 88ooood8 MMMM  MMMM 88ooood8 Y8ooooo.   88   
    MM  MMMMMMMM 88.  .88 M. .MMM'  M 88 88  88  88 88.  .88 88 88.  ... MMMM  MMMM 88.  ...       88   88   
    MM  MMMMMMMM `8888P88 Mb.     .dM dP dP  dP  dP 88Y888P' dP `88888P' MMMM  MMMM `88888P' `88888P'   dP   
    MMMMMMMMMMMM      .88 MMMMMMMMMMM               88                   MMMMMMMMMM                          
                  d8888P                            dP
...
interpreter_dict = {'3.6': '-P36-', '3.7': '-P37-', '3.8': '-P38-', '3.9': '-P39-', '3.10': '-P310-'}
...
def make_output_tab(tab_text, key, tab_key):
    tab = sg.Tab(tab_text, [[sg.Multiline(
        ...
        expand_x=True, expand_y=True, write_only=True, key=key, auto_refresh=True, font=sg.user_settings_get_entry('-output font-', 'Courier 10')), ],
                            [sg.B('Copy To Clipboard', k=('-COPY-', key)), sg.B('Clear', k=('-CLEAR-', key))]],
                 right_click_menu=sg.MENU_RIGHT_CLICK_EDITME_VER_LOC_EXIT, k=tab_key)
...
def make_window(sp_to_mline_dict=None, sp_to_filename=None):
    ...
    choose_interpreter_at_top = sg.pin(sg.Column([[sg.T('Launch using'),
                                                   sg.Combo(sorted(interpreter_list), default_value=sg.user_settings_get_entry('-current interpreter-', ''),
                                                            size=(len(interpreter_list) + 1, 8), key='-INTERPRETER TOP-', enable_events=True, readonly=True)]],
