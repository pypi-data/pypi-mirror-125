...
# --verbose --repository testpypi dist/HSL-1.0.3-cp38-cp38-win_amd64.whl-cp38-cp38-win_amd64.whl

# for python 3.6
# C:\Users\yoann\AppData\Roaming\Python\Python36\Scripts\twine upload
# --verbose --repository testpypi dist/HSL-1.0.3-cp36-cp36-win_amd64.whl
...
# PRODUCTION v:
# version 1.0.2
# C:\Users\yoann\AppData\Roaming\Python\Python38\Scripts\twine upload --verbose dist/HSL-1.0.2*
...
setuptools.setup(
    ...
    data_files=[('./lib/site-packages/HSL',
                 ['example.py',
                  'hsl.pxd',
                  'hsl.pyx',
                  'hsl_c.c',
                  ...
                  'requirements.txt',
                  'setup_hsl.py',
                  #'build/lib.win-amd64-3.8/HSL/hsl.cp38-win_amd64.pyd',
                  #'build/lib.win-amd64-3.8/HSL/testing.cp38-win_amd64.pyd',
                  '__init__.pxd',
                  '__init__.py',
                  'testing.pyx',
                  'pyproject.toml',
