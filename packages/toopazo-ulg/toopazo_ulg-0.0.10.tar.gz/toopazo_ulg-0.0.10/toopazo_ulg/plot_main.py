...
class UlgMain:
    ...
    def process_logdir(self):
        ...
        FFTools.run_method_on_folder(self.logdir, '.ulg', ulgprocess.process_file)
...
if __name__ == '__main__':
    ...
    # ubdir = FFTools.full_path(args.bdir)
    ubdir = os.path.abspath(args.bdir)
    ...
    # Copy-paste this command to run the code
    # python
    # /home/tzo4/Dropbox/tomas/pennState/avia/software/toopazo_ulg/
    # plot_main.py --bdir .
