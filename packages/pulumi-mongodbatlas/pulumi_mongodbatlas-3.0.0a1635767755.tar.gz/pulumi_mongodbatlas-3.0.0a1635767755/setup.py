...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '3.0.0-alpha.1635767755+6b192b4f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 3.0.0-alpha.1635767755+6b192b4f`
                """)
            else:
                raise
