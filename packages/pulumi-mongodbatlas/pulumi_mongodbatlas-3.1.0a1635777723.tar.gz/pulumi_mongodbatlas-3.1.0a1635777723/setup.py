...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '3.1.0-alpha.1635777723+5a7a2003'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 3.1.0-alpha.1635777723+5a7a2003`
                """)
            else:
                raise
