...
from defektor_api import rest
from defektor_api.configuration import Configuration
from defektor_api.exceptions import ApiTypeError, ApiValueError, ApiException
from defektor_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.all_plans_delete  # this is an instance of the class Endpoint
        api_instance.all_plans_delete()  # this invokes api_instance.all_plans_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.all_plans_delete.callable or self.callable in this class
