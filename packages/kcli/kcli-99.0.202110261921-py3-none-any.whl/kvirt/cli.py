...
def create_plan(args):
    ...
    if force:
        if plan is None:
            ...
            config.delete_plan(plan, unregister=unregister)
    if plan is None:
        plan = nameutils.get_random_name()
        pprint("Using %s as name of the plan" % plan)
...
def cli():
    ...
    plancreate_parser.add_argument('--unregister', action='store_true', help='Remove rhel subscriptions')
    ...
    plandelete_parser.add_argument('-u', '--unregister', action='store_true', help='Remove rhel subscriptions')
    ...
    vmdelete_parser.add_argument('-u', '--unregister', action='store_true', help='Remove rhel subscription')
