...
def get_dispersion(geocoded_data:Union(pd.DataFrame,dict,str) , metrics: list) -> pd.DataFrame:
    ...
    geocoded_data = ast.literal_eval(geocoded_data)

    # MAPEAR LAT LONG PARA TUPLA EM GEOMETRY
    ...
    try:
        ...
        raise("it is necessary to inform at least one metric")
