    ...
    class GenerateSettings:
        ...
        def settings(self):
            try:
                ...
                LightThemeSelectedColour = self.FontCol
                DarkThemeSelectedColour = self.FontCol
                LowModeSelectedColour = self.FontCol
                MediumModeSelectedColour = self.FontCol
                HighModeSelectedColour = self.FontCol
                AdaptiveModeSelectedColour = self.FontCol
                FPSsliderSelectedColour = self.FontCol
                FOVsliderSelectedColour = self.FontCol
                CameraRotationSpeedSliderSelectedColour = self.FontCol
                AAselectorSelectedColour = self.FontCol
                RenderFOGSelectorSelectedColour = self.FontCol
                FancySkiesSelectorSelectedColour = self.FontCol
                FancyParticlesSelectorSelectedColour = self.FontCol
                SoundSelectorSelectedColour = self.FontCol
                SoundSliderSelectedColour = self.FontCol
                MusicSelectorSelectedColour = self.FontCol
                MusicSliderSelectedColour = self.FontCol
                ...
                while True:
                    ...
                    InfoFont = InfoTitleFont.render("Settings", self.aa, self.FontCol)
                    InfoWidth = InfoFont.get_width()
                    ...
                    if My >= 85+scroll and My <= 95+scroll and Mx >= 40 and Mx <= 80:
                        ...
                        if mousebuttondown == True:
                            rendis = 60
                            self.FPS = self.mod_Random__.randint(15, 30)
                            self.aa = False
                            self.RenderFOG = False
                            self.FanSky = False
                            self.FanPart = False
                    ...
                    if My >= 85+scroll and My <= 95+scroll and Mx >= 90 and Mx <= 155:
                        ...
                        if mousebuttondown == True:
                            rendis = 80
                            self.FPS = self.mod_Random__.randint(30, 60)
                            self.aa = True
                            self.RenderFOG = False
                            self.FanSky = True
                            self.FanPart = False
                    ...
                    if My >= 85+scroll and My <= 95+scroll and Mx >= 165 and Mx <= 205:
                        ...
                        if mousebuttondown == True:
                            rendis = 100
                            self.FPS = self.mod_Random__.randint(60, 120)
                            self.aa = True
                            self.RenderFOG = True
                            self.FanSky = True
                            self.FanPart = True
                    ...
                    if My >= 85+scroll and My <= 95+scroll and Mx >= 215 and Mx <= 300:
                        ...
                        if mousebuttondown == True:
                            rendis = (self.mod_Psutil__.cpu_freq(percpu=True)[0][2])/20
