if not __name__ == "__main__":
    ...
    class DetermineThemeColours:
        ...
        def GetColours(self):
            try:
                self.themeArray = [[(255, 255, 255), [30, 30, 30], (80, 80, 80), (237, 125, 49)], [(0, 0, 0), [255, 255, 255], (80, 80, 80), (237, 125, 49)]]
                if self.theme == "dark":
                ...
                while self.theme == False:
                    ...
                    if mX >= 260 and mX <= 460 and mY >= 300 and mY <= 460:
                        if mousebuttondown == True:
                            ...
                            self.mod_Pygame__.mixer.music.load(self.mod_OS__.path.join(self.base_folder, ("Resources\\General_Resources\\Click.ogg")))
