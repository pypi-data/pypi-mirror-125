    ...
    class GenerateBenchmarkMenu:
        def __init__(self):
            try:
                ...
                base_folder = self.mod_OS__.path.dirname(__file__)
        ...
        def Benchmark(self):
            try:
                ...
                BenchmarkFont = InfoTitleFont.render("Benchmark", self.aa, self.FontCol)
                ...
                while True:
                    ...
                    if stage == 2:
                        try:
                            SavedWidth, SavedHeight = self.mod_Pygame__.display.get_window_size()
