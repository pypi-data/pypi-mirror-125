            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        self.mod_Sys__.exit("4-Thank you for playing")
                    except:
                        quit()
        ...
        def PycraftSelfTest(self):
            try:
                ...
                if not currentDate == self.lastRun or self.crash == True:
                    ...
                    data = self.mod_Pygame__.mixer.music.load(self.mod_OS__.path.join(self.base_folder, ("Resources\\General_Resources\\Click.ogg")))
                    self.mod_CaptionUtils__.GenerateCaptions.GetLoadingCaption(self, 3)
