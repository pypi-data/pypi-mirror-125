...
def parse_arguments():
    ...
    parser.add_argument('--result_file',     '-rf', required=True,  default='output/aggregate.json')
    parser.add_argument('--account_file',    '-af', required=False)
    parser.add_argument('--account_section', '-as', required=False)
