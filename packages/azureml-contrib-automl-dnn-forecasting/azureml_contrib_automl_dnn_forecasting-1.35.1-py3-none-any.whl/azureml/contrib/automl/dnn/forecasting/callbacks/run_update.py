    ...
    def _score_metrics(self, loss : float) -> None:
        ...
        if self.ds_valid.cross_validation:
            ...
            for i in eval_list:
                ...
                scores = slice_scores if len(cv_scores) > 1 else (
                    aggregate_scores(cv_scores, FORECASTING_SET | REGRESSION_SET))
