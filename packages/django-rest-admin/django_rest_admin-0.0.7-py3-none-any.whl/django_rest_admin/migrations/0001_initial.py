# Generated by Django 3.2.8 on 2021-10-28 14:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_key_id', django_rest_admin.model_field.JSONField(blank=True, help_text='外键定义.关联删除属性：CASCADE-关联删除, SET_NULL-字段变空, DO_NOTHING-不做操作. eg: {"user":["User", "CASCADE"], "article":["Article", "SET_NULL"]}', null=True)),
