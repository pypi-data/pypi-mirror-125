...
class StdONNXQuantConv2dHandler(StdONNXQuantConvNdHandler, Kernel2dApplHandlerMixin):
    handled_layer = QuantConv2d


class StdONNXQuantConv1dHandler(StdONNXQuantConvNdHandler, Kernel1dApplHandlerMixin):
