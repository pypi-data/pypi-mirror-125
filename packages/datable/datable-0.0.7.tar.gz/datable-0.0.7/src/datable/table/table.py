...
class Datable:
    ...
    def __init__(self, data=[], header=[]):
        ...
        self.top = tk.Tk()
        self.top.iconbitmap("./../resource/zrnt.ico")
    ...
    def show(self):
        ...
        sheet = tksheet.Sheet(self.top, width=1000, height=1000, total_columns=len(self.header))

        sheet.grid()
        sheet.headers(["Caption colum 1","Caption colum 2","Caption colum 3","Caption colum 4"])
