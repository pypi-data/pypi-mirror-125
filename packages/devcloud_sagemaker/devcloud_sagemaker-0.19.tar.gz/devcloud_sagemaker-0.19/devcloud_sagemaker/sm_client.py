...
if __name__ == "__main__":
    ...
    #print(files)
    make_tar("yolov5")
    create_training_job("none", "none", "none", {"instance_type":"ml.m5.xlarge", "instance_count":"1", "framework_version":"1.8.1", "hyperparameters":{"imgsz":"64", "epochs":"10"}})
    #make_tar("train.py")
