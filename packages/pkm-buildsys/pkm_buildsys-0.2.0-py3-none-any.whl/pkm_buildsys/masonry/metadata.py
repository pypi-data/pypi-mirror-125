...
if TYPE_CHECKING:
    from pkm_buildsys.packages import Package  # noqa
...
class Metadata:
    ...
    def from_package(cls, package: "Package") -> "Metadata":
        from pkm_buildsys.utils.helpers import canonicalize_name
        from pkm_buildsys.utils.helpers import normalize_version
        from pkm_buildsys.version.helpers import format_python_constraint
