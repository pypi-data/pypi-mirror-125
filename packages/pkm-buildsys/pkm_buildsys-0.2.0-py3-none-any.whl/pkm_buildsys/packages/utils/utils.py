...
if TYPE_CHECKING:
    from pkm_buildsys.packages.constraints import BaseConstraint  # noqa
    from pkm_buildsys.semver.helpers import VersionTypes  # noqa
    from pkm_buildsys.semver.version import Version  # noqa
    from pkm_buildsys.semver.version_constraint import VersionConstraint  # noqa
    from pkm_buildsys.semver.version_range import VersionRange  # noqa
    from pkm_buildsys.semver.version_union import VersionUnion  # noqa
    from pkm_buildsys.version.markers import BaseMarker  # noqa
...
def group_markers(
    ...
    from pkm_buildsys.version.markers import MarkerUnion
    from pkm_buildsys.version.markers import MultiMarker
    from pkm_buildsys.version.markers import SingleMarker
...
def create_nested_marker(
    ...
    from pkm_buildsys.packages.constraints.constraint import Constraint
    from pkm_buildsys.packages.constraints.multi_constraint import MultiConstraint
    from pkm_buildsys.packages.constraints.union_constraint import UnionConstraint
    from pkm_buildsys.semver.version import Version
    from pkm_buildsys.semver.version_union import VersionUnion
...
def get_python_constraint_from_marker(
    ...
    from pkm_buildsys.semver.empty_constraint import EmptyConstraint
