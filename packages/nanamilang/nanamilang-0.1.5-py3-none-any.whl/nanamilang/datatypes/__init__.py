...
from .exception import NException


class DataType:
    """NanamiLang DataType class, all data types dictionary"""
    ...
    complex_types: list = [Set.get('name'),
                           Vector.get('name'),
                           HashMap.get('name')]
    simple_types: list = [Undefined.get('name'), Macro.get('name'),
                          Function.get('name'), Boolean.get('name'),
