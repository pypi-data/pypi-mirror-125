...
class People(object):
    ...
    def get_all_people(self, fields=None, includeTerminated=False):
        ...
        query = self.bitsdb.collection(self.people_collection)
    ...
    def get_people(self, args, role):
        ...
        return self.run_query(self.people_collection, kind, args)

    def get_person(self, args, role):
        """Return a person from firestore."""
        coll = self.bitsdb.collection(self.people_collection)
    ...
    def get_person_direct_reports(self, args, role):
        ...
        # run query
        query = self.bitsdb.collection(self.people_collection).where(
    ...
    def search_people(self, args, role):
        ...
        # create query string
        query = 'SELECT * FROM `broad-gaia-prod.gaia.people`'
