...
pass_stmt = Literal("<#>").setParseAction(replaceWith('pass'))
cont_stmt = Literal("<$>").setParseAction(replaceWith('continue'))
break_stmt = Literal("<%>").setParseAction(replaceWith('break'))
if_cond = Literal('<?>').setParseAction(replaceWith('if '))
