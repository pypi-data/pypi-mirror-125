...
certificate = acm.Certificate.from_certificate_arn(scope, "existing-cert", "arn:aws:acm:us-east-1:123456789012:certificate/11112222-3333-1234-1234-123456789012")
props = {
...
AlbToLambda(stack, "new-construct", props)
```
