...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, headers=None, total_timeout=None, pulp_href=None, max_retries=None, name=None, client_cert=None, sock_connect_timeout=None, rate_limit=None, download_concurrency=None, pulp_created=None, pulp_labels=None, connect_timeout=None, tls_validation=None, pulp_last_updated=None, url=None, ca_cert=None, sock_read_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
