...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, client_cert=None, proxy_password=None, name=None, pulp_labels=None, username=None, total_timeout=None, rate_limit=None, proxy_url=None, headers=None, download_concurrency=None, sock_read_timeout=None, connect_timeout=None, sock_connect_timeout=None, proxy_username=None, password=None, ca_cert=None, max_retries=None, tls_validation=None, client_key=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
