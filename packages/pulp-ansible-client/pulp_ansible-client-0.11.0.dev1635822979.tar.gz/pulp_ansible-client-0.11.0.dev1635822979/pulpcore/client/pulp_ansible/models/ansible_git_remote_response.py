...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, pulp_href=None, client_cert=None, name=None, pulp_labels=None, total_timeout=None, rate_limit=None, proxy_url=None, headers=None, download_concurrency=None, sock_read_timeout=None, connect_timeout=None, sock_connect_timeout=None, pulp_created=None, pulp_last_updated=None, ca_cert=None, max_retries=None, tls_validation=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
