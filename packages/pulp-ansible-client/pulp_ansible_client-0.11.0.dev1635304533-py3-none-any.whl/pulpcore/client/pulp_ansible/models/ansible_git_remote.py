...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, username=None, headers=None, password=None, sock_read_timeout=None, connect_timeout=None, client_key=None, url=None, download_concurrency=None, pulp_labels=None, tls_validation=None, client_cert=None, rate_limit=None, sock_connect_timeout=None, max_retries=None, total_timeout=None, proxy_url=None, proxy_password=None, ca_cert=None, proxy_username=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
