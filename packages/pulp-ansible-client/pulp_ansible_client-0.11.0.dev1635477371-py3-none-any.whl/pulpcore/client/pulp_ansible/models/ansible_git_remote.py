...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, ca_cert=None, sock_connect_timeout=None, download_concurrency=None, connect_timeout=None, proxy_url=None, total_timeout=None, pulp_labels=None, rate_limit=None, tls_validation=None, password=None, sock_read_timeout=None, name=None, proxy_username=None, proxy_password=None, max_retries=None, url=None, headers=None, client_key=None, username=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
