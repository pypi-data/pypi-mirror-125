...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, ca_cert=None, sock_connect_timeout=None, download_concurrency=None, connect_timeout=None, proxy_url=None, pulp_href=None, total_timeout=None, pulp_created=None, pulp_labels=None, rate_limit=None, tls_validation=None, sock_read_timeout=None, name=None, pulp_last_updated=None, max_retries=None, url=None, headers=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
