...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, name=None, download_concurrency=None, connect_timeout=None, max_retries=None, rate_limit=None, pulp_href=None, client_cert=None, sock_read_timeout=None, tls_validation=None, total_timeout=None, sock_connect_timeout=None, pulp_labels=None, pulp_created=None, headers=None, url=None, pulp_last_updated=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
