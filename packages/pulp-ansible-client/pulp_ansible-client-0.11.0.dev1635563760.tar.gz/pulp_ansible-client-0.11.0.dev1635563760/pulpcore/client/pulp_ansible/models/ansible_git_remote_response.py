...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, pulp_created=None, url=None, pulp_labels=None, connect_timeout=None, proxy_url=None, total_timeout=None, tls_validation=None, max_retries=None, pulp_last_updated=None, pulp_href=None, sock_connect_timeout=None, client_cert=None, download_concurrency=None, sock_read_timeout=None, rate_limit=None, headers=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
