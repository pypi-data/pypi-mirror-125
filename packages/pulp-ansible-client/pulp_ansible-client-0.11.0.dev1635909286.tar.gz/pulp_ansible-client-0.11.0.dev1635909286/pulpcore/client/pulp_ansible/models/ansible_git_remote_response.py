...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, pulp_labels=None, rate_limit=None, connect_timeout=None, max_retries=None, download_concurrency=None, headers=None, ca_cert=None, tls_validation=None, total_timeout=None, name=None, sock_connect_timeout=None, sock_read_timeout=None, pulp_href=None, pulp_last_updated=None, pulp_created=None, client_cert=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
