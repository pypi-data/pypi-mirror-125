...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, url=None, pulp_labels=None, rate_limit=None, connect_timeout=None, password=None, max_retries=None, username=None, download_concurrency=None, headers=None, ca_cert=None, tls_validation=None, proxy_username=None, total_timeout=None, name=None, client_key=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_password=None, client_cert=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
