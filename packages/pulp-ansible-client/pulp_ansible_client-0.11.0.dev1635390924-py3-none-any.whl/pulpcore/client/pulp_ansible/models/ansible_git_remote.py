...
class AnsibleGitRemote(object):
    ...
    def __init__(self, sock_connect_timeout=None, max_retries=None, client_cert=None, sock_read_timeout=None, download_concurrency=None, name=None, client_key=None, proxy_url=None, tls_validation=None, rate_limit=None, url=None, connect_timeout=None, proxy_username=None, total_timeout=None, proxy_password=None, username=None, password=None, headers=None, pulp_labels=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
