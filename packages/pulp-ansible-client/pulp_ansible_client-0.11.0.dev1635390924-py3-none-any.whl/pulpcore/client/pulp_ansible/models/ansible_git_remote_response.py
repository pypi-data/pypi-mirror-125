...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_connect_timeout=None, pulp_href=None, max_retries=None, client_cert=None, sock_read_timeout=None, download_concurrency=None, name=None, proxy_url=None, tls_validation=None, pulp_created=None, rate_limit=None, pulp_last_updated=None, url=None, connect_timeout=None, total_timeout=None, headers=None, pulp_labels=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
