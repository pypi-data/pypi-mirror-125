...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, proxy_url=None, name=None, download_concurrency=None, connect_timeout=None, max_retries=None, proxy_password=None, rate_limit=None, proxy_username=None, client_cert=None, sock_read_timeout=None, tls_validation=None, total_timeout=None, sock_connect_timeout=None, pulp_labels=None, username=None, headers=None, url=None, password=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
