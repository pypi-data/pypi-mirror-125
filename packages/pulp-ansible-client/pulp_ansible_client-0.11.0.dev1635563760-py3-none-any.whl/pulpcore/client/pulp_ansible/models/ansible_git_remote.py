...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, url=None, pulp_labels=None, connect_timeout=None, proxy_url=None, total_timeout=None, username=None, tls_validation=None, password=None, proxy_username=None, max_retries=None, client_key=None, sock_connect_timeout=None, client_cert=None, download_concurrency=None, sock_read_timeout=None, proxy_password=None, rate_limit=None, headers=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
