...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, headers=None, sock_read_timeout=None, connect_timeout=None, url=None, download_concurrency=None, pulp_labels=None, tls_validation=None, client_cert=None, rate_limit=None, sock_connect_timeout=None, max_retries=None, pulp_href=None, total_timeout=None, proxy_url=None, ca_cert=None, pulp_last_updated=None, pulp_created=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
