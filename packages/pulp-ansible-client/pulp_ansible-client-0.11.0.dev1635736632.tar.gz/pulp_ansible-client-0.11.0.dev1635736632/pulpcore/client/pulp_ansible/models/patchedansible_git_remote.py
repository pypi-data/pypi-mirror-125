...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, headers=None, total_timeout=None, max_retries=None, name=None, proxy_username=None, client_cert=None, sock_connect_timeout=None, rate_limit=None, download_concurrency=None, pulp_labels=None, client_key=None, connect_timeout=None, password=None, tls_validation=None, username=None, url=None, ca_cert=None, sock_read_timeout=None, proxy_password=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
