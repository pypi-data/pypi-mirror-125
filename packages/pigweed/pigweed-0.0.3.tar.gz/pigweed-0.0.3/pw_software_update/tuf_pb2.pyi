...
class CommonMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_expires",b"_expires",u"expires",b"expires"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_expires",b"_expires",u"expires",b"expires",u"spec_version",b"spec_version",u"version",b"version"]) -> None: ...
