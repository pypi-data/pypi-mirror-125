...
def opensio(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        if ok:
            ...
            raise Exception("The 'opensio' decorator has failed to load or open the library")
    return wrapper
...
class TestLib(TestBase):
    ...
    def test_Constructor(self):
        ...
        with LIBUSBSIO(autoload=False) as sio:
            ...
            self.assertTrue(isinstance(sio.LoadDLL("bad_path", raiseOnError=False), Exception))
