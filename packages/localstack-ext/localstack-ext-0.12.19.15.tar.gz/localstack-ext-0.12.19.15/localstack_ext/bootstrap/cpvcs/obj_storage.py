...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=oJSvl
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:oJSvw)->oJSvw:
  pass
 @oJSvR
 def get(cls,requested_file_locator:oJSvw):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=oJSvl
 @oJSvR
 def get(cls,state_file_locator:oJSvw,requested_storage:oJSvw,serializers:Dict[oJSvw,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[oJSvw,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:oJSvw)->oJSvw:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:oJSvw)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:oJSvw)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:oJSvw)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:oJSvw)->oJSvw:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[oJSvw]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:oJSvw,new_key:oJSvw,referenced_by_version:oJSvw=oJSvl):
  pass
 @abc.abstractmethod
 def version_exists(self,key:oJSvw)->oJSvs:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:oJSvw,key:oJSvw):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:oJSvw,new_key:oJSvw,base_path:oJSvw)->oJSvs:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[oJSvw]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[oJSvw,oJSvw],remote_location:oJSvw=oJSvl)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[oJSvw]:
  ...
  for cpvcs_obj in args:
   if oJSvX(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif oJSvX(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[oJSvw,oJSvw],remote_location:oJSvw=oJSvl)->List[Union[Revision,Version]]:
