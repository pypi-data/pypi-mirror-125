...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=OdkGX
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:OdkGC)->OdkGC:
  pass
 @OdkGA
 def get(cls,requested_file_locator:OdkGC):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=OdkGX
 @OdkGA
 def get(cls,state_file_locator:OdkGC,requested_storage:OdkGC,serializers:Dict[OdkGC,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[OdkGC,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:OdkGC)->OdkGC:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:OdkGC)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:OdkGC)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:OdkGC)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:OdkGC)->OdkGC:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[OdkGC]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:OdkGC,new_key:OdkGC,referenced_by_version:OdkGC=OdkGX):
  pass
 @abc.abstractmethod
 def version_exists(self,key:OdkGC)->OdkGN:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:OdkGC,new_key:OdkGC,base_path:OdkGC)->OdkGN:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[OdkGC]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[OdkGC,OdkGC])->List[CPVCSObj]:
  pass
