...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=vHbUF
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:vHbUi)->vHbUi:
  pass
 @vHbUe
 def get(cls,requested_file_locator:vHbUi):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=vHbUF
 @vHbUe
 def get(cls,state_file_locator:vHbUi,requested_storage:vHbUi,serializers:Dict[vHbUi,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[vHbUi,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:vHbUi)->vHbUi:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:vHbUi)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:vHbUi)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:vHbUi)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:vHbUi)->vHbUi:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[vHbUi]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:vHbUi,new_key:vHbUi,referenced_by_version:vHbUi=vHbUF):
  pass
 @abc.abstractmethod
 def version_exists(self,key:vHbUi)->vHbUK:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:vHbUi,new_key:vHbUi,base_path:vHbUi)->vHbUK:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[vHbUi]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[vHbUi,vHbUi])->List[CPVCSObj]:
  pass
