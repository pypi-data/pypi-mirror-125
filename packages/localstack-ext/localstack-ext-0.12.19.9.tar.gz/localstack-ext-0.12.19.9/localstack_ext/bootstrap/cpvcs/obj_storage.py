...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=GnvbJ
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:Gnvbm)->Gnvbm:
  pass
 @Gnvbe
 def get(cls,requested_file_locator:Gnvbm):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=GnvbJ
 @Gnvbe
 def get(cls,state_file_locator:Gnvbm,requested_storage:Gnvbm,serializers:Dict[Gnvbm,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[Gnvbm,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:Gnvbm)->Gnvbm:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:Gnvbm)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:Gnvbm)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:Gnvbm)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:Gnvbm)->Gnvbm:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[Gnvbm]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:Gnvbm,new_key:Gnvbm,referenced_by_version:Gnvbm=GnvbJ):
  pass
 @abc.abstractmethod
 def version_exists(self,key:Gnvbm)->GnvbY:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:Gnvbm,new_key:Gnvbm,base_path:Gnvbm)->GnvbY:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[Gnvbm]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[Gnvbm,Gnvbm])->List[CPVCSObj]:
  pass
