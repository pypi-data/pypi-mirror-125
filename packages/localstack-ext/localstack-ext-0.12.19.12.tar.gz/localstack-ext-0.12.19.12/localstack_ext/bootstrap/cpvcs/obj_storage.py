...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=xzJNG
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:xzJNd)->xzJNd:
  pass
 @xzJNO
 def get(cls,requested_file_locator:xzJNd):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=xzJNG
 @xzJNO
 def get(cls,state_file_locator:xzJNd,requested_storage:xzJNd,serializers:Dict[xzJNd,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[xzJNd,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:xzJNd)->xzJNd:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:xzJNd)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:xzJNd)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:xzJNd)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:xzJNd)->xzJNd:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[xzJNd]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:xzJNd,new_key:xzJNd,referenced_by_version:xzJNd=xzJNG):
  pass
 @abc.abstractmethod
 def version_exists(self,key:xzJNd)->xzJNm:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:xzJNd,new_key:xzJNd,base_path:xzJNd)->xzJNm:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[xzJNd]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[xzJNd,xzJNd])->List[CPVCSObj]:
  pass
