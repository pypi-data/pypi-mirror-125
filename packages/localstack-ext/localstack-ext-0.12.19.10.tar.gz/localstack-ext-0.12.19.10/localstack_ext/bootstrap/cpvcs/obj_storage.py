...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=TiFGB
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:TiFGM)->TiFGM:
  pass
 @TiFGR
 def get(cls,requested_file_locator:TiFGM):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=TiFGB
 @TiFGR
 def get(cls,state_file_locator:TiFGM,requested_storage:TiFGM,serializers:Dict[TiFGM,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[TiFGM,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:TiFGM)->TiFGM:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:TiFGM)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:TiFGM)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:TiFGM)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:TiFGM)->TiFGM:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[TiFGM]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:TiFGM,new_key:TiFGM,referenced_by_version:TiFGM=TiFGB):
  pass
 @abc.abstractmethod
 def version_exists(self,key:TiFGM)->TiFGP:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:TiFGM,new_key:TiFGM,base_path:TiFGM)->TiFGP:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[TiFGM]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[TiFGM,TiFGM])->List[CPVCSObj]:
  pass
