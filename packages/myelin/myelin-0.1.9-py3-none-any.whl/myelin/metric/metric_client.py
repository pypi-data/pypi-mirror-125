...
class MetricClient(object):
    ...
    def post_hpo_result(self, config_id, config, budget, loss_metric, loss, params, tags, info_map):
    ...
    def mlflow_export(self, config: Dict[str, Any], loss: float, loss_metric: str,
                      params: Dict[str, Any], tags: Dict[str, str], num_tries: int):
        try:
            ...
            if num_tries == 0:
                ...
                return self.mlflow_export(config, loss, loss_metric, params, tags, num_tries - 1)
