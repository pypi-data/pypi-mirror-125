...
class AssignmentService(t.Generic[_ClientT]):
    ...
    def get_rubric(
        ...
        *,
        ...
        :returns: A list of `RubricRows` items.
        """
    ...
    def update_peer_feedback_settings(
        ...
        *,
        ...
        :param json_body: The body of the request. See
            :model:`.UpdatePeerFeedbackSettingsAssignmentData` for information
            about the possible fields. You can provide this data as a
            :model:`.UpdatePeerFeedbackSettingsAssignmentData` or as a
            dictionary.
    ...
    def export(
        ...
        *,
        ...
        :param json_body: The body of the request. See
            :model:`.ExportAssignmentData` for information about the possible
            fields. You can provide this data as a
            :model:`.ExportAssignmentData` or as a dictionary.
        :param assignment_id: The id of the assignment
        :param extra_parameters: The extra query parameters you might want to
            add. By default no extra query parameters are added.
    ...
    def get_auto_test(
        ...
        *,
        ...
        :returns: The AutoTest for the given assignment, if it has an AutoTest.
        """
    ...
    def import_into(
        ...
        *,
        ...
        :param json_body: The body of the request. See
            :model:`.ImportIntoAssignmentData` for information about the
            possible fields. You can provide this data as a
            :model:`.ImportIntoAssignmentData` or as a dictionary.
    ...
    def upload_submission(
        ...
        *,
        ...
        :param multipart_data: The data that should form the body of the
            request. See :model:`.UploadSubmissionAssignmentData` for
