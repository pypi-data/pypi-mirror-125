"""The module that defines the ``IOTestAsJSON`` model.
...
@dataclass
class IOTestAsJSON(AnyNonRedactedAutoTestStepAsJSON, IOTestExtra):
    """ """
    ...
    @classmethod
    def from_dict(
        cls: t.Type["IOTestAsJSON"], d: t.Dict[str, t.Any]
    ) -> "IOTestAsJSON":
