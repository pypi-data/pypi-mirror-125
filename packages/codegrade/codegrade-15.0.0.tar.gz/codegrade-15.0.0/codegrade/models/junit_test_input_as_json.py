"""The module that defines the ``JunitTestInputAsJSON`` model.
...
@dataclass
class JunitTestInputAsJSON(AutoTestStepBaseInputAsJSON, JunitTestExtra):
    """ """
    ...
    @classmethod
    def from_dict(
        cls: t.Type["JunitTestInputAsJSON"], d: t.Dict[str, t.Any]
