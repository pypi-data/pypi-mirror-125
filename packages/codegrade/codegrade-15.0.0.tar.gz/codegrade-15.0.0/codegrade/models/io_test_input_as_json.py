"""The module that defines the ``IOTestInputAsJSON`` model.
...
@dataclass
class IOTestInputAsJSON(AutoTestStepBaseInputAsJSON, IOTestExtra):
    """ """
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: AutoTestStepBaseInputAsJSON.data_parser.parser.combine(
            IOTestExtra.data_parser.parser
        )
    ...
    @classmethod
    def from_dict(
        cls: t.Type["IOTestInputAsJSON"], d: t.Dict[str, t.Any]
    ) -> "IOTestInputAsJSON":
