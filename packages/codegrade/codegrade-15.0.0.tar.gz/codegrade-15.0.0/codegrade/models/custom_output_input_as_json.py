"""The module that defines the ``CustomOutputInputAsJSON`` model.
...
@dataclass
class CustomOutputInputAsJSON(AutoTestStepBaseInputAsJSON, CustomOutputExtra):
    """ """
    ...
    @classmethod
    def from_dict(
        cls: t.Type["CustomOutputInputAsJSON"], d: t.Dict[str, t.Any]
