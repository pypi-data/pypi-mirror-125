...
class AutoTestStepResult:
    ...
    auto_test_step: "t.Union[IOTestAsJSON, RunProgramAsJSON, CustomOutputAsJSON, CheckPointsAsJSON, JunitTestAsJSON, CodeQualityAsJSON, AnyRedactedAutoTestStepAsJSON]"
    ...
    #: step result.
    log: "t.Optional[t.Union[CustomOutputLog, JunitTestLog, QualityTestLog, RunProgramLog, IOTestLog, AutoTestStepLogBase]]"
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.RequiredArgument(
                "auto_test_step",
                parsers.make_union(
                    parsers.ParserFor.make(IOTestAsJSON),
                    parsers.ParserFor.make(RunProgramAsJSON),
                    parsers.ParserFor.make(CustomOutputAsJSON),
                    parsers.ParserFor.make(CheckPointsAsJSON),
                    parsers.ParserFor.make(JunitTestAsJSON),
                    parsers.ParserFor.make(CodeQualityAsJSON),
                    parsers.ParserFor.make(AnyRedactedAutoTestStepAsJSON),
                ),
