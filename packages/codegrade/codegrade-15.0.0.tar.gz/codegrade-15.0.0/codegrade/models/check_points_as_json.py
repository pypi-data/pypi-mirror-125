"""The module that defines the ``CheckPointsAsJSON`` model.
...
@dataclass
class CheckPointsAsJSON(AnyNonRedactedAutoTestStepAsJSON, CheckPointsExtra):
    """ """
    ...
    @classmethod
    def from_dict(
        cls: t.Type["CheckPointsAsJSON"], d: t.Dict[str, t.Any]
    ) -> "CheckPointsAsJSON":
