...
class GitProviderService(t.Generic[_ClientT]):
    ...
    def connect_repository(
        ...
        *,
        ...
        :param json_body: The body of the request. See
            :model:`.ConnectRepositoryGitProviderData` for information about
            the possible fields. You can provide this data as a
            :model:`.ConnectRepositoryGitProviderData` or as a dictionary.
    ...
    def get_all_repositories(
        ...
        *,
        ...
        url = (
            "/api/v1/git_providers/{providerId}/tokens/{tokenId}/repositories/"
            .format(providerId=provider_id, tokenId=token_id)
        )
        params: t.Dict[str, t.Any] = {
            **(extra_parameters or {}),
        }
    ...
    def create_repository(
        ...
        *,
        ...
        :param json_body: The body of the request. See
            :model:`.CreateRepositoryGitProviderData` for information about the
            possible fields. You can provide this data as a
            :model:`.CreateRepositoryGitProviderData` or as a dictionary.
