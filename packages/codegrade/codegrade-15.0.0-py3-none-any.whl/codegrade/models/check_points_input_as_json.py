"""The module that defines the ``CheckPointsInputAsJSON`` model.
...
@dataclass
class CheckPointsInputAsJSON(AutoTestStepBaseInputAsJSON, CheckPointsExtra):
    """ """
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: AutoTestStepBaseInputAsJSON.data_parser.parser.combine(
            CheckPointsExtra.data_parser.parser
        )
    ...
    @classmethod
    def from_dict(
        cls: t.Type["CheckPointsInputAsJSON"], d: t.Dict[str, t.Any]
