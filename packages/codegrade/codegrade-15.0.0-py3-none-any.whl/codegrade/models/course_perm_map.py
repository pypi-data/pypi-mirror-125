...
class CoursePermMap:
    ...
    #: Users with this permission can see all feedback, except for peer
    #: feedback, before an assignment is set to "done"
    can_see_user_feedback_before_done: "bool"
    #: Users with this permission can view the analytics dashboard of an
    #: assignment.
    can_view_analytics: "bool"
    #: Users with this permission can edit inline comments left by other users
    can_edit_others_comments: "bool"
    #: Users with this permission can add and reply to inline comments on
    #: submissions they are the author of
    can_add_own_inline_comments: "bool"
    #: Users with this permission may see the edit history of comments placed
    #: by others
    ...
    #: Users with this permission can view unapproved inline comments, comments
    #: that need approval include peer feedback comments. Users still need to
    #: have the permission to see the feedback, so this permission alone is not
    #: enough to see peer feedback.
    can_view_inline_feedback_before_approved: "bool"
    #: Users with this permission can approve inline comments, comments that
    #: need approval include peer feedback comments.
    ...
    #: Users with this permission are allowed to see peer feedback before the
    #: state of an assignment has been set to "done".
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can see all feedback, except"
                    ' for peer feedback, before an assignment is set to "done"'
                ),
            ),
            rqa.RequiredArgument(
                "can_view_analytics",
            ...
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can edit inline comments left"
                    " by other users"
                ),
            ),
            rqa.RequiredArgument(
            ...
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can view unapproved inline"
                    " comments, comments that need approval include peer"
                    " feedback comments. Users still need to have the"
            ...
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission can approve inline comments,"
                    " comments that need approval include peer feedback"
                    " comments."
                ),
            ),
            rqa.RequiredArgument(
            ...
            rqa.RequiredArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Users with this permission are allowed to see peer"
                    " feedback before the state of an assignment has been set"
                    ' to "done".'
                ),
            ),
            rqa.RequiredArgument(
