"""The module that defines the ``CodeQualityAsJSON`` model.
...
@dataclass
class CodeQualityAsJSON(AnyNonRedactedAutoTestStepAsJSON, CodeQualityExtra):
    """ """
    ...
    @classmethod
    def from_dict(
        cls: t.Type["CodeQualityAsJSON"], d: t.Dict[str, t.Any]
    ) -> "CodeQualityAsJSON":
