"""The module that defines the ``LoginTokenBeforeTimeSetting`` model.
...
class LoginTokenBeforeTimeSetting:
    ...
    value: "t.Optional[t.Sequence[datetime.timedelta]]"
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.RequiredArgument(
                "value",
                rqa.Nullable(rqa.List(rqa.RichValue.TimeDelta)),
                doc="",
            ),
