...
class AutoTestSuite:
    ...
    steps: "t.Sequence[t.Union[IOTestAsJSON, RunProgramAsJSON, CustomOutputAsJSON, CheckPointsAsJSON, JunitTestAsJSON, CodeQualityAsJSON, AnyRedactedAutoTestStepAsJSON]]"
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.RequiredArgument(
                ...
                doc=(
                    "The maximum amount of time a step (or substep) may take."
                    " If `null` the instance default will be used."
                ),
            ),
