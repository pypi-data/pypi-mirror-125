"""The module that defines the ``QualityTestLogBase`` model.
...
@dataclass
class QualityTestLogBase(AutoTestStepLogBase):
    """The log for the QualityTest step type."""
    ...
    @classmethod
    def from_dict(
        cls: t.Type["QualityTestLogBase"], d: t.Dict[str, t.Any]
    ) -> "QualityTestLogBase":
