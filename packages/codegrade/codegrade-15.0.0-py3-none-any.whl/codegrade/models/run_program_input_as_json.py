"""The module that defines the ``RunProgramInputAsJSON`` model.
...
@dataclass
class RunProgramInputAsJSON(AutoTestStepBaseInputAsJSON, RunProgramExtra):
    """ """
    ...
    @classmethod
    def from_dict(
        cls: t.Type["RunProgramInputAsJSON"], d: t.Dict[str, t.Any]
