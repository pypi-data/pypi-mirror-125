...
class generatedClass(ZIDS_Tester):
    ...
    def __init__(self):
        ...
        self.pred_name = ""  # Fill this according to the field received from DSP, and remove this comment
        self.target_name = ""  # Fill this according to the field received from the model, and remove this comment
    ...
    def test_batch(self, test_request: TestInputRequest) -> TestOutputResponse:
        ...
        if data_rows:
            ...
            model_evaluation_results = self.format_evaluation_output(df_model_evaluation_results)
