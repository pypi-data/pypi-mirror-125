...
cloud_eval_extra_files = package_files('cli/tester/cloud_eval')
...
setup(
    ...
    # ],
    packages=find_packages(include=['cli*'])+find_packages(include=['dsframework*']),
