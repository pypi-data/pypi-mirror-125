...
class classification:
	...
	classifier='GP', 'SVM', 'RandomForest', 'KNN', 'NeuralNet', 'LDA', 'NaiveBayes'
...
def run_every_classifier(data, y=None, y_column_name=None, order_by='Test'):
	...
	order_by: 'Test', 'Train'
	'''
	regressors=['GP', 'SVM', 'RandomForest', 'KNN', 'NeuralNet', 'LDA', 'NaiveBayes']
	results = {}

	df = pd.DataFrame()
	for reg in regressors:
		results[reg] = classification(data, y=y, classifier=reg)
