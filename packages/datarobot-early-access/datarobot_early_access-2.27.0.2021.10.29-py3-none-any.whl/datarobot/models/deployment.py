...
class DeploymentListFilters(object):
    ...
    **Performing OR logic**
    ...
    role = attr.ib(default=None, converter=_check(String()))
    service_health = attr.ib(default=None, converter=_check(t.List[String()]))
    model_health = attr.ib(default=None, converter=_check(t.List[String()]))
    accuracy_health = attr.ib(default=None, converter=_check(t.List[String()]))
    execution_environment_type = attr.ib(default=None, converter=_check(t.List[String()]))
    importance = attr.ib(default=None, converter=_check(t.List[String()]))
