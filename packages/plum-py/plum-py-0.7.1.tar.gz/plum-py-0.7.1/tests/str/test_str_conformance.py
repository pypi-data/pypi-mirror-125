...
ascii_sized = StrX("ascii_sized", nbytes=43, encoding="ascii")
ascii_padded = StrX("ascii_padded", nbytes=45, encoding="ascii", pad=b"\x00")
...
class TestPad(Case):
    data = CaseData(
        ...
        1 too few bytes to unpack 'ascii_padded' (45 needed, only 44
        available)
        """
        ),
    )
