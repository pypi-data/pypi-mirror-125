...
class App(object):
    ...
    def update(self, name, tags, desc):
        """
        更新模型基础信息
        :param tags:应用标签
        :param name:应用名称
        ...
        """
        return self._backend.update_app(self.id, name, tags, desc)
    ...
    def delete(self):
        ...
        :return:
        """
        return self._backend.delete_app(self.id)
    ...
    def list_models(self):
        ...
        """
        return self._backend.list_models(self.id)
    ...
    def create_model(self, name, desc='', auth_id='', git_url='', http_url=''):
        ...
        :return: List of Class `Model` Object
        """
        return self._backend.create_model(self.id, name, desc, auth_id, git_url, http_url)
