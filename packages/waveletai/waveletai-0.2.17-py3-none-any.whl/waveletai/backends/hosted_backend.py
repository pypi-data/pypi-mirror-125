...
class HostedBackend(Backend):
    ...
    def update_dataset(self, dataset_id, name, zone, desc):
        ...
        """
        res = self._session.put(url=f'{self.api_address}/{self.app_id}/data/dataset/{dataset_id}',
    ...
    def update_model(self, model_id, app_id, name, desc):
        ...
        :return:
        """
        res = self._session.put(url=f'{self.api_address}/{self.app_id}/training/model/{model_id}',
    ...
    def delete_model(self, model_id):
        ...
        :return:
        """
        res = self._session.delete(url=f'{self.api_address}/{self.app_id}/training/model/{model_id}')
        if res.json()['message']:
            raise Exception(res.json()['message'])
        data = res.json()['data']
        return data
    ...
    def create_model(self, name, app_id, desc, auth_id, git_url, http_url):
        ...
        :return: List of Class `Model` Object
        """
        res = self._session.post(url=f'{self.api_address}/{app_id}/training/model/', json={"name": name,
                                                                                           "app_id": app_id,
                                                                                           "desc": desc,
                                                                                           "auth_id": auth_id,
                                                                                           "git_url": git_url,
    ...
    def get_model(self, model_id):
        ...
        """
        res = self._session.get(url=f'{self.api_address}/{self.app_id}/training/model/{model_id}/')
        if res.json()["message"]:
            raise Exception(res.json()["message"])
        dict = res.json()['data']
    ...
    def _get_feature_zip_path(self, feature_id, imgtype):
        if imgtype == None:
            imgtype = ''
        res = self._session.get(url=f'{self.api_address}/{self.app_id}/data/feature/{feature_id}/asset?type={imgtype}')
        if res.json()["message"]:
            raise Exception(res.json()["message"])
        data = res.json()['data']
        feature_path = ''
    ...
    def create_experiment(self, name, model_id, params=None, host_id=None, dataset_id=None, docker_args=None,
        ...
        res = self._session.post(url=f'{self.api_address}/{model_id}/training/experiment/', json=data)
        if res.json()['message']:
            raise Exception(res.json()['message'])
        data = res.json()['data']
    ...
    def get_experiment_by_mlflow_experiment(self, experiment_id):
        ...
        :return:
        """
        res = self._session.get(f'{self.api_address}/{self.app_id}/training/experiment/mlflow/{experiment_id}')
        if res.json()['message']:
            raise Exception(res.json()['message'])
        data = res.json()['data']
        self.set_model_id(data['model_id'])
        self.set_app_id(data['model']['app_id'])
        return Experiment(self, id=data['id'], name=data['name'], desc=data['desc'], host_id=data['host_id'],
    ...
    def get_experiment_by_mlflow_run(self, run_id):
        ...
        :return:
        """
        res = self._session.get(f'{self.api_address}/{self.app_id}/training/experiment/mlflow/run/{run_id}')
        if res.json()['message']:
            raise Exception(res.json()['message'])
        data = res.json()['data']
        self.set_model_id(data['model_id'])
