...
version = (
    SourceFileLoader("waveletai._version", os.path.join("waveletai", "_version.py")).load_module().VERSION
)
...
setup(name='waveletai',
      ...
      url='https://market.xiaobodata.com/',
      ...
      project_urls={
          ...
          'wavelet-ai doc': 'https://plus.xiaobodata.com/wai_doc/'
      },
      install_requires=[
          'pymysql',
          'boto3',
